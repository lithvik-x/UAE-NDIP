 ...
 * Comprehensive research data for UAE Regional Perception
 * Source: 3-1-international-perception-results.md (regionalPerception section)
 */
...
export const regionalPerception = {
  ...
  europe: {
    ...
    shadowSide: {
      ...
      quoteAuthor: 'Erwin van Veen, Clingendael Institute',
    },
  },
  china: {
    title: 'China',
...
export const regionalSummary = [
  { region: 'United States', sentiment: 'MIXED', keyMetric: '82% UAE positive vs 14% US positive', trend: 'Stable' },
  { region: 'Europe', sentiment: 'MIXED', keyMetric: 'Strategic partner + far-right shadow', trend: 'Stable' },
  { region: 'China', sentiment: 'POSITIVE', keyMetric: '$100B/year trade', trend: 'Rising' },
  { region: 'Russia', sentiment: 'POSITIVE', keyMetric: 'BRICS member, $11.5B trade', trend: 'Rising' },
  { region: 'Arab World', sentiment: 'MIXED', keyMetric: 'Globally trusted, regionally strained', trend: 'Deteriorating' },
  { region: 'Africa', sentiment: 'MIXED', keyMetric: '$100B+ investment', trend: 'Stable' },
  { region: 'Latin America', sentiment: 'POSITIVE', keyMetric: '$9B trade, CEPAs signed', trend: 'Rising' },
  { region: 'India', sentiment: 'POSITIVE', keyMetric: '4.3M diaspora, $200B trade target', trend: 'Rising' },
]
...
export const tradePartnershipData = [
  { country: 'China', tradeVolume: 100, trend: 'up', label: '$100B/year' },
  { country: 'US', tradeVolume: 75, trend: 'stable', label: '$75B/year' },
  { country: 'India', tradeVolume: 65, trend: 'up', label: '$65B/year' },
  { country: 'Russia', tradeVolume: 45, trend: 'up', label: '$11.5B (2024)' },
  { country: 'Europe', tradeVolume: 40, trend: 'stable', label: 'EU SPA pending' },
  { country: 'Latin America', tradeVolume: 15, trend: 'up', label: '$9B total' },
]
...
export const regionalPerceptionData = {
  // Metadata
  executionMetadata,
...
export default regionalPerceptionData
