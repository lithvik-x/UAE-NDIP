/**
 * Global Standing Data — UAE Competitive Benchmarking
 * Single Source of Truth for UAE Competitive Positioning vs. Regional and Global Peers
...
export interface CompetitorMetric {
  ...
  uae?: string | null
  year?: string | number | null
  [competitor: string]: string | number | null | undefined
}
...
export interface CityComparison {
  ...
  london?: string | null
  newYork?: string | null
  hongKong?: string | null
  [competitor: string]: string | null | undefined
}
...
export interface CompetitorCard {
  ...
  vision?: string
  rivalryArena?: string
  postAccordsOpportunity?: string
  uaeCompetitiveEdge: string
}
...
export interface RankingsOverTime {
  index: string
  2022: string | null
  2023: string | null
  2024: string | null
...
export interface GCCCComparison {
  metric: string
  uae: string | null
  saudiArabia: string | null
  qatar: string | null
  oman: string | null
  bahrain: string | null
  kuwait: string | null
...
export interface CompetitiveAdvantage {
  advantageDomain: string
  uaeStrength: string
  closestRival: string
  uaeAdvantageMargin: string
}

export interface CompetitiveVulnerability {
  vulnerability: string
  uaeMetric: string
  dominantRival: string | null
...
export const globalStandingSummary = {
  uaePositioning:
    'UAE positions itself as a global hub federation — a tax-efficient, politically stable, and diversification-forward alternative to regional rivals and established Western/Asian financial centres.',
  headlineFinding:
    'The UAE is the only GCC state to simultaneously rank in the global top 10 for competitiveness (IMD #5), entrepreneurship (GEM #1, 5th consecutive year), soft power (Brand Finance #10), happiness (UN #21), and digital competitiveness (IMD #9).',
  lastUpdated: '2026-04-27',
...
export const uaeGlobalRankings: GlobalRanking[] = [
  {
  ...
  {
    index: 'GEM National Entrepreneurship Context Index (NECI)',
    ranking: '1st globally',
    score: '7.0 pts',
    source: 'GEM Global Report 2025/2026',
    year: 2026,
    trend: 'Stable, 5th consecutive year',
  },
  {
    index: 'Global Financial Centres Index (GFCI) — Dubai',
    ranking: '7th globally',
    score: '742 pts',
    source: 'Long Finance / Z/Yen',
    year: 'Mar 2026',
    trend: 'Up 4-place jump',
  },
  {
    index: 'IMD World Digital Competitiveness Ranking',
    ranking: '9th globally',
    score: null,
    source: 'IMD',
    year: 2025,
    trend: '1st in Arab world',
  },
  {
    index: 'World Happiness Report — Arab Region',
    ranking: '1st regionally, 21st globally',
    score: null,
    source: 'UN Sustainable Development Solutions',
    year: 2026,
    trend: 'Maintained',
  },
  {
    index: 'Brand Finance Global Soft Power Index',
    ranking: '10th globally',
    score: null,
    source: 'Brand Finance',
    year: 2026,
    trend: '4th consecutive year in top-10',
  },
  {
    index: 'Global Human Prosperity Index',
  ...
  {
    index: 'Doing Business Ranking (legacy)',
    ranking: '16th globally',
    score: null,
    source: 'World Bank',
    year: 2020,
    trend: 'Historical reference',
  },
  {
    ...
    year: 2023,
    trend: 'Better than Oman (43)',
  },
]

export const uaeIndicatorPerformance: IndicatorPerformance[] = [
...
// ============================================================================
// COMPETITOR COMPARISONS — UAE VS SAUDI ARABIA
// ============================================================================

export const uaeVsSaudiEconomic: CompetitorMetric[] = [
...
export const uaeVsSaudiDemographics: CompetitorMetric[] = [
...
export const uaeVsSaudiMilitary: CompetitorMetric[] = [
  { metric: 'Power Index (lower = stronger)', uae: '1.0188', saudi: '0.4473', source: 'GFP 2026', year: 2026 },
  { metric: 'Global military rank (of 145)', uae: '54', saudi: '25', source: 'GFP 2026', year: 2026 },
  { metric: 'Defense spending', uae: '$23.48B (Rank 24)', saudi: '$63.99B (Rank 8)', source: 'GFP 2026', year: 2026 },
  { metric: 'Active troops', uae: '65,000', saudi: '247,000', source: 'GFP 2026', year: 2026 },
  { metric: 'Reserve troops', uae: '130,000', saudi: '0', source: 'GFP 2026', year: 2026 },
  { metric: 'Total aircraft', uae: '581', saudi: '917', source: 'GFP 2026', year: 2026 },
  { metric: 'Fighter aircraft', uae: '99', saudi: '283', source: 'GFP 2026', year: 2026 },
  { metric: 'Tanks', uae: '354', saudi: '1,085', source: 'GFP 2026', year: 2026 },
  { metric: 'Armored vehicles', uae: '8,982', saudi: '22,370', source: 'GFP 2026', year: 2026 },
  { metric: 'Naval fleet', uae: '84 ships', saudi: '32 ships', source: 'GFP 2026', year: 2026 },
  { metric: 'Middle East regional rank', uae: '7th', saudi: '5th', source: 'GFP 2026', year: 2026 },
]
...
export const uaeVsQatar: CompetitorMetric[] = [
  { metric: 'Area', uae: '83,600 km²', qatar: '11,610 km²', source: 'Qatar ~7x smaller', year: null },
  { metric: 'Population', uae: '10.99M', qatar: '2.86M', source: 'Qatar ~4x smaller', year: null },
  { metric: 'GDP (nominal)', uae: '$552B', qatar: '$219B', source: 'WorldData.info', year: null },
  { metric: 'GDP per capita', uae: '$50,270', qatar: '$76,690', source: 'Qatar higher', year: null },
  { metric: 'Average income', uae: '$51,550', qatar: '$77,290', source: 'Qatar higher', year: null },
  { metric: 'Unemployment', uae: '2.2%', qatar: '0.1%', source: 'Qatar near-full employment', year: null },
  { metric: 'Exports', uae: '$648B', qatar: '$125B', source: 'UAE dominates total trade', year: null },
  { metric: 'Exports % GDP', uae: '92.96%', qatar: '44.64%', source: 'UAE more trade-dependent', year: null },
  { metric: 'Government debt (% GDP)', uae: '34%–34.94%', qatar: '40.6%–42.81%', source: 'Qatar higher debt', year: null },
  { metric: 'Health spending (% budget)', uae: '14.41%', qatar: '7.69%', source: 'UAE prioritizes health', year: null },
  { metric: 'Education spending (% budget)', uae: '14.76%', qatar: '8.94%', source: 'UAE prioritizes education', year: null },
  { metric: 'Defense spending (% budget)', uae: '17.04%', qatar: '26.88%', source: 'Qatar more defense-focused', year: null },
  { metric: 'Literacy rate', uae: '98.8%', qatar: '93.5%', source: 'UAE higher', year: null },
  { metric: "Bachelor's degree attainment", uae: '52.7%', qatar: '30.4%', source: 'UAE higher', year: null },
  { metric: 'Political stability (0-100)', uae: '86', qatar: '90', source: 'Slight Qatar edge', year: null },
  { metric: 'Health score (0-100)', uae: '78', qatar: '76', source: 'UAE higher', year: null },
]

export const aviationRivalry: CompetitorMetric[] = [
  { metric: 'SKYTRAX Best Airlines Middle East 2025', emirates: '#2', qatarAirways: '#1', source: 'World Airliner Awards', year: 2025 },
  { metric: 'AirlineRatings safety 2025', emirates: '#3 (tied)', qatarAirways: '#3 (tied)', source: 'AirlineRatings Jan 2026', year: 2026 },
  { metric: 'Business class', emirates: 'Consistent product across fleet', qatarAirways: 'QSuite considered more premium', source: 'Multiple 2026', year: 2026 },
  { metric: 'Business class award 2025', emirates: null, qatarAirways: '#1', source: 'Simple Flying Mar 2026', year: 2026 },
  { metric: 'Economy — free WiFi', emirates: 'Emirates better', qatarAirways: 'Consistent', source: 'Simple Flying', year: null },
  { metric: 'Punctuality', emirates: 'Good', qatarAirways: 'Edges ahead', source: 'Multiple sources', year: null },
  { metric: 'Fleet approach', emirates: 'Focused on mainline passenger', qatarAirways: 'Wider route network, diverse fleet', source: 'Simple Flying', year: null },
]

// ============================================================================
// UAE VS OMAN, BAHRAIN, KUWAIT
// ============================================================================

export const uaeVsOman: CompetitorMetric[] = [
  { metric: 'GDP (nominal)', uae: '$552B', oman: '$107B', source: 'CountryEconomy.com', year: null },
  { metric: 'GDP per capita', uae: '$48,906', oman: '$20,529', source: 'CountryEconomy.com', year: null },
  { metric: 'GDP growth (2024)', uae: '4.0%', oman: '1.6%', source: 'CountryEconomy.com', year: 2024 },
  { metric: "Moody's sovereign rating", uae: 'Aa2', oman: 'Baa3', source: 'CountryEconomy.com', year: null },
  { metric: 'S&P sovereign rating', uae: 'AA', oman: 'BBB-', source: 'CountryEconomy.com', year: null },
  { metric: 'Corruption Index (2023)', uae: '68', oman: '43', source: 'CountryEconomy.com', year: 2023 },
  { metric: 'Exports', uae: '$449B', oman: '$58B', source: 'CountryEconomy.com', year: null },
  { metric: 'HDI', uae: '0.937', oman: '0.819', source: 'CountryEconomy.com', year: null },
  { metric: 'Tourism arrivals', uae: '11,479,000', oman: '2,059,000', source: 'CountryEconomy.com', year: null },
]

export const uaeVsBahrain: CompetitorMetric[] = [
  { metric: 'Currency swap (Apr 2026)', uae: 'Provider', bahrain: '$5.4B agreement signed', source: 'GulfIF / ArabNews', year: 2026 },
  { metric: 'Fiscal deficit (IMF)', uae: null, bahrain: '11% (flagged)', source: 'GulfIF', year: null },
  { metric: 'S&P rating (Nov 2025)', uae: 'AA', bahrain: 'B (downgraded)', source: 'GulfIF', year: 2025 },
  { metric: 'Debt-to-GDP', uae: 'Low (~2%)', bahrain: '133%', source: 'GulfIF', year: null },
  { metric: 'Sovereign wealth buffers', uae: 'Yes', bahrain: 'No (single aging oil field)', source: 'GulfIF', year: null },
]

export const uaeVsKuwait: CompetitorMetric[] = [
  { metric: 'GDP (2024)', uae: '$509–$552B', kuwait: '$134–$160B', source: 'CountryEconomy.com', year: 2024 },
  { metric: 'GDP per capita (2024)', uae: '$79,229', kuwait: '$32,106–$52,444', source: 'CountryEconomy.com', year: 2024 },
  { metric: 'Unemployment', uae: '2.2%', kuwait: '2.2%', source: 'Tied', year: null },
  { metric: 'Wealth-to-GDP ratio', uae: '12th globally', kuwait: 'Topped GCC', source: 'CountryEconomy.com', year: null },
]

// ============================================================================
// UAE VS ISRAEL, TURKEY, EGYPT
// ============================================================================

export const uaeVsIsrael: CompetitorMetric[] = [
  { metric: 'Normalisation framework', uae: 'Abraham Accords (Sep 2020)', israel: 'Abraham Accords (Sep 2020)', source: 'Wikipedia / Britannica', year: 2020 },
  { metric: 'Bilateral trade (by 2026)', uae: 'Growing significantly post-Accords', israel: null, source: 'Times of Israel Feb 2026', year: 2026 },
  { metric: 'Joint tech fund', uae: '$3B (US-Israel-UAE fund)', israel: null, source: 'Atlantic Council Jan 2026', year: 2026 },
  { metric: 'Cooperation areas', uae: 'AI, cybersecurity, health-tech, agrifood, fintech', israel: null, source: 'Middle East Institute', year: null },
  { metric: 'UAE tech ecosystem', uae: 'Hub71 (Abu Dhabi)', israel: 'Start-Up Nation Central', source: 'Multiple', year: null },
  { metric: 'Knowledge ranking (INSEAD)', uae: '6th globally', israel: '9th (tech sophistication)', source: 'MEI', year: null },
  { metric: 'Regional military rank (GFP)', uae: '7th (Middle East)', israel: '2nd (PwrIndx 0.2707)', source: 'GFP 2026', year: 2026 },
  { metric: 'Defense cooperation', uae: 'Intelligence sharing, early-warning data swaps', israel: null, source: 'Semafor Mar 2026', year: 2026 },
]

export const uaeVsTurkey: CompetitorMetric[] = [
  { metric: 'GDP (nominal)', uae: '$540–$601B', turkey: '~$1.1T (larger)', source: 'Multiple', year: null },
  { metric: 'Regional military rank (GFP)', uae: '7th', turkey: '1st in Middle East (PwrIndx 0.1975)', source: 'GFP 2026', year: 2026 },
  { metric: 'Power Index (lower = stronger)', uae: '1.0188', turkey: '0.1975', source: 'GFP 2026', year: 2026 },
  { metric: 'Soft power approach', uae: 'Economic/security-focused', turkey: 'Cultural/soft power', source: 'PMC/NIH 2022', year: 2022 },
  { metric: 'Africa rivalry', uae: 'Main arena of competition', turkey: 'Main arena of competition', source: 'PMC/NIH 2022', year: 2022 },
  { metric: 'Mutual Protection Agreement', uae: 'Signed July 2025', turkey: 'Signed July 2025', source: 'Turkiye Today Feb 2026', year: 2025 },
]

export const uaeVsEgypt: CompetitorMetric[] = [
  { metric: 'GDP (nominal)', uae: '$540–$601B', egypt: '~$400B', source: 'Multiple', year: null },
  { metric: 'Regional military rank (GFP)', uae: '7th', egypt: '4th (PwrIndx 0.3651)', source: 'GFP 2026', year: 2026 },
  { metric: 'Active military personnel', uae: '63,000–65,000', egypt: '~836,000', source: 'GlobalMilitary.net', year: null },
  { metric: 'Numerical military advantage', uae: null, egypt: 'Egypt 13:1 UAE', source: 'GlobalMilitary.net', year: null },
  { metric: 'Tourism arrivals (UAE)', uae: 'Dubai alone: 19.6M (2025)', egypt: null, source: 'Gulf News / Multiple', year: 2025 },
]

// ============================================================================
// UAE VS SINGAPORE, SWITZERLAND, HONG KONG, MONACO
// ============================================================================

export const uaeVsSingapore: CompetitorMetric[] = [
  { metric: 'Cost of living', uae: 'Baseline', singapore: '38% more expensive', source: 'Novad.app', year: null },
  { metric: 'Monthly costs (single person)', uae: '$3,500', singapore: '$4,830', source: 'Novad.app', year: null },
  { metric: 'Rent (1BR city centre)', uae: '$2,150', singapore: '$2,850', source: 'Novad.app', year: null },
  { metric: 'Personal income tax', uae: '0%', singapore: 'Progressive 0%–24%', source: 'Novad.app', year: null },
  { metric: 'Visa process', uae: 'Easier', singapore: 'More complex', source: 'Novad.app', year: null },
  { metric: 'Geopolitical stability', uae: 'Moderate (Middle East risk)', singapore: '"Island of stability"', source: 'Novad.app', year: null },
  { metric: 'Safety score', uae: '84/100', singapore: '77/100', source: 'Novad.app', year: null },
  { metric: 'Internet speed', uae: '100 Mbps', singapore: '250 Mbps', source: 'Novad.app', year: null },
  { metric: 'Healthcare infrastructure', uae: 'Good', singapore: 'Better', source: 'Novad.app', year: null },
]

export const uaeVsSwitzerland: CompetitorMetric[] = [
  { metric: 'Personal income tax', uae: '0%', switzerland: 'Up to ~40% (cantons)', source: 'Emifast', year: null },
  { metric: 'Corporate income tax', uae: '9% (0% in free zones)', switzerland: '12%–21%', source: 'Emifast', year: null },
  { metric: 'Capital gains tax (personal)', uae: '0%', switzerland: 'Generally exempt', source: 'Emifast', year: null },
  { metric: 'Wealth tax', uae: 'None', switzerland: 'Yes', source: 'Emifast', year: null },
  { metric: 'Inheritance tax', uae: 'None', switzerland: 'Yes', source: 'Emifast', year: null },
  { metric: 'Crypto tax', uae: '0%', switzerland: 'Varies by canton', source: 'Emifast', year: null },
  { metric: 'Financial discretion', uae: 'High (ADGM, VARA)', switzerland: 'Very high (Swiss tradition)', source: 'Emifast', year: null },
  { metric: 'Crypto regulation', uae: 'VARA (Dubai), ADGM clear', switzerland: 'Evolving', source: 'Emifast', year: null },
  { metric: 'Foreign property ownership', uae: '100% allowed', switzerland: 'Strict limits', source: 'Emifast', year: null },
  { metric: 'Property tax', uae: 'None', switzerland: 'Yes', source: 'Emifast', year: null },
]

export const uaeVsHongKong: CompetitorMetric[] = [
  { metric: 'Status (2026)', uae: 'Rising star', hongKong: 'Challenged by geopolitics', source: 'SCMP', year: 2026 },
  { metric: 'Foreign assets under management', uae: '~$700B (2024)', hongKong: null, source: 'BCG via SCMP', year: 2024 },
  { metric: 'Financial hub positioning', uae: 'Middle East/Africa/Europe', hongKong: 'Asia/China-focused', source: 'SCMP', year: null },
  { metric: 'Competition for Chinese capital', uae: 'Both compete', hongKong: 'Both compete', source: 'SCMP', year: null },
  { metric: 'Preferred by', uae: 'Middle East-connected firms', hongKong: 'Asian trading firms', source: 'SCMP', year: null },
]

export const uaeVsMonaco: CompetitorMetric[] = [
  { metric: 'Luxury philosophy', uae: 'Visibility and grandeur', monaco: 'Privacy and exclusivity', source: 'Villa Monaco', year: null },
  { metric: 'Climate', uae: 'Intense summer heat, year-round sun', monaco: 'Mediterranean mild winters', source: 'Villa Monaco', year: null },
  { metric: 'Signature experiences', uae: 'Desert safari, sky-high dining, private beaches', monaco: 'Yacht charters, Monaco GP, Monte-Carlo Masters', source: 'Villa Monaco', year: null },
  { metric: 'Art/cultural events', uae: 'Expo, Art Dubai', monaco: 'Monte-Carlo Ballet, Opera', source: 'Villa Monaco', year: null },
  { metric: 'Population approach', uae: 'Major metropolis', monaco: 'Small, discreet community', source: 'Villa Monaco', year: null },
  { metric: 'Tax status', uae: '0% personal income/capital gains/inheritance', monaco: 'No tax for residents', source: 'Multiple', year: null },
]
...
export const dubaiVsLondon: CityComparison[] = [
...
export const dubaiVsNewYork: CityComparison[] = [
...
export const aviationSector: SectorBenchmark[] = [
  { metric: 'SKYTRAX Middle East ranking', emirates: '#2', qatarAirways: '#1', etihad: '#4', source: 'Skytrax World Airliner Awards 2025' },
  { metric: 'AirlineRatings safety 2025', emirates: '#3 (tied)', qatarAirways: '#3 (tied)', source: 'AirlineRatings Jan 2026' },
  { metric: 'Business class', emirates: 'Consistent fleet product', qatarAirways: 'QSuite premium', source: 'Multiple 2026' },
  { metric: 'Business class award 2025', emirates: null, qatarAirways: '#1', source: 'Simple Flying Mar 2026' },
  { metric: 'Economy (WiFi)', emirates: 'Better free WiFi', qatarAirways: 'Consistent', source: 'Simple Flying' },
  { metric: 'Historical global rank', emirates: '#1 (historical)', qatarAirways: '#2 (historical)', etihad: '#7', source: 'Various' },
]

export const wealthManagementSector: SectorBenchmark[] = [
...
export const gccEconomicOverview: GCCCComparison[] = [
  ...
  { metric: 'Debt/GDP', uae: '~2% (lowest)', saudiArabia: '30%', qatar: '40–43%', oman: '35.5%', bahrain: '133%', kuwait: 'Low' },
  { metric: 'S&P rating', uae: 'AA (highest)', saudiArabia: null, qatar: null, oman: 'BBB-', bahrain: 'B (downgraded)', kuwait: null },
  ...
  { metric: 'HDI', uae: '0.937 (highest)', saudiArabia: null, qatar: null, oman: '0.819', bahrain: null, kuwait: null },
  { metric: 'VAT rate', uae: '5%', saudiArabia: null, qatar: null, oman: '0%', bahrain: null, kuwait: null },
]

export const tourismSector: SectorBenchmark[] = [
  ...
  { metric: 'UAE non-oil trade milestone', value: '$1 trillion first time (2025/2026)', source: 'WAM / Gulf Good News Feb 2026' },
...
export const competitorIntelligenceCards: Record<string, CompetitorCard> = {
  saudiArabia: {
    strengths:
      "2.7x UAE's oil reserves; 3.8x UAE's oil production; largest GCC economy; 25x UAE's land area; 2.7x UAE's defense budget; 3.8x UAE's active troops; Vision 2030 mega-projects (NEOM, Red Sea, Qiddiya)",
    weaknesses:
      "Lower per-capita income; lower diversification (56% non-oil vs UAE's 77%); higher taxes (20% corporate); stricter social norms; lower expat share (38% vs UAE's 88%)",
    vision: 'Vision 2030 — NEOM ($500B city), Red Sea tourism, Qiddiya entertainment city',
    uaeCompetitiveEdge:
      'Per-capita income, business efficiency, tax rates, religious tolerance, expat attractiveness, construction volume, diversification speed',
  },
  qatar: {
    strengths:
      "Highest GCC GDP per capita ($77K); near-zero unemployment (0.1%); highest trade surplus ratio (30% of GDP); world's largest LNG exporter",
    weaknesses:
      "4x smaller population; 7x smaller area; lower diversification; no VAT; higher government debt ratio (40–43%)",
  ...
  oman: {
    ...
    weaknesses:
      '5x smaller GDP; 2x smaller GDP per capita; lower diversification; smaller oil reserves; no sovereign wealth fund',
    uaeCompetitiveEdge: 'Scale, ratings, HDI, diversification, tourism infrastructure',
  },
  israel: {
    strengths:
      'Deep-tech leadership (cyber, blockchain, AI, quantum computing); Start-Up Nation ecosystem; high-tech workforce; strong defense industry',
    weaknesses: 'Small market; geopolitical risk; limited natural resources',
    postAccordsOpportunity:
      '$3B joint fund; tech transfer in AI, health, agrifood, cybersecurity; defense intelligence sharing',
    uaeCompetitiveEdge: 'Scale; government-supported AI; institutional strength; market access to 4B+ region',
  },
  turkey: {
    strengths:
      'Largest military in Middle East (PwrIndx 0.1975); large economy; cultural/soft power reach; historical influence',
    weaknesses: 'Higher inflation; weaker sovereign ratings; geopolitical exposure',
    rivalryArena:
      'Africa (ODA competition, Somaliland vs central govt support); Egypt (opposing post-Arab Spring postures)',
    uaeCompetitiveEdge:
      'Diversification speed; business environment rankings; tax efficiency; naval fleet; sovereign wealth',
  },
  singapore: {
    strengths:
      'Asian market access; geopolitical stability; rule of law; world-class education and healthcare; internet infrastructure (250 Mbps)',
...
export const urlSourceRegistry: SourceEntry[] = [
...
export const uaeRankingsOverTime: RankingsOverTime[] = [
...
export const middleEastMilitaryRankings: MilitaryRanking[] = [
...
export const uaeCompetitiveAdvantages: CompetitiveAdvantage[] = [
...
export const uaeCompetitiveVulnerabilities: CompetitiveVulnerability[] = [
...
export const sentimentAnalysisByDimension: SentimentDimension[] = [
...
export const globalStandingData = {
  // Summary
...
export default globalStandingData
