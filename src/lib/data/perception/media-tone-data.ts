...
/**
 * Media Tone Data
 * Comprehensive research data for UAE Media Tone Analysis
 * Source: 3-5-framing-analysis-results.md (Media Tone / Framing Analysis)
 *
 * This module extracts and structures all data from the MD file for the
 * perception-x2/media-tone dashboard page.
 */
...
// ============================================================================
// SOURCES DATA - Comprehensive source information
// ============================================================================
...
export interface SourceInfo {
  ...
  statistics?: Array<{ metric: string; value: string; target?: string }>
  westernMediaHeadlines?: Array<{ source: string; date: string; headline: string; tone: string }>
  theoreticalFrameworks?: string[]
  keyQuotes?: Array<{ text: string; attribution?: string } | string>
  coreArguments?: string[]
  engagementMetrics?: Array<{ metric: string; value: string }>
  sentimentAnalysis?: Array<{ segment: string; positiveSentiment: string }>
  platformPerformance?: Array<{ platform: string; role: string }>
  fourInstitutionalPillars?: string[]
  demographics?: Array<{ group: string; estimate: string }>
  economicData?: Array<{ metric: string; value: string }>
  keyFramingStatements?: string[]
  characterization?: string[]
  geopoliticalPositions?: string[]
  quotes?: Array<{ text: string; attribution: string }>
  economicGrowthTrajectory?: Array<{ year: string; gdp: string; notes: string }>
  economicIndicators2025?: Array<{ metric: string; value: string; target?: string }>
  defenseSecurity?: Array<{ metric: string; value: string }>
  technologyAI?: Array<{ metric: string; value: string; target?: string }>
  strategicInvestments?: Array<{ partnership: string; value: string }>
  spaceClimate?: Array<{ achievement: string; year: string; notes: string }>
  threeStrategicPillars?: Array<{ priority: string; pillar: string; description: string }>
  antiIslamistDetails?: string[]
  maritimeExpansion?: string[]
  domesticPowerStructure?: Array<{ element: string; details: string }>
  regionalInterventions?: Array<{ country: string; support: string; duration: string; notes: string }>
  keyAlliances?: Array<{ partner: string; nature: string; dynamics: string }>
  qatarBlockade?: { date: string; demands: string; outcome: string }
  challenges?: string[]
  campaignActors?: Array<{ actorType: string; description: string }>
  campaignCharacteristics?: Array<{ characteristic: string; description: string }>
  paradox?: string
  responseStrategy?: string[]
  westernMediaFramingPatterns?: Array<{ frame: string; description: string }>
  gulfFramingPatterns?: Array<{ frame: string; description: string }>
  dubaiCaseStudy?: Array<{ perspective: string; coverageFocus: string }>
  statisticsAlt?: Array<{ metric: string; value: string }>
  governanceDivergence?: Array<{ westernNarrative: string; gccCounterNarrative: string }>
  crisisImpact?: string[]
  authorPerspective?: string
  uaeResponse?: Array<{ action: string; outcome: string }>
  strategicOpportunity?: string[]
  investorPerspective?: string
  softPowerInfrastructure?: Array<{ initiative: string; launch: string; description: string }>
  softPowerMetrics?: Array<{ metric: string; value: string }>
  keyInstitutions?: Array<{ institution: string; role: string }>
  challengeAreas?: string[]
  keyEntities?: Array<{ entity: string; role: string }>
  methodsTechnologies?: Array<{ method: string; description: string }>
...
export const sourcesData: SourceInfo[] = [
  {
    id: 1,
  ...
  },
  {
    ...
    credibility: 'BLOCKED - Could not retrieve content',
  },
  {
    id: 3,
  ...
  },
  {
    ...
    date: 'Spring 2026',
    title: 'UAE Transforming Middle Power Through Effective Strategies',
  ...
  },
  {
    ...
    credibility: 'CONNREFUSED - Could not retrieve content',
  },
  {
    id: 10,
    name: 'SWP Berlin',
  ...
  },
  {
    ...
    title: 'Why does the UAE not respond to the frenzied media campaign?',
  ...
  },
  {
    ...
    date: 'March 12, 2026',
    title: 'Western Narratives vs Gulf Realities',
  ...
  },
  {
    ...
    date: 'April 26, 2026',
    title: 'How the UAE Engineers Global Influence Through Public Diplomacy',
  ...
  },
  {
    ...
    date: 'April 25, 2026',
    title: 'How the UAE is tackling digital misinformation and online smear campaigns',
...
// ============================================================================
// SYNTHESIZED FINDINGS - Framing Divergence
// ============================================================================
...
// ============================================================================
// FRAMING SCORECARD - Western vs Gulf Comparison
// ============================================================================
