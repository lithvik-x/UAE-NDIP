...
export const safeHavenNarrative = {
  ...
  keyDataPoints: [
    { metric: 'March 2026 strikes', value: 'Unprecedented trading suspension', context: 'Regional conflict' },
    { metric: 'Iran threat level', value: 'Active drone/missile attacks', context: 'Ongoing' },
    { metric: 'Dubai GDP (Q1-Q3 2025)', value: 'AED 355B (~$96.7B USD)', context: 'Economic resilience despite tensions' },
  ],
  sentiment: {
    overall: 'Contested',
    proSources: 8,
...
// ============================================================================
// ALL NARRATIVES (for iteration)
// ============================================================================

export const allNarratives = [
  { id: 'success-story', name: 'Success Story', data: successStoryNarrative, relevance: 'Critical' },
  { id: 'safe-haven', name: 'Safe Haven', data: safeHavenNarrative, relevance: 'High' },
  { id: 'tolerant-nation', name: 'Tolerant Nation', data: tolerantNationNarrative, relevance: 'High' },
  { id: 'innovation-hub', name: 'Innovation Hub', data: innovationHubNarrative, relevance: 'Medium' },
  { id: 'sports-power', name: 'Sports Power', data: sportsPowerNarrative, relevance: 'Medium' },
  { id: 'human-rights-violator', name: 'Human Rights Violator', data: humanRightsViolatorNarrative, relevance: 'Critical' },
  { id: 'regional-mediator', name: 'Regional Mediator', data: regionalMediatorNarrative, relevance: 'High' },
  { id: 'climate-leader', name: 'Climate Leader', data: climateLeaderNarrative, relevance: 'Critical' },
  { id: 'economic-powerhouse', name: 'Economic Powerhouse', data: economicPowerhouseNarrative, relevance: 'Critical' },
  { id: 'lavish-lifestyle', name: 'Lavish Lifestyle', data: lavishLifestyleNarrative, relevance: 'Medium' },
  { id: 'foreign-policy-aggressor', name: 'Foreign Policy Aggressor', data: foreignPolicyAggressorNarrative, relevance: 'Critical' },
  { id: 'land-of-opportunity', name: 'Land of Opportunity', data: landOfOpportunityNarrative, relevance: 'High' },
]
...
export const narrativeTrackingData = {
  // Metadata
  executionMetadata,
  keyFindings,
...
export default narrativeTrackingData
