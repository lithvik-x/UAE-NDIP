...
export const abuDhabiCommunityGroups = [
...
export const sharjahCommunityGroups = [
  ...
  { name: 'Visit Sharjah', url: 'https://www.facebook.com/VisitSharjah/', likes: 75273, focus: 'Official account showcasing Emirate of Sharjah' },
]
...
export const facebookIntelligenceData: PlatformIntelligence = {
