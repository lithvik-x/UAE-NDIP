 ...
 * Comprehensive research results for major UAE corporate entities
 *
 * Source: 1-7-corporate-entities-results.md
...
export const adnocData = {
  ...
  leadership: [
    ...
    { position: 'Director-General & CEO', name: 'Sultan Ahmed Al Jaber', notes: 'Also UAE Minister of Industry and Advanced Technology, Special Climate Envoy' },
  ] as unknown as LeadershipEntry[],
  financialData: [
...
export const mubadalaData = {
  ...
  ] as unknown as unknown as KeyTransaction[],
...
export const dpWorldData = {
  ...
  controversies: [
    ...
    },
    {
      ...
      impact: 'International criticism',
    },
  ] as Controversy[],
  strategicDevelopments: [
    {
      ...
      points: [
        'October 2024: Announced £1 billion expansion',
        '£1.3 billion ($1.30 billion) expansion plan revealed',
        'Construction began March 2025',
        "Will become UK's largest container port",
        '2025: Record 3 million TEUs handled (+52% from 1.9M in 2024)',
      ],
    },
    {
      title: 'Djibouti Dispute',
      points: [
        'Long-running 50-year concession dispute for Doraleh Container Terminal',
        'February 2018: Djibouti unilaterally terminated concession',
        'London Court of International Arbitration ruled concession still valid',
        'January 2026: Djibouti gains upper hand after arbitration setback',
      ],
    },
  ],
  sustainability: [
    { label: 'Scope 1 & 2 Emissions Reduction', value: '14% vs 2022 baseline' },
    { label: 'Renewable Energy', value: '~67% of global electricity' },
  ],
  leadershipStatements: [
    "Chairman H.E. Essa Kazim: 'Our diversified portfolio, disciplined capital allocation and focus on high-yield cargo enabled us to deliver resilient earnings and strong cash flow.'",
    "Group CEO Yuvraj Narayan: 'Ports & Terminals performed strongly, with like-for-like revenue per TEU increasing by 8.5%.'",
  ],
...
export const emiratesData = {
  ...
  financialPerformance2024_25: [
    { label: 'Emirates Airline Profit before tax', value: 'AED 21.2B ($5.8B)', change: '+20%', source: 'Emirates Group Annual Report 2024-25' },
    { label: 'Emirates Airline Revenue', value: 'AED 127.9B ($34.9B)', change: '+6%', source: 'Emirates Group Annual Report 2024-25' },
    { label: 'Emirates Airline Profit after tax', value: 'AED 19.1B ($5.2B)', source: 'Emirates Group Annual Report 2024-25' },
    { label: 'Emirates Airline Profit margin', value: '14.9%', source: 'Emirates Group Annual Report 2024-25' },
    { label: 'Emirates Airline Cash assets', value: 'AED 49.7B ($13.5B)', change: '+16%', source: 'Emirates Group Annual Report 2024-25' },
    { label: 'Emirates Airline Operating cash flow', value: 'AED 40.8B ($11.1B)', source: 'Emirates Group Annual Report 2024-25' },
    { label: 'Emirates Airline Fuel costs', value: 'AED 32.6B ($8.9B)', change: '31% of operating costs', source: 'Emirates Group Annual Report 2024-25' },
    { label: 'Emirates Group Profit before tax', value: 'AED 22.7B ($6.2B)', change: '+18%', source: 'Emirates Group Annual Report 2024-25' },
    { label: 'Emirates Group Revenue', value: 'AED 145.4B ($39.6B)', change: '+6%', source: 'Emirates Group Annual Report 2024-25' },
    { label: 'Emirates Group EBITDA', value: 'AED 42.2B ($11.5B)', change: '+6%', source: 'Emirates Group Annual Report 2024-25' },
    { label: 'Emirates Group Cash assets', value: 'AED 53.4B ($14.6B)', change: '+13%', source: 'Emirates Group Annual Report 2024-25' },
    { label: 'Emirates Group Profit after tax', value: 'AED 20.5B ($5.6B)', source: 'Emirates Group Annual Report 2024-25' },
    { label: 'Emirates Group Dividend', value: 'AED 6.0B ($1.6B)', source: 'Emirates Group Annual Report 2024-25' },
    { label: 'Emirates Group Investment', value: 'AED 14.0B ($3.8B)', source: 'Emirates Group Annual Report 2024-25' },
    { label: 'Emirates Group Workforce', value: '121,223 employees', change: '+9%', source: 'Emirates Group Annual Report 2024-25' },
  ] as OperationalMetric[],
  operationalMetrics2024_25: [
    { label: 'Passengers', value: '53.7 million', change: '+3%' },
    { label: 'Seat factor', value: '78.9%' },
    { label: 'Cargo carried', value: '2.3 million tonnes', change: '+7%' },
    { label: 'Cargo yield', value: '+10% per FTKM' },
  ] as OperationalMetric[],
  skyCargo: {
  ...
  retrofitProgramme: {
    aircraft: '219 aircraft to be retrofitted',
    investment: '$5.0 billion',
  },
  dnataPerformance: [
    { label: 'Profit before tax', value: 'AED 1.6B ($430M)', change: '+2%' },
    { label: 'Revenue', value: 'AED 21.1B ($5.8B)', change: '+10%' },
    { label: 'International revenue share', value: '75%' },
    { label: 'Aircraft turns handled', value: '794,091', change: '+2%' },
    { label: 'Cargo handled', value: '3.1 million tonnes', change: '+9%' },
    { label: 'Meals uplifted', value: '114.0 million' },
  ] as OperationalMetric[],
  safetyIncident: [
    'Flight EK521 (August 3, 2016): Boeing 777-300 crashed during landing from Thiruvananthapuram to Dubai',
    'All 282 passengers and 18 crew evacuated safely',
    'Investigation found wind shear during landing',
  ],
  subsidyControversy: [
    'Emirates publicly states opposition to state aid',
    'European/Australian carriers claimed unfair labor advantages',
    'Air France, Qantas, British Airways, Lufthansa expressed concerns',
    'American Airlines, Delta, United made similar claims in 2016',
  ],
  relevanceAssessment: {
    criticality: 'CRITICAL' as CriticalityType,
    rationale: 'Global brand, tourism',
...
export const etihadData = {
  ...
  financialPerformance2025: [
    { label: 'Profit after tax', value: 'AED 2.6B ($698M)', change: '+47% YoY', source: 'Aviation Source News' },
    { label: 'EBITDA', value: 'AED 6.3B ($1.7B)', change: '+37%', source: 'Aviation Source News' },
    { label: 'Profit margin', value: '8.4%', change: '2x global average (3.9%)', source: 'IATA estimate' },
    { label: 'Total revenue', value: 'AED 30.7B ($8.4B)', change: '+21%', source: 'Aviation Source News' },
    { label: 'Passenger revenue', value: 'AED 25.8B ($7.0B)', change: '+24%', source: 'Aviation Source News' },
    { label: 'Cargo revenue', value: 'AED 4.5B ($1.2B)', change: '+8%', source: 'Aviation Source News' },
  ] as OperationalMetric[],
  ...
  operationalMetrics2025: [
    ...
    { label: 'ASK', value: '111.5 billion seat kilometres' },
    { label: 'Cargo volumes', value: '>700,000 leg tonnes' },
  ...
  new2025Routes: ['Atlanta', 'Prague', 'Warsaw', 'Addis Ababa', 'Phnom Penh', 'Hanoi', 'Hong Kong'],
  leadership: [
  ...
  ownershipHistory: [
    'Transferred to Abu Dhabi wealth fund ADQ in October 2022',
    'Subsidiary: Air Arabia Abu Dhabi (51% ownership)',
  ],
  leadershipStatements: [
    "CEO Antonoaldo Neves: 'These results prove our strategy works—we grow sustainably, build financial strength, and provide top-quality experiences for guests.'",
    "Chairman H.E. Mohammed Ali Al Shorafa: 'The results highlight the power of long-term planning and strong execution.'",
  ],
  relevanceAssessment: {
    criticality: 'HIGH' as CriticalityType,
...
export const fabData = {
  ...
  leadership: [
    { position: 'Group CEO', name: 'Hana Al Rostamani', notes: 'Appointed January 2021' },
    { position: 'Chairman', name: 'Sheikh Tahnoun bin Zayed Al Nahyan' },
  ] as unknown as LeadershipEntry[],
  financialPerformance2024: [
    { label: 'Total Assets', value: 'AED 1.21 trillion ($330B)', source: 'FAB Annual Report 2024' },
    { label: 'Market Capitalization', value: 'AED 152B ($41.3B)', source: 'FAB Annual Report 2024' },
    { label: 'UAE Market Share', value: '27%', source: 'FAB Annual Report 2024' },
    { label: 'Group Revenue', value: 'AED 31.6B', change: '+15%', source: 'FAB Annual Report 2024' },
    { label: 'Group Net Profit', value: 'AED 17.1B', change: '+4%', source: 'FAB Annual Report 2024' },
    { label: 'Profit Before Tax', value: 'AED 19.9B', change: '+13%', source: 'FAB Annual Report 2024' },
    { label: 'Return on Tangible Equity', value: '16.8%', source: 'FAB Annual Report 2024' },
  ] as OperationalMetric[],
  ...
  relevanceAssessment: {
    criticality: 'CRITICAL' as CriticalityType,
    rationale: 'Largest bank, financial stability',
    sentiment: 'HIGHLY_POSITIVE' as SentimentType,
...
export const emiratesNbdData = {
  ...
  financialPerformance: [
    { label: '2022 Revenue', value: 'AED 32.51B ($8.86B)', source: 'Wikipedia' },
    { label: '2022 Total Assets', value: 'AED 741.96B ($202.17B)', source: 'Wikipedia' },
    { label: 'June 2025 Assets', value: 'AED 1.086 trillion ($295.7B)', source: 'Wikipedia' },
    { label: 'Brand Value', value: '$4.54 billion' },
    { label: 'FY 2025 Profit before tax', value: 'AED 29.8B (record)', source: 'Emirates NBD results' },
    { label: 'Q3 2025 Profit', value: 'AED 6.4B', change: '+23% YoY', source: 'Emirates NBD results' },
    { label: 'YTD Q3 2025 Profit', value: 'AED 19.0B', source: 'Emirates NBD results' },
    { label: 'H1 2025 Income', value: 'AED 23.9B', change: '+12%', source: 'Emirates NBD results' },
    { label: 'Group EPS', value: 'AED 3.71', change: '2024: AED 3.56', source: 'Emirates NBD results' },
  ] as OperationalMetric[],
  operationalScale: [
  ...
  digitalBanking: [
    'Liv digital bank: ~500,000 users',
  ],
  relevanceAssessment: {
    criticality: 'HIGH' as CriticalityType,
    rationale: 'Banking leadership',
    sentiment: 'POSITIVE' as SentimentType,
...
export const adcbData = {
  ...
  financialPerformance: [
    ...
    { label: 'Combined entity assets', value: 'Dh420B', change: 'post-merger' },
  ...
  operationalScale: [
    ...
    { label: 'Services', value: 'Retail, commercial, investment, merchant banking, brokerage, fund management' },
  ] as OperationalMetric[],
  leadership: [
    { position: 'CEO', name: 'Eldar Sarkamov', notes: 'Appointed 2024' },
  ] as unknown as LeadershipEntry[],
  january2019Merger: {
...
export const dibData = {
  ...
  notableLegalMatter: [
    'Principal complainant in Ryan Cornelius fraud case',
    'Cornelius convicted 2010, sentenced 10 years',
    'Reported liabilities exceeding $400 million',
  ],
  relevanceAssessment: {
    criticality: 'HIGH' as CriticalityType,
...
export const duData = {
  ...
  networkCapabilities: [
    '2G, 3G, 4G LTE, 5G services',
    '5G launched June 2019 (first in UAE)',
    'First MENA mmWave 5G deployment (2020)',
  ],
  relevanceAssessment: {
    criticality: 'HIGH' as CriticalityType,
...
export const emaarData = {
  ...
  marassiEgypt: {
    ...
    size: '2,400 acres',
    development: '6.5 million square meters',
    beaches: '5',
    hotelsPlanned: '23',
    unitSizes: 'From 65 sqm',
    paymentPlans: 'Up to 12 years',
  },
  relevanceAssessment: {
    criticality: 'HIGH' as CriticalityType,
...
export const luluData = {
  ...
  globalPresence: [
    { country: 'UAE', storeCount: '175 stores' },
    { country: 'Saudi Arabia', storeCount: '34 stores' },
    { country: 'Oman', storeCount: '35 stores' },
    { country: 'Qatar', storeCount: '22 stores' },
    { country: 'Bahrain', storeCount: '11 stores' },
    { country: 'Kuwait', storeCount: '6 stores' },
    { country: 'Yemen', storeCount: '1 store' },
    { country: 'Egypt', storeCount: '3 stores' },
    { country: 'India', storeCount: '12 stores', note: 'Kochi, Bengaluru, Lucknow, Coimbatore, Thiruvananthapuram, Palakkad, Kottayam, Hyderabad, Kozhikode' },
    { country: 'Malaysia/Indonesia', storeCount: '2 stores' },
    { country: 'Suriname', storeCount: '1 store' },
    { country: 'UK', storeCount: 'Birmingham logistics facility' },
  ],
  businessSegments: [
  ...
  financialGrowthMetrics: [
    ...
    { label: 'GCC Hypermarkets', value: '200+', date: 'September 2024' },
...
export const alHabtoorData = {
  ...
  hotelsInAlHabtoorCity: [
    { hotel: 'Habtoor Palace Dubai' },
    { hotel: 'V Hotel' },
    { hotel: 'Curio Collection by Hilton' },
    { hotel: 'Hilton Dubai Al Habtoor City' },
    { hotel: 'Metropolitan Hotel Dubai' },
    { hotel: 'Al Habtoor Polo' },
  ],
  relevanceAssessment: {
    criticality: 'MEDIUM' as CriticalityType,
...
export const microsoftUaeData = {
  investmentAnnouncement: [
    { date: 'November 3, 2025', details: 'Announced $15.2 billion investment plan in UAE through 2029' },
    { date: '2023-end 2025', details: '$7.3 billion already invested' },
    { date: '2026-2029', details: 'Further $7.9 billion earmarked' },
  ],
  strategicFocus: [
  ...
  regionalPresence: [
    'Dubai office: careers in sales and services',
    'Gulf Regional Office: Bahrain, Kuwait, Oman, Qatar, UAE',
  ],
  relevanceAssessment: {
    criticality: 'HIGH' as CriticalityType,
...
export const awsUaeData = {
  ...
  march2026Incident: [
    { date: 'March 2, 2026', event: 'Drones damaged three facilities in UAE and Bahrain' },
    { date: 'Impact', event: 'Data centers "directly struck"' },
    { date: 'Cause', event: 'US-Iran tensions' },
    { date: 'Result', event: 'AWS outage in UAE following drone strikes' },
  ],
  relevanceAssessment: {
    criticality: 'MEDIUM' as CriticalityType,
...
export const hsbcUaeData = {
  ...
  uaeEconomyAssessment: [
    'Bloomberg (September 2025): UAE one of strongest performing economies in CEEMEA',
    'Chief Economist: Simon Williams',
  ],
  relevanceAssessment: {
    criticality: 'MEDIUM' as CriticalityType,
...
export const mcKinseyData = {
  ...
  companyCulture: [
    'Glassdoor rating: 3.9/5 (146 reviews)',
  ],
  relevanceAssessment: {
...
export const financialPerformanceTable: FinancialPerformance[] = [
  ...
  { entity: 'Du', revenue: '$15.9B', profit: '$2.49B', margin: '15.7%' },
]
