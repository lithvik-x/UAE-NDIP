// @ts-nocheck
/**
 * Media & Communications Topic Data
 * UAE National Digital Intelligence Platform
 *
 * Comprehensive data extracted from 2-7-media-communications-results.md
 * All content from the MD file has been hardcoded as TypeScript data
 */

import type { TopicAnalysis, TopicMetrics } from '../types'

// ============================================================================
// INTERFACES
// ============================================================================

export interface PressFreedomIndex {
  year: number
  score: number
  rank: number
...
export interface JournalistCase {
  individual: string
  details: string
  status: string
}
...
export interface JournalistSalary {
  source: string
  amount: string
  period: string
  details: string
...
export interface GpsDisruptionEvent {
  date: string
...
export interface MediaFreeZone {
  emirate: string
  benefits: string[]
}

export interface ForeignInvestment {
  entity: string
  details: string
}

export interface AlJazeeraBlocking {
  date: string
  event: string
...
export interface VpnPenalty {
  offense: string
  penalty: string
}

export interface VoipBlocked {
  service: string
  status: string
  since?: string
}

export interface GamingAgeRating {
...
// ============================================================================
// COMPLETE DATA FROM MD FILE
// ============================================================================

export const mediaCommunicationsMetrics: TopicMetrics = {
  volume: 160000,
  reach: 9.94,
  engagement: 68,
  description: 'Media regulation, press freedom, influencer licensing, internet restrictions, advertising market',
}

export const mediaCommunicationsOverview = {
  title: 'Media & Communications',
  description: 'Comprehensive analysis of UAE media environment including regulation, press freedom, influencer licensing, internet restrictions, and media market dynamics',
...
export const keyMetrics: KeyMetric[] = [
  { label: 'Press Freedom Index (RSF 2025)', value: '26.91/100 (164th of 180)', trend: 'Declining 5+ years' },
  { label: 'Internet Freedom Score', value: '28/100 "Not Free"', trend: 'Static' },
  { label: 'Advertising Market 2025', value: 'USD 3.6 billion', trend: 'Growing 5.36% CAGR' },
  { label: 'Digital Media Market 2030', value: 'USD 18.5 billion', trend: 'Growing 12.2% CAGR' },
  { label: 'VPN Apps Downloaded 2025', value: '9.6 million', trend: 'Steady increase' },
  { label: 'Websites Blocked', value: '160,000+', trend: 'Expanding' },
  { label: 'Influencer License Deadline', value: 'January 31, 2026', trend: 'Imminent' },
]
...
export const pressFreedomData: PressFreedomIndex[] = [
...
export const contentStandards: ContentStandard[] = [
  { requirement: 'Respect divine and Islamic beliefs and all religions' },
  { requirement: 'Respect UAE sovereignty, symbols, and institutions' },
  { requirement: 'Avoid actions hurting UAE\'s foreign relations' },
  { requirement: 'Respect culture, national identity, and values' },
  { requirement: 'Refrain from disseminating information compromising national unity' },
  { requirement: 'Refrain from inciting violence' },
  { requirement: 'Respect privacy' },
  { requirement: 'Refrain from publishing rumors, false news, or content instigating crimes' },
]

export const mediaFreeZones: MediaFreeZone[] = [
  {
    emirate: 'Dubai',
    benefits: ['100% foreign ownership permitted', 'Tax-free environment', 'No customs duties'],
  },
  {
    emirate: 'Abu Dhabi',
    benefits: ['100% foreign ownership permitted', 'Tax-free environment', 'No customs duties'],
...
export const mediaTimeline: MediaTimelineEvent[] = [
...
export const mediaOutlets: MediaOutlet[] = [
  ...
  { name: 'Al Khaleej', type: 'newspaper', circulation: '', ownership: 'Privately owned (with government ties)' },
...
export const governmentStatement = {
...
// ============================================================================
// INFLUENCER & SOCIAL MEDIA LICENSING
// ============================================================================

export const influencerLicenseDeadline = {
...
export const processingTime = '3 working days'
...
// ============================================================================
// CONTENT VIOLATIONS & PENALTIES
// ============================================================================

export const violationCategories: ViolationPenalty[] = [
  {
    severity: 'Fourth Degree (Most Severe)',
    violationType: 'Disrespect for divine entity, Islam, other religions',
    minFine: 100000,
    maxFine: 1000000,
  },
  {
    severity: 'Fourth Degree',
    violationType: 'Promotion of sectarianism, violence, or terrorism',
    minFine: 100000,
    maxFine: 500000,
  },
  {
    severity: 'Third Degree',
    violationType: 'Disrespect for UAE regime, symbols, institutions',
    minFine: 50000,
    maxFine: 500000,
  },
  {
    severity: 'Third Degree',
    violationType: 'Content harmful to foreign relations',
    minFine: 30000,
    maxFine: 250000,
  },
  {
    severity: 'Third Degree',
    violationType: 'Undermining foreign relations or social cohesion',
    minFine: 0,
    maxFine: 250000,
  },
  {
    severity: 'Second Degree',
    violationType: 'Publishing immoral, misleading, or fake content',
    minFine: 10000,
    maxFine: 100000,
  },
  {
    severity: 'Second Degree',
    violationType: 'Inciting crimes (murder, rape, drug abuse)',
    minFine: 0,
    maxFine: 150000,
  },
  {
    severity: 'Second Degree',
    violationType: 'Violation of privacy or children\'s rights',
    minFine: 5000,
    maxFine: 100000,
  },
  {
    severity: 'Second Degree',
    violationType: 'Failure to adhere to age classifications',
    minFine: 5000,
    maxFine: 100000,
  },
  {
    severity: 'First Degree (Least Severe)',
    violationType: 'Operating without license',
    minFine: 10000,
    maxFine: 40000,
  },
  {
    severity: 'First Degree',
    violationType: 'Publishing with expired license',
    minFine: 10000,
    maxFine: 20000,
  },
  {
    severity: 'First Degree',
    violationType: 'Failure to renew',
    minFine: 150,
    maxFine: 3000,
    notes: 'Dh150/day, capped at Dh3,000',
  },
  {
    severity: 'First Degree',
    violationType: 'Disseminating false information',
    minFine: 5000,
    maxFine: 10000,
  },
  {
    severity: 'First Degree',
    violationType: 'License misuse',
    minFine: 0,
    maxFine: 20000,
  },
]
...
export const enforcementMechanisms = [
  {
    mechanism: 'AI Monitoring',
    details: 'NMA deployed AI-powered monitoring in May 2025',
  },
  {
    mechanism: 'Committee',
    details: 'Media Content Standards Violations Committee (3-7 media experts)',
  },
  {
    mechanism: 'Appeals',
    details: '15-day window; decisions within 15 days',
  },
  {
    mechanism: 'Additional sanctions',
    details: 'Activity suspension, license revocation, criminal proceedings',
  },
]

export const detentionCases2026: DetentionCase[] = [
  {
    case: 'British tourist (60)',
    details: 'Charged for filming missiles; immediately deleted video when asked',
  },
  {
    case: 'Filipina domestic worker',
    details: 'Detained near Burj Al Arab for taking photo while waiting for work',
  },
  {
    case: 'Vietnamese sailor',
    details: 'Detained in Fujairah for sharing video of missile activity',
  },
  {
    case: 'Influencer (300K views)',
    details: 'Told to delete video and post correction; others arrested for same',
  },
]
...
export const gulfComparison2025 = [
...
export const globalContext = '412.5 million VPN downloads worldwide in 2025'

export const voipBlocked: VoipBlocked[] = [
...
export const legalAlternatives = ['BOTIM', 'C\'Me (require paid subscriptions)']
...
export const internetInfrastructure: InternetInfrastructure[] = [
...
export const advertisingMarket = {
...
export const digitalAdvertising: AdMetric[] = [
...
export const advertisingSegments: AdSegment[] = [
...
export const dominantPlatforms = [
  'Instagram',
  'Snapchat',
  'Facebook (74% of social media usage in 2018)',
]

export const majorStreaming = [
...
export const telegraphAcquisition = {
  ...
  keyEntities: [
    {
      name: 'RedBird IMI',
      role: 'Bidding vehicle, majority-owned by International Media Investments',
    },
    {
      name: 'Controlled by',
      role: 'Sheikh Mansour bin Zayed Al Nahyan (UAE Vice President)',
    },
    {
      name: 'Promise',
      role: 'Journalists would receive "total editorial freedom"',
    },
  ],
}
...
export const otherMediaInvestments = [
  {
    investors: 'Saudi Arabia, Abu Dhabi, Qatar',
    amount: 'Contributing $24 billion to Paramount\'s bid',
  },
  {
    investors: 'Live Nation and WWE',
    backing: 'Backed by Gulf sovereign funds',
  },
  {
    investors: 'RedBird Capital',
    involvement: 'Involved in media investments',
  },
]

// ============================================================================
// JOURNALIST CASES & DETENTIONS
// ============================================================================

export const journalistCases: JournalistCase[] = [
  {
    individual: 'Egyptian dissident',
    details: 'Extradited to UAE after criticizing government on social media',
    status: 'Detained',
  },
  {
    individual: 'British tourist (60)',
    details: 'Charged under cybercrime laws for filming Iranian missiles',
    status: 'Charged',
  },
  {
    individual: 'Mohammed Harun Arsalai',
    details: 'US-Afghan journalist, held without charge at Dubai Central Jail',
    status: 'Detained approximately 1 month',
  },
  {
    individual: 'William Deng Dut Koor',
    details: 'South Sudanese critic, deported to Juba after arrest',
    status: 'Deported',
  },
  {
    individual: '11 Egyptian journalists',
    details: 'Detained by UAE authorities in 2013',
    status: 'Detained',
  },
]

export const legalFrameworkDetentions = {
...
export const contentManipulation = [
...
// ============================================================================
// AL JAZZEERA & MEDIA BLOCKING
// ============================================================================

export const alJazeeraBlocking: AlJazeeraBlocking[] = [
  {
    date: 'May 2017',
    event: 'UAE, Saudi Arabia, Egypt, Bahrain block Al Jazeera following Qatar diplomatic crisis',
  },
  {
    date: '2017-2023/2024',
    event: 'Al Jazeera inaccessible in UAE',
  },
  {
    date: '2024/2025',
    event: 'Al Jazeera unblocked (after 6-year ban)',
  },
]
...
export const blocksImplemented = [
  'Al Jazeera Live website blocked',
  'Al Jazeera Riyadh and Amman bureaus closed',
  'Other Qatari newspapers\' websites blocked',
]

export const rsfResponse = 'Called blocking "unacceptable"'

export const otherBlockedMedia = [
  'Middle East Eye',
  'The New Arab',
...
// ============================================================================
// GPS JAMMING & SATELLITE ISSUES
// ============================================================================

export const gpsDisruptionEvents: GpsDisruptionEvent[] = [
  {
    date: 'March 7, 2026',
    shipsAffected: '1,650+ in Middle East',
    increase: '55% increase',
  },
  {
    date: 'Feb 28, 2026',
    shipsAffected: 'Approximately 1,100 within 24 hours of US strikes',
  },
]

export const affectedAreas = ['Kuwait', 'Iran', 'Saudi Arabia', 'Oman', 'UAE']

export const phenomenaObserved = [
...
export const technicalMethods = [
  {
    method: 'Jamming',
    description: 'Blocks GPS signals, makes it hard to receive satellite positioning',
  },
  {
    method: 'Spoofing',
    description: 'Sends false signals broadcasting wrong location',
  },
]

export const expertQuoteGps = {
...
export const expertWarnings = [
  {
    speaker: 'Elliott Sanders, RSA',
    quote: 'The first casualty of future conflicts is going to be GPS - civilians will continue to be affected given GPS prevalence',
  },
  {
    speaker: 'Jim Stroup, SandboxAQ',
    quote: 'GPS signals are extremely weak...relatively easy to interfere with',
  },
]

// ============================================================================
// OTT/STREAMING REGULATION
// ============================================================================

export const netflixStreaming = [
  {
    issue: 'Content caution',
    details: 'UAE authorities cautioned Netflix over inappropriate content',
  },
  {
    issue: 'LGBTQ content',
    details: 'Gulf Arab countries asked Netflix to remove "offensive content" targeting LGBTQ individuals',
  },
  {
    issue: 'Cancellation difficulty',
    details: '"Click to cancel" rule being implemented; aimed at making cancelling as easy as signing up',
  },
]
...
export const regulatoryApproach = [
...
export const gamingAgeRating: GamingAgeRating = {
  administeringBody: 'National Media Authority (NMA)',
  fee: 'AED 500',
  processingDays: '5 working days',
  requirement: 'Government to Business (G2B)',
}

export const gamingRequirements = [
...
export const trainingInstitutions: TrainingInstitution[] = [
  {
    ...
    contact: 'Notable clients: World Government Summit, Global Village, Expo City Dubai, ADNOC',
  },
  {
  ...
  },
  {
    ...
    contact: 'Notable trainer: Eve Hester (BBC-trained director/journalist)',
  },
  {
...
// ============================================================================
// JOURNALIST SALARIES & EMPLOYMENT
// ============================================================================

export const journalistSalaries: SalaryRange[] = [
  {
    source: 'Indeed',
    averageSalary: 'AED 5,878/month',
    details: 'Based on 6 reported salaries (Dec 2025)',
  },
  {
    source: 'GrabJobs',
    averageSalary: 'AED 3,500/month',
    details: 'Average; AED 42,000/year',
  },
  {
    source: 'Payscale',
    averageSalary: 'AED 40,000/month',
    details: 'Mid-career (5-9 years experience), based on 5 salaries',
  },
  {
    source: 'Glassdoor (Dubai)',
    averageSalary: '$18,467/year',
    details: 'Journalist in Dubai',
  },
  {
    source: 'Glassdoor (Abu Dhabi)',
    averageSalary: '$35,177/year',
    details: 'Multimedia Journalist in Abu Dhabi',
  },
  {
    source: 'SalaryExpert',
    averageSalary: 'AED 165,559/year',
    details: 'Average journalist media gross salary; AED 80/hour',
  },
]
...
export const realityVsNarrative = {
  ifexAssessment: [
...
export const keyDataSummary: DashboardMetric[] = [
...
export const regulatoryTimeline: RegulatoryTimeline[] = [
...
export const urlSources: URLSource[] = [
...
export const sentimentDimensions: SentimentDimension[] = [
...
export const positiveElements: PositiveElement[] = [
...
export const keyNarratives: KeyNarrative[] = [
  {
...
export const dashboardRecommendations: DashboardRecommendation[] = [
  {
    ...
    metrics: [
      'Number of media licenses issued',
      'Compliance rate (licenses vs. active influencers)',
  ...
  },
  {
    ...
    metrics: [
      'Advertising market size (USD billions)',
      'Digital ad spend percentage',
  ...
  },
  {
    ...
    metrics: [
      'RSF ranking (inverse scale)',
      'RSF score (inverse scale)',
      'Freedom House score',
    ],
  },
  {
...
export const keyDefinitions: Definition[] = [
...
export const enrichmentMetadata = {
  ...
  enrichmentCriteria: [
    'All URLs identified and content summarized',
    'All facts traceable to source',
    'All statistics with citations',
    'Contextual information (who/what/when/where/why/how) extracted',
    'Sentiment analysis completed',
    'UAE relevance assessed',
    'Dashboard-ready format achieved',
  ],
...
export const mediaCommunicationsData: TopicAnalysis = {
  overview: mediaCommunicationsOverview,
  metrics: mediaCommunicationsMetrics,
  description: 'Media regulation, press freedom, influencer licensing, internet restrictions, advertising market, foreign investment, journalist cases, Al Jazeera blocking, GPS jamming, streaming regulation, gaming safety, training, salaries',
  keyFindings: [], // Populated from data above as needed
  sentiment: {
    positive: 30,
    neutral: 20,
    negative: 50,
...
export default mediaCommunicationsData
