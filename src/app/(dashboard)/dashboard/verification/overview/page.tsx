                ...
                <Card className="glass-card">
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-slate-400">Real-time Recognition</span>
                        <Badge className="bg-emerald-500/20 text-emerald-400 border-emerald-500/50">Active</Badge>
                      </div>
                      <div className="flex items-center justify-between">
                        <span className="text-slate-400">AI Arrests (2018)</span>
                        <span className="font-bold text-emerald-400">319 suspects</span>
                      </div>
                      <div className="flex items-center justify-between">
                        <span className="text-slate-400">Smart Police Stations</span>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="font-bold text-blue-400">Abu Dhabi + Airport + Islands</span>
                      </div>
                      <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-slate-400">Cameras at Tourist Sites</span>
                ...
                <CardContent>
                  <div className="grid gap-4 sm:grid-cols-4">
                    ...
                    <div className="rounded-lg border border-slate-700 bg-slate-800/50 p-4 text-center">
                      ...
                      <p className="text-sm text-slate-400">US Contractors</p>
                    </div>
                    <div className="rounded-lg border border-slate-700 bg-slate-800/50 p-4 text-center">
                      <div className="text-2xl font-bold text-rose-400">2008</div>
                      <p className="text-sm text-slate-400">Contract Start</p>
                    </div>
                    <div className="rounded-lg border border-slate-700 bg-slate-800/50 p-4 text-center">
                      <div className="text-2xl font-bold text-rose-400">$1.685M</div>
                      <p className="text-sm text-slate-400">Fines (2021)</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent>
                  <div className="grid gap-4 sm:grid-cols-4">
                    <div className="rounded-lg border border-slate-700 bg-slate-800/50 p-4 text-center">
                      ...
                      <p className="text-sm text-slate-400">Data Points/Day</p>
                    </div>
                    <div className="rounded-lg border border-slate-700 bg-slate-800/50 p-4 text-center">
                      <div className="text-2xl font-bold text-emerald-400">AED 1B+</div>
                      <p className="text-sm text-slate-400">Annual Efficiency</p>
                    </div>
                    <div className="rounded-lg border border-slate-700 bg-slate-800/50 p-4 text-center">
                      <div className="text-2xl font-bold text-emerald-400">2M+</div>
                      <p className="text-sm text-slate-400">Labor Hours Saved</p>
                    </div>
                    <div className="rounded-lg border border-slate-700 bg-slate-800/50 p-4 text-center">
                ...
                <CardContent>
                  <div className="grid gap-4 sm:grid-cols-5">
                    <div className="rounded-lg border border-slate-700 bg-slate-800/50 p-4 text-center">
                      ...
                      <p className="text-sm text-slate-400">Killed</p>
                    </div>
                    <div className="rounded-lg border border-slate-700 bg-slate-800/50 p-4 text-center">
                    ...
                    <div className="rounded-lg border border-slate-700 bg-slate-800/50 p-4 text-center">
                      ...
                      <p className="text-sm text-slate-400">Missiles Intercepted</p>
                    </div>
                    <div className="rounded-lg border border-slate-700 bg-slate-800/50 p-4 text-center">
                      <div className="text-2xl font-bold text-emerald-400">2,256</div>
                      <p className="text-sm text-slate-400">Drones Intercepted</p>
                    </div>
                    <div className="rounded-lg border border-slate-700 bg-slate-800/50 p-4 text-center">
                      <div className="text-2xl font-bold text-orange-400">21</div>
                      <p className="text-sm text-slate-400">People Charged</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
                        ...
                        >
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-sm text-slate-400">{entity.function}</p>
                            </div>
                          </div>
                          {entity.acronym && (
                        ...
                        >
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-sm text-slate-400">{program.type} — {program.operator}</p>
                            </div>
                          </div>
                        ...
                        >
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-sm text-slate-400">{person.role} — {person.affiliation}</p>
                            </div>
                          </div>
                      ...
                      {uaeRelevanceAssessment.map((item, idx) => (
                        ...
                        >
                          <div className="flex-1">
                            ...
                            <p className="text-sm text-slate-400 mt-1">{item.classification}</p>
                          </div>
                    ...
                    <div className="space-y-4">
                      {sentimentAnalysis.map((item, idx) => (
                        ...
                        >
                          ...
                          <p className="text-sm text-slate-400 mb-2">{item.keyNarrative}</p>
                  ...
                  <ScrollArea className="h-[400px]">
                    <div className="space-y-2">
                      {sourceCredibilityMatrix.slice(0, 20).map((source, idx) => (
                        ...
                        >
                          <div className="flex-1">
                            <p className="font-medium text-slate-200 text-sm">{source.name}</p>
                ...
                <CardContent>
                  <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    <div className="rounded-lg border border-rose-500/30 bg-rose-500/10 p-4 text-center">
                      ...
                      <p className="text-sm text-slate-400">Journalists Lost Jobs</p>
                    </div>
                    <div className="rounded-lg border border-slate-700 bg-slate-800/50 p-4 text-center">
                      <div className="text-2xl font-bold text-slate-200">Sep 13, 2022</div>
                      <p className="text-sm text-slate-400">Incident Date</p>
                    </div>
                    <div className="rounded-lg border border-slate-700 bg-slate-800/50 p-4 text-center">
                      <div className="text-2xl font-bold text-slate-200">IMI</div>
                      <p className="text-sm text-slate-400">Publisher (Sheikh Mansour)</p>
                    </div>
                    <div className="rounded-lg border border-rose-500/30 bg-rose-500/10 p-4 text-center">
                      <div className="text-lg font-bold text-rose-400">Economic Impact Story</div>
                      <p className="text-sm text-slate-400">Trigger: Fuel prices article</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
                  ...
                  <div className="grid gap-4 sm:grid-cols-3">
                    {mediaAboutMediaData.extendedData?.surveillanceInfrastructure.map((sys, idx) => (
                      ...
                      >
                        ...
                        <p className="text-sm text-slate-400 mb-1">Location: {sys.location}</p>
                        <p className="text-sm text-slate-400 mb-1">Scale: {sys.scale}</p>
                        <p className="text-xs text-slate-500">{sys.capability}</p>
                      </motion.div>
                    ))}
                  </div>
                </CardContent>
                  ...
                  <ScrollArea className="h-[300px]">
                    <div className="space-y-2">
                      {mediaAboutMediaData.extendedData?.summaryDataPoints.map((point, idx) => (
                        ...
                        >
                          <div className="flex-1">
                            <p className="text-sm text-slate-300">{point.metric}</p>
                            <p className="text-xs text-slate-500">{point.category} | Source: {point.source}</p>
                          </div>
                          <div className="text-right">
                            <p className="text-lg font-bold text-emerald-400">{point.value}</p>
                            <p className="text-xs text-slate-500">{point.extractionStatus}</p>
                          </div>
                        </motion.div>
                      ))}
                    </div>
                      ...
                      {cibMetrics.takedowns.map((takedown, idx) => (
                        ...
                        >
                          <div className="flex items-start justify-between mb-3">
                            <div>
                              <h4 className="font-semibold text-slate-200">{takedown.date} — {takedown.origin}</h4>
                              <p className="text-sm text-slate-400">Attribution: {takedown.attribution}</p>
                            </div>
                            <Badge variant="destructive" className="bg-red-500/20 text-red-400 border-red-500/50">
                  ...
                  <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                    {cibMetrics.detectionIndicators.map((indicator, idx) => (
                      ...
                      >
                        ...
                        <p className="text-sm text-slate-400 mb-2">Threshold: {indicator.threshold}</p>
                      ...
                      {cibMetrics.tactics.map((tactic, idx) => (
                        ...
                        >
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <p className="font-semibold text-slate-200">{tactic.name}</p>
                      ...
                      {cibMetrics.marketingFirms.map((firm, idx) => (
                        ...
                        >
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <p className="font-semibold text-slate-200">{firm.name}</p>
                              <p className="text-sm text-slate-400">{firm.country} • {firm.role}</p>
                            </div>
                          </div>
                          <div className="text-right">
                            <p className="text-xs text-slate-400">{firm.operationDate}</p>
                            <Badge
                  ...
                  <ScrollArea className="h-[300px]">
                    <div className="space-y-3">
                      {cibMetrics.narrativeThemes.map((narrative, idx) => (
                        ...
                        >
                          <div className="flex items-start justify-between mb-2">
                            <p className="font-medium text-slate-200">{narrative.theme}</p>
                            <Badge
                          ...
                          <div className="flex items-center gap-4 text-xs text-slate-400">
                            <span>Target: <span className="text-slate-300">{narrative.target}</span></span>
                            <span>Source: <span className="text-slate-300">{narrative.sourceType}</span></span>
                    ...
                    <table className="w-full text-sm">
                      <thead>
                        <tr className="border-b border-slate-700">
                          ...
                          <th className="text-left p-3 text-slate-400">Policy Strength</th>
                          <th className="text-left p-3 text-slate-400">Enforcement</th>
                          <th className="text-left p-3 text-slate-400">Transparency</th>
                          <th className="text-left p-3 text-slate-400">Detection</th>
                        </tr>
                      </thead>
                      <tbody>
                        {cibMetrics.platformComparison.map((platform, idx) => (
                          ...
                          >
                            <td className="p-3 font-semibold text-slate-200">{platform.platform}</td>
                            <td className="p-3">
                              <Badge className={platform.policyStrength === 'Comprehensive' ? 'bg-emerald-500/20 text-emerald-400 border-emerald-500/50' : 'bg-slate-500/20 text-slate-400 border-slate-500/50'}>
                                {platform.policyStrength}
                              </Badge>
                            </td>
                            <td className="p-3 text-slate-300">{platform.enforcement}</td>
                            <td className="p-3">
                              <Badge className={platform.transparency === 'High' ? 'bg-emerald-500/20 text-emerald-400 border-emerald-500/50' : platform.transparency === 'Moderate' ? 'bg-yellow-500/20 text-yellow-400 border-yellow-500/50' : 'bg-slate-500/20 text-slate-400 border-slate-500/50'}>
                                {platform.transparency}
                              </Badge>
                            </td>
                            <td className="p-3">
                              <Badge className={platform.detectionCapability === 'Advanced' ? 'bg-emerald-500/20 text-emerald-400 border-emerald-500/50' : platform.detectionCapability === 'Basic' ? 'bg-yellow-500/20 text-yellow-400 border-yellow-500/50' : 'bg-blue-500/20 text-blue-400 border-blue-500/50'}>
                ...
                <CardContent>
                  <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                    {cibMetrics.uaeThreatLevels.map((threat, idx) => (
                      ...
                      >
                        <div className="flex items-center justify-between mb-2">
                          <h4 className="font-semibold text-slate-200">{threat.target}</h4>
                          <Badge
                        ...
                        <p className="text-sm text-slate-400 mb-2">{threat.primaryNarrative}</p>
                        <p className="text-xs text-slate-500">Engagement: {threat.engagementLevel}</p>
                      </motion.div>
                    ))}
                  </div>
                </CardContent>
                  ...
                  <ScrollArea className="h-[200px]">
                    <div className="space-y-3">
                      {cibMetrics.sourceCredibility.map((source, idx) => (
                        ...
                        >
                          <div>
                            <Badge className="mb-1 bg-blue-500/20 text-blue-400 border-blue-500/50">{source.tier}</Badge>
                            <p className="font-semibold text-slate-200">{source.sourceType}</p>
                            <p className="text-sm text-slate-400">{source.examples}</p>
                          </div>
                          <Badge className={source.reliability === 'Very High' || source.reliability === 'High' ? 'bg-emerald-500/20 text-emerald-400 border-emerald-500/50' : 'bg-yellow-500/20 text-yellow-400 border-yellow-500/50'}>
                            {source.reliability}
                          </Badge>
                        </motion.div>
                      ))}
                      ...
                      {visualMultimediaExtendedData.viralContentMetrics.map((item, idx) => (
                        ...
                        >
                          <div className="flex items-center gap-4">
                            ...
                            <div>
                              <p className="font-semibold text-slate-200">{item.contentType}</p>
                              <p className="text-sm text-slate-400">{item.platform} - {item.metric}</p>
                            </div>
                          </div>
                          <div className="text-right">
                    ...
                    {visualMultimediaExtendedData.threatDashboardKPIs.map((threat, idx) => (
                      ...
                      >
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            <p className="font-semibold text-slate-200">{threat.threatType}</p>
                            <p className="text-sm text-slate-400">{threat.keyFinding}</p>
                          </div>
                        </div>
                        <div className="flex items-center gap-2">
                          <Badge className={`${threat.fetchStatus === 'SUCCESS' ? 'bg-emerald-500/20 text-emerald-400 border-emerald-500/50' : 'bg-slate-500/20 text-slate-400 border-slate-500/50'}`}>
                            {threat.fetchStatus}
                          </Badge>
                    ...
                    <div className="space-y-4">
                      <div className="grid grid-cols-2 gap-4">
                        <div className="rounded-lg border border-slate-700 bg-slate-800/50 p-3 text-center">
                          ...
                          <p className="text-xs text-slate-400">Missions (2019)</p>
                        </div>
                        <div className="rounded-lg border border-slate-700 bg-slate-800/50 p-3 text-center">
                          <div className="text-xl font-bold text-blue-400">{visualMultimediaExtendedData.cloudSeedingData.costPerOperation}</div>
                          <p className="text-xs text-slate-400">Cost/Operation</p>
                        </div>
                        <div className="rounded-lg border border-slate-700 bg-slate-800/50 p-3 text-center">
                          <div className="text-xl font-bold text-cyan-400">{visualMultimediaExtendedData.cloudSeedingData.effectivenessClear}</div>
                          <p className="text-xs text-slate-400">Effectiveness (Clear)</p>
                        </div>
                        <div className="rounded-lg border border-slate-700 bg-slate-800/50 p-3 text-center">
                          <div className="text-xl font-bold text-slate-400">{visualMultimediaExtendedData.cloudSeedingData.aircraft}</div>
                          <p className="text-xs text-slate-400">Aircraft Fleet</p>
                        </div>
                      </div>
                      <div className="space-y-2">
                        <div className="flex items-center justify-between text-sm">
                          <span className="text-slate-400">Technology</span>
                          <span className="text-slate-300">Hygroscopic (KCl, NaCl)</span>
                        </div>
                        <div className="flex items-center justify-between text-sm">
                          <span className="text-slate-400">Weather Stations</span>
                          <span className="text-slate-300">{visualMultimediaExtendedData.cloudSeedingData.weatherStations} networked</span>
                        </div>
                        <div className="flex items-center justify-between text-sm">
                          <span className="text-slate-400">Doppler Radars</span>
                          <span className="text-slate-300">{visualMultimediaExtendedData.cloudSeedingData.dopplerRadars} stationary + 1 mobile</span>
                        </div>
                        <div className="flex items-center justify-between text-sm">
                          <span className="text-slate-400">Drone Technology</span>
                          <span className="text-slate-300">Since 2021</span>
                        </div>
                      </div>
                    </div>
                  </CardContent>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      ...
                      <div className="rounded-lg border border-blue/30 bg-blue/10 p-4">
                        <h4 className="font-semibold text-blue-400">Eid Al Etihad 2025</h4>
                        <div className="mt-2 space-y-1 text-sm text-slate-300">
                    ...
                    <div className="space-y-2">
                      {visualMultimediaExtendedData.sourceCredibilityMatrix.slice(0, 12).map((source, idx) => (
                        ...
                        >
                          ...
                          <div className="flex items-center gap-2">
                            <Badge className={`${source.fetchStatus === 'SUCCESS' ? 'bg-emerald-500/20 text-emerald-400 border-emerald-500/50' : 'bg-slate-500/20 text-slate-400 border-slate-500/50'}`}>
                              {source.fetchStatus}
                            </Badge>
                            {getTierBadge(source.tier)}
                          </div>
                        ...
                        {visualMultimediaExtendedData.entityRegistry.slice(0, 10).map((entity, idx) => (
                          ...
                          >
                            <div className="flex items-center gap-2">
                              ...
                              <span className="text-sm text-slate-200">{entity.entity}</span>
                            </div>
                            <Badge className={`text-xs ${entity.uaeRelevance === 'Critical' ? 'bg-rose-500/20 text-rose-400 border-rose-500/50' : entity.uaeRelevance === 'High' ? 'bg-orange-500/20 text-orange-400 border-orange-500/50' : 'bg-slate-500/20 text-slate-400 border-slate-500/50'}`}>
                              {entity.uaeRelevance}
                            </Badge>
                          </motion.div>
                        ))}
                      ...
                      {visualMultimediaExtendedData.reportingChannels.map((channel, idx) => (
                        ...
                        >
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <p className="text-sm font-medium text-slate-200">{channel.agency}</p>
                              <p className="text-xs text-slate-400">{channel.platform}</p>
                            </div>
                          </div>
                        </motion.div>
                      ))}
                    ...
                    <div className="space-y-2">
                      {visualMultimediaExtendedData.fakeContentTypes.map((type, idx) => (
                        ...
                        >
                          ...
                          <div>
                            <p className="text-sm font-medium text-slate-200">{type.type}</p>
                ...
                <CardContent>
                  <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                    {visualMultimediaExtendedData.reverseImageSearchTargets.map((target, idx) => (
                      ...
                      >
                        <div className="flex items-center justify-between mb-2">
                          <h4 className="font-semibold text-slate-200">{target.landmark}</h4>
                          <Badge className={`${target.riskLevel === 'Critical' ? 'bg-rose-500/20 text-rose-400 border-rose-500/50' : target.riskLevel === 'High' ? 'bg-orange-500/20 text-orange-400 border-orange-500/50' : 'bg-yellow-500/20 text-yellow-400 border-yellow-500/50'}`}>
                            {target.riskLevel}
                          </Badge>
                        </div>
                        <p className="text-xs text-slate-400">{target.manipulationHistory}</p>
                      </motion.div>
                    ))}
                  </div>
                </CardContent>
                ...
                <CardContent>
                  <div className="flex flex-wrap gap-2">
                    {visualMultimediaExtendedData.hashtagRegistry.map((tag, idx) => (
                      ...
                      >
                        <Badge
                          className={`cursor-pointer ${tag.usageCount === 'High' ? 'bg-emerald-500/20 text-emerald-400 border-emerald-500/50' : tag.usageCount === 'Medium' ? 'bg-blue-500/20 text-blue-400 border-blue-500/50' : 'bg-slate-500/20 text-slate-400 border-slate-500/50'}`}
                  ...
                  <ScrollArea className="h-[300px]">
                    <div className="space-y-2">
                      {visualMultimediaExtendedData.kpiSummaryTable.map((kpi, idx) => (
                        ...
                        >
                          <div>
                            <p className="text-sm font-medium text-slate-200">{kpi.category}</p>
                            <p className="text-xs text-slate-500">{kpi.source} - {kpi.date}</p>
                          </div>
                          <div className="flex items-center gap-2">
                ...
                <CardContent>
                  <div className="grid gap-4 sm:grid-cols-4">
                    ...
                    <div className="rounded-lg border border-emerald/30 bg-emerald/10 p-4 text-center">
                      ...
                      <p className="text-sm text-slate-400">Successful Fetches</p>
                    </div>
                    <div className="rounded-lg border border-rose/30 bg-rose/10 p-4 text-center">
                      ...
                      <p className="text-sm text-slate-400">Blocked/Inaccessible</p>
                    </div>
                    <div className="rounded-lg border border-blue/30 bg-blue/10 p-4 text-center">
                      <div className="text-2xl font-bold text-blue-400">{visualMultimediaExtendedData.executionMetadata.fetchRate}</div>
                      <p className="text-sm text-slate-400">Fetch Rate</p>
                    </div>
                  </div>
                    ...
                    {omissionSilenceData.extendedData?.freedomOnTheNet2025.map((cat, idx) => (
                      ...
                      >
                        <div className="flex items-center justify-between text-sm">
                          ...
                          <span className="font-medium text-slate-200">{cat.score}/{cat.max}</span>
                        </div>
                  ...
                  <div className="grid gap-4 sm:grid-cols-3 lg:grid-cols-5">
                    {omissionSilenceData.extendedData?.enforcementKPIs.map((kpi, idx) => (
                      ...
                      >
                        ...
                        <p className="text-sm text-slate-400 mt-1">{kpi.kpi}</p>
                        {kpi.period && <p className="text-xs text-slate-500 mt-1">{kpi.period}</p>}
                      </motion.div>
                    ))}
                  </div>
                </CardContent>
                      ...
                      {omissionSilenceData.extendedData?.omissionPatterns.map((pattern, idx) => (
                        ...
                        >
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <p className="font-semibold text-slate-200">{pattern.pattern}</p>
                              <p className="text-sm text-slate-400">{pattern.evidenceBase}</p>
                            </div>
                          </div>
                          <Badge variant="destructive" className="bg-red-500/20 text-red-400 border-red-500/50">
                            {pattern.severity}
                    ...
                    {omissionSilenceData.extendedData?.silenceMechanisms.map((mech, idx) => (
                      ...
                      >
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <h4 className="font-semibold text-slate-200">{mech.mechanism}</h4>
                        </div>
                        <p className="text-sm text-slate-400 mb-2">{mech.implementation}</p>
                        ...
                        >
                          ...
                          <div className="grid grid-cols-2 gap-4 text-sm">
                            <div className="p-2 rounded bg-emerald-500/10 border border-emerald-500/30">
                              <p className="text-xs text-slate-500 mb-1">International Coverage</p>
                              <p className="text-slate-300">{item.internationalCoverage}</p>
                            </div>
                            <div className="p-2 rounded bg-rose-500/10 border border-rose-500/30">
                              <p className="text-xs text-slate-500 mb-1">UAE Coverage</p>
                              <p className="text-slate-300">{item.uaeCoverage}</p>
                            </div>
                          </div>
                        </motion.div>
                      ))}
                      ...
                      {omissionSilenceData.extendedData?.specificDiscrepanciesDocumented.map((item, idx) => (
                        ...
                        >
                          ...
                          <div className="space-y-2 text-sm">
                            <div className="p-2 rounded bg-rose-500/10 border border-rose-500/30">
                              <p className="text-xs text-slate-500 mb-1">Official Claim</p>
                              <p className="text-slate-300">{item.officialClaim}</p>
                            </div>
                            <div className="p-2 rounded bg-emerald-500/10 border border-emerald-500/30">
                              <p className="text-xs text-slate-500 mb-1">Contrasting Evidence</p>
                              <p className="text-slate-300">{item.contrastingEvidence}</p>
                            </div>
                          </div>
                        </motion.div>
                      ))}
                  ...
                  <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                    {omissionSilenceData.extendedData?.enforcementActionsDuringIranStrikes.map((action, idx) => (
                      ...
                      >
                        ...
                        <p className="text-sm text-slate-300 mt-1">{action.metric}</p>
                        <p className="text-xs text-slate-500 mt-2">Source: {action.source}</p>
                      </motion.div>
                    ))}
                  </div>
                </CardContent>
                  ...
                  <ScrollArea className="h-[300px]">
                    <div className="space-y-3">
                      {omissionSilenceData.extendedData?.wartimeSpeechRestrictions.map((restriction, idx) => (
                        ...
                        >
                          <div className="flex items-center gap-3">
                            <div className={`flex h-10 w-10 items-center justify-center rounded-full ${restriction.country === 'UAE' ? 'bg-rose/20 text-rose' : 'bg-slate-600/20 text-slate-400'}`}>
                              <Globe className="h-5 w-5" />
                            </div>
                            <div>
                      ...
                      {omissionSilenceData.extendedData?.entityRegistry?.convictedHRDs.map((person, idx) => (
                        ...
                        >
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <p className="font-semibold text-slate-200">{person.name}</p>
                              <p className="text-sm text-slate-400">{person.nationality} • {person.charges}</p>
                            </div>
                          </div>
                          <div className="text-right">
                            <Badge variant="destructive" className="bg-red-500/20 text-red-400 border-red-500/50">
                            ...
                            <p className="text-xs text-slate-500 mt-1">{person.year}</p>
                          </div>
                        </motion.div>
                      ))}
                    </div>
                      ...
                      {omissionSilenceData.extendedData?.entityRegistry?.forciblyDisappeared.map((person, idx) => (
                        ...
                        >
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <p className="font-semibold text-slate-200">{person.name}</p>
                              <p className="text-sm text-slate-400">{person.nationality} • Last seen: {person.lastSeen}</p>
                            </div>
                          </div>
                          <Badge variant="destructive" className="bg-red-500/20 text-red-400 border-red-500/50">
                            {person.circumstance}
                  ...
                  <div className="grid gap-4 sm:grid-cols-2">
                    {omissionSilenceData.extendedData?.entityRegistry?.influenceOperations2019.map((op, idx) => (
                      ...
                      >
                        ...
                        <p className="text-sm text-slate-400 mt-1">Accounts on {op.platform}</p>
                        <div className="mt-3 space-y-1">
                          <p className="text-xs text-slate-500">Origin: <span className="text-slate-300">{op.origin}</span></p>
                          <p className="text-xs text-slate-500">Purpose: <span className="text-slate-300">{op.purpose}</span></p>
                        </div>
                      </motion.div>
                    ))}
                  </div>
                    ...
                    <div className="space-y-2">
                      {omissionSilenceData.extendedData?.sourceCredibilityMatrix.map((source, idx) => (
                        ...
                        >
                          <div className="flex-1">
                            <p className="font-medium text-slate-200 text-sm">{source.source}</p>
                            <p className="text-xs text-slate-500">{source.focus}</p>
                          </div>
                          <div className="flex items-center gap-2">
                            <Badge
                              className={source.uaeBiasAssessment === 'Independent' ? 'bg-emerald-500/20 text-emerald-400 border-emerald-500/50' : 'bg-yellow-500/20 text-yellow-400 border-yellow-500/50'}
                            >
                      ...
                      {omissionSilenceData.extendedData?.legalFramework.map((law, idx) => (
                        ...
                        >
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <p className="font-semibold text-slate-200">{law.law}</p>
                              <p className="text-sm text-slate-400">{law.purpose}</p>
                              <p className="text-xs text-slate-500">{law.year}</p>
                            </div>
                          </div>
                          <Badge variant="destructive" className="bg-red-500/20 text-red-400 border-red-500/50">
                            {law.maxPenalty}
                ...
                <CardContent>
                  <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div className="rounded-lg border border-emerald-500/30 bg-emerald-500/10 p-4 text-center">
                      ...
                      <p className="text-sm text-slate-400">Enrichment Rate</p>
                    </div>
                  </div>
                  <p className="text-xs text-slate-500 mt-4 text-center">
            ...
            <div className="space-y-6">
                      ...
                      >
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-slate-400">{platform.dominantECType}</p>
                          </div>
                        </div>
                        <div className="text-right">
                          ...
                          <p className="text-sm text-slate-400 mt-1">{platform.commonUsersPercent !== 'N/A' ? `${platform.commonUsersPercent} common users` : platform.platform === 'Facebook' ? 'Polarized clusters' : 'Ideological clustering'}</p>
                        </div>
                      </motion.div>
                    ))}
                  </div>
                ...
                <CardContent>
                  <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                    {echoChamberFilterData.extendedData?.sentimentByPlatform?.map((sentiment, idx) => (
                      ...
                      >
                        <div className="flex items-center justify-between mb-2">
                          <p className="font-semibold text-slate-200">{sentiment.platform}</p>
                          <Badge variant={
                        ...
                        <p className="text-xs text-slate-400">Researchers: {sentiment.sentimentResearchers}</p>
                        <p className="text-xs text-slate-500 mt-1">{sentiment.consensus}</p>
                      </motion.div>
                    ))}
                  </div>
                </CardContent>
                ...
                <CardContent>
                  <div className="space-y-3">
                    {echoChamberFilterData.extendedData?.uaeRelevanceMatrix?.map((item, idx) => (
                      <motion.div
                        ...
                        className="flex items-center justify-between rounded-lg border border-slate-700 bg-slate-800/50 p-3"
                      >
                        <p className="text-slate-200">{item.topicArea}</p>
                        <Badge variant={
                  ...
                  <div className="mt-4 grid gap-4 sm:grid-cols-3">
                    <div className="rounded-lg border border-rose-500/30 bg-rose-500/10 p-3 text-center">
                      ...
                      <p className="text-xs text-slate-400">Social Media Regulation</p>
                    </div>
                    <div className="rounded-lg border border-orange-500/30 bg-orange-500/10 p-3 text-center">
                      ...
                      <p className="text-xs text-slate-400">Echo Chambers, Misinformation</p>
                    </div>
                    <div className="rounded-lg border border-gold/30 bg-gold/10 p-3 text-center">
                      ...
                      <p className="text-xs text-slate-400">Algorithmic Curation, Filter Bubbles</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
                      ...
                      {echoChamberFilterData.extendedData?.tierDistribution?.map((tier) => (
                        ...
                        >
                          <div className={`text-lg font-bold ${
                            ...
                            tier.tier.includes('TIER 3') ? 'text-orange-400' : 'text-slate-400'
                          }`}>
                            {tier.count}
                          </div>
                          <p className="text-xs text-slate-400">{tier.tier.split(' ')[0]} {tier.tier.split(' ')[1]}</p>
                          <p className="text-xs text-slate-500">{tier.percentageOfSources}</p>
                        </motion.div>
                      ))}
                    </div>
                    <div className="space-y-2">
                      <p className="text-sm font-semibold text-slate-300">Evidence Quality Assessment</p>
                      {echoChamberFilterData.extendedData?.evidenceQualityAssessment?.map((eq) => (
                        <div key={eq.qualityDimension} className="flex items-center justify-between rounded border border-slate-700 bg-slate-800/30 p-2">
                          <span className="text-sm text-slate-300">{eq.qualityDimension}</span>
              ...
              <Card className="glass-card">
                ...
                <CardContent>
                  <div className="space-y-4">
                    <div className="space-y-2">
                      <p className="text-sm font-semibold text-slate-300">Consensus on Key Findings</p>
                      {echoChamberFilterData.extendedData?.consensusMatrix?.slice(0, 4).map((item) => (
                        <motion.div
                          key={item.finding}
                          initial={{ opacity: 0, x: -10 }}
                          animate={{ opacity: 1, x: 0 }}
                          className="flex items-center justify-between rounded border border-slate-700 bg-slate-800/30 p-2"
                        >
                          <span className="text-xs text-slate-300 flex-1 mr-2">{item.finding}</span>
                          <Badge variant={
                    ...
                    <div className="space-y-2">
                      <p className="text-sm font-semibold text-slate-300">Methodological Quality</p>
                      <BarChart
                    ...
                    <div className="space-y-2">
                      <p className="text-sm font-semibold text-slate-300">Key Research Gaps</p>
                      <ScrollArea className="h-[150px]">
                        <div className="space-y-2 pr-4">
                          {echoChamberFilterData.extendedData?.researchGaps?.map((gap) => (
                            ...
                            >
                              <p className="text-sm font-medium text-slate-200">{gap.gap}</p>
                      ...
                      >
                        <div className="flex items-center gap-3">
                          <div className={`h-2 w-2 rounded-full ${
                            ...
                            threat.combinedScore === 'MEDIUM' ? 'bg-gold' : 'bg-slate-500'
                          }`} />
                          <span className="text-sm text-slate-200">{threat.threat}</span>
                        </div>
                        <div className="flex items-center gap-2">
                          <Badge variant="outline" className="text-xs">
