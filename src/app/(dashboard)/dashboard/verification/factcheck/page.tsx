...
const getVerdictBadge = (verdict: string) => {
  switch (verdict) {
    ...
    case 'Debunked': return <Badge variant="warning" className="text-xs bg-yellow-500/20 text-yellow-400 border-yellow-500/50">{verdict}</Badge>
...
const getRelevanceBadge = (relevance: string) => {
  switch (relevance) {
    ...
    case 'Medium': return <Badge variant="info" className="text-xs bg-blue-500/20 text-blue-400 border-blue-500/50">{relevance}</Badge>
              ...
              <div className="space-y-4">
                {threePillars.map((pillar, idx) => (
                  ...
                  >
                    ...
                    <div>
                      <p className="font-semibold text-slate-200">{pillar.pillar}</p>
                      <p className="text-sm text-slate-400">{pillar.elements}</p>
                    </div>
                  </motion.div>
                ))}
              </div>
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
              {sentimentAnalysis.map((item, idx) => (
                ...
                >
                  ...
                  <p className="text-xs text-slate-500 mt-1">{item.narrative}</p>
                </motion.div>
              ))}
            </div>
          </GlassPanel>
                ...
                <div key={item.category} className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    <span className={`text-sm font-bold ${
                      ...
                      item.completeness === '80%' ? 'text-yellow-400' :
                      'text-slate-400'
                ...
                {governmentOrgs.map((org, idx) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-semibold text-slate-200">{org.org}</p>
                        <p className="text-xs text-slate-400">{org.fullName}</p>
                        <p className="text-xs text-slate-500 mt-1">{org.role}</p>
                      </div>
                    </div>
                ...
                {detectionMethods.map((method, idx) => (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-slate-400">{method.application}</p>
                    </div>
                  </motion.div>
                ))}
              </div>
            ...
            <div className="grid gap-4 sm:grid-cols-3">
              {reportingChannels.map((channel, idx) => (
                ...
                >
                  ...
                  <p className="font-semibold text-slate-200">{channel.channel}</p>
            ...
            <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-5">
              {verificationRecommendations.map((rec, idx) => (
                ...
                >
                  ...
                  <span className="text-sm text-slate-300">{rec.recommendation}</span>
                </motion.div>
              ))}
            </div>
          </GlassPanel>
              ...
              {legalPenalties.map((penalty, idx) => (
                ...
                >
                  <div className="flex items-start justify-between mb-3">
                    <div>
                      <p className="font-semibold text-slate-200">{penalty.violation}</p>
                      <p className="text-sm text-slate-500">Legal basis: {penalty.basis}</p>
                    </div>
            ...
            <div className="space-y-3">
              {entityLaws.map((law, idx) => (
                ...
                >
                  ...
                  <div className="flex-1">
                    <p className="font-medium text-slate-200">{law.law}</p>
                    <p className="text-sm text-slate-400">{law.article} {law.year && `(${law.year})`}</p>
                  </div>
                ...
                {aiContentCases.map((item, idx) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-medium text-slate-200">{item.content}</p>
                        <p className="text-xs text-slate-400">{item.identification}</p>
                      </div>
                    </div>
                  ...
                  {miscaptionedVideos.map((video, idx) => (
                    ...
                    >
                      ...
                      <div className="ml-6 space-y-1">
                        <p className="text-xs text-slate-500">Actual: <span className="text-slate-300">{video.actual}</span></p>
                ...
                {factCheckCases.map((fcCase, idx) => (
                  ...
                  >
                    <div className="flex items-start justify-between mb-2">
                      <div>
                        <p className="font-semibold text-slate-200">{fcCase.case}</p>
                        <p className="text-xs text-slate-500">{fcCase.source} - {fcCase.date}</p>
                      </div>
          ...
          <GlassPanel title="Snopes UAE Fact-Checks" description="Verified claims from Snopes database">
            <div className="space-y-3">
              {snopesCases.map((snopes, idx) => (
                ...
                >
                  <div className="flex-1">
                    <p className="font-medium text-slate-200">{snopes.claim}</p>
                    <p className="text-xs text-slate-500">{snopes.date}</p>
                  </div>
                  <div className="flex items-center gap-2">
            ...
            <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-5">
              {deepfakeRisks.map((risk, idx) => (
                ...
                >
                  ...
                  <p className="font-semibold text-slate-200">{risk.risk}</p>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-1">
                        <p className="font-semibold text-slate-200">{quote.expert}</p>
                        <Badge variant="outline" className="text-xs">{quote.org}</Badge>
                      </div>
                      <p className="text-sm text-slate-300 italic">"{quote.quote}"</p>
                      <p className="text-xs text-slate-500 mt-1">Context: {quote.context}</p>
                    </div>
                  </div>
                </motion.div>
              ))}
              ...
              <div className="space-y-3">
                {sudanResponse.map((official, idx) => (
                  ...
                  >
                    ...
                    <div>
                      <p className="font-medium text-slate-200">{official.official}</p>
                      <p className="text-xs text-slate-400">{official.position}</p>
                    </div>
                  </motion.div>
                ))}
              </div>
              ...
              {enforcementActions.map((action, idx) => (
                ...
                >
                  ...
                  <div className="space-y-1 text-sm">
                    <p><span className="text-slate-500">Date:</span> <span className="text-slate-300">{action.date}</span></p>
                    <p><span className="text-slate-500">Charge:</span> <span className="text-slate-300">{action.charge}</span></p>
                  </div>
                </motion.div>
              ))}
            </div>
            ...
            <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
              {incidentRestrictions.map((restriction, idx) => (
                ...
                >
                  ...
                  <p className="font-semibold text-slate-200">{restriction.risk}</p>
              ...
              {dubaiFakeCases.map((dubaiCase, idx) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-medium text-slate-200">{dubaiCase.claim}</p>
                      <p className="text-xs text-slate-500">{dubaiCase.source} - {dubaiCase.date}</p>
                    </div>
                  </div>
                  ...
                  {entityPeople.map((person, idx) => (
                    ...
                    >
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-xs text-slate-400">{person.role} - {person.org}</p>
                      </div>
                ...
                <div className="space-y-3 pr-4">
                  {entityOrgs.map((org, idx) => (
                    ...
                    >
                      ...
                      <div className="flex-1">
                        <p className="font-medium text-slate-200">{org.acronym || org.org}</p>
                        <p className="text-xs text-slate-400 truncate">{org.org}</p>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-white/10">
                    ...
                    <th className="text-left py-2 px-3 text-slate-400">Reliability</th>
                  </tr>
                </thead>
                <tbody>
                  {sourceCredibilityMatrix.map((source, idx) => (
                    ...
                    >
                      <td className="py-2 px-3 text-slate-200">{source.source}</td>
