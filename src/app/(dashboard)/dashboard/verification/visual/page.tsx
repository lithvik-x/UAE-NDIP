                  ...
                  <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                    {extended.reverseImageSearchTargets.map((target, idx) => (
                      ...
                      >
                        ...
                        <p className="text-xs text-slate-500 mt-2">{target.manipulationHistory}</p>
                      </motion.div>
                    ))}
                  </div>
                </CardContent>
                    ...
                    {extended.fakeContentTypes.map((type, idx) => (
                      ...
                      >
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <h4 className="font-semibold text-slate-200">{type.type}</h4>
                        </div>
                  ...
                  <div className="space-y-3">
                    {extended.verificationMethods.map((method, idx) => (
                      ...
                      >
                        ...
                        <p className="text-sm text-slate-300">{method.method}</p>
                      </motion.div>
                    ))}
                  </div>
                </CardContent>
                    ...
                    {extended.reportingChannels.map((channel, idx) => (
                      ...
                      >
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <h4 className="font-semibold text-slate-200">{channel.agency}</h4>
                        </div>
                        <p className="text-sm text-slate-400">{channel.platform}</p>
                      </motion.div>
                    ))}
                  </div>
                </CardContent>
                      ...
                      {extended.viralContentMetrics.map((viral, idx) => (
                        ...
                        >
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <p className="font-semibold text-slate-200">{viral.contentType}</p>
                              <p className="text-sm text-slate-400">{viral.platform} | {viral.date}</p>
                            </div>
                          </div>
                          <div className="flex items-center gap-4">
              ...
              <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                {extended.threatDashboardKPIs.map((threat, idx) => (
                  ...
                  >
                    ...
                    <h4 className="font-semibold text-slate-200 mt-2">{threat.threatType}</h4>
                    <p className="text-sm text-slate-400 mt-1">{threat.keyFinding}</p>
                    <p className="text-xs text-slate-500 mt-2">Source: {threat.primarySource}</p>
                  </motion.div>
                ))}
              </div>
                  ...
                  <ScrollArea className="h-[200px]">
                    <div className="space-y-3">
                      {extended.queryTemplates.map((qt, idx) => (
                        ...
                        >
                          <p className="text-sm font-medium text-slate-300">{qt.name}</p>
                ...
                <CardContent>
                  <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div className="rounded-lg border border-emerald-500/30 bg-emerald-500/10 p-4 text-center">
                      ...
                      <p className="text-sm text-slate-400">Emirati Designers</p>
                    </div>
                    <div className="rounded-lg border border-emerald-500/30 bg-emerald-500/10 p-4 text-center">
                      <div className="text-2xl font-bold text-emerald-400">7</div>
                      <p className="text-sm text-slate-400">Emirates United</p>
                    </div>
                  </div>
                  <div className="mt-4">
                    <h4 className="text-sm font-medium text-slate-300 mb-2">Symbolism:</h4>
                    <div className="flex flex-wrap gap-2">
                    ...
                    <div className="rounded-lg border border-rose-500/30 bg-rose-500/10 p-4">
                      ...
                      {extended.logoBrandingData.dubaiEmblem.penalties.map((p, idx) => (
                        <div key={idx} className="flex justify-between mt-2">
                          <span className="text-sm text-slate-400">{p.type}</span>
                          <span className="text-sm font-medium text-slate-200">{p.range}</span>
                        </div>
                      ))}
                    </div>
                    <div className="rounded-lg border border-slate-700 bg-slate-800/50 p-4">
                      <h4 className="font-semibold text-slate-200 mb-2">Key Restrictions</h4>
                      {extended.logoBrandingData.dubaiEmblem.restrictions.map((r, idx) => (
                        <p key={idx} className="text-sm text-slate-400 mt-1">• {r}</p>
                      ))}
                    </div>
                  </div>
                </CardContent>
              ...
              <Card className="glass-card">
                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <div>
                      <h4 className="text-sm font-medium text-slate-300 mb-2">Prohibited Actions (DON&apos;Ts):</h4>
            ...
            <div className="space-y-6">
              ...
              <Card className="glass-card">
                ...
                <CardContent>
                  <div className="grid gap-4 sm:grid-cols-2">
                    <div className="space-y-2">
                      <div className="flex justify-between rounded-lg border border-slate-700 bg-slate-800/50 p-3">
                        <span className="text-sm text-slate-400">Technology</span>
                        <span className="text-sm font-medium text-slate-200">Hygroscopic</span>
                      </div>
                      <div className="flex justify-between rounded-lg border border-slate-700 bg-slate-800/50 p-3">
                        <span className="text-sm text-slate-400">Doppler Radars</span>
                        <span className="text-sm font-medium text-slate-200">{extended.cloudSeedingData.dopplerRadars}</span>
                      </div>
                      <div className="flex justify-between rounded-lg border border-slate-700 bg-slate-800/50 p-3">
                        <span className="text-sm text-slate-400">Drone Technology</span>
                        <span className="text-sm font-medium text-slate-200">Since 2021</span>
                      </div>
                    </div>
                    <div className="rounded-lg border border-slate-700 bg-slate-800/50 p-4">
                      <h4 className="text-sm font-medium text-slate-300 mb-2">Materials Used</h4>
                      <p className="text-sm text-slate-400">Potassium chloride, Sodium chloride</p>
                      <h4 className="text-sm font-medium text-slate-300 mt-4 mb-2">Target Area</h4>
                      <p className="text-sm text-slate-400">Eastern mountains near Oman</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
                    ...
                    <div className="space-y-4">
                      {extended.sentimentAnalysisByTopic.map((sent, idx) => {
                        ...
                        return (
                          ...
                          >
                            <div className="flex items-center justify-between mb-2">
                              <h4 className="font-semibold text-slate-200">{sent.topic}</h4>
                            ...
                            <div className="flex items-center gap-4 text-sm">
                              ...
                              <span className="text-slate-400">{sent.neutral}%</span>
                            </div>
                            <Progress
                              value={100}
                              className="mt-2 h-2"
                            ...
                            <p className="text-xs text-slate-500 mt-2">Source: {sent.source}</p>
                          </motion.div>
                        )
                      })}
                    </div>
                ...
                <CardContent>
                  <div className="space-y-4">
                    {extended.legalFramework.map((law, idx) => (
                      ...
                      >
                        <div className="flex items-center justify-between mb-2">
                          <h4 className="font-semibold text-slate-200">{law.law}</h4>
                          <Scale className="h-5 w-5 text-gold" />
                        </div>
                        <p className="text-sm text-slate-400 mb-2">{law.keyProvision}</p>
                        <div className="flex items-center gap-2">
                          <AlertTriangle className="h-4 w-4 text-rose-400" />
                          <span className="text-sm text-rose-400">{law.penalty}</span>
                        </div>
                        <p className="text-xs text-slate-500 mt-2">Source: {law.source}</p>
                      </motion.div>
                    ))}
                  </div>
                </CardContent>
                  ...
                  <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                    {extended.financialConversions.map((fc, idx) => (
                      ...
                      >
                        ...
                        <p className="text-sm text-slate-400">{fc.currency}</p>
                        <div className="mt-2 pt-2 border-t border-slate-700">
                          <p className="text-xs text-slate-500">USD: {fc.usdEquivalent}</p>
                          <p className="text-xs text-slate-500">INR: {fc.inrEquivalent}</p>
                        </div>
                      </motion.div>
                    ))}
                  </div>
                      ...
                      {extended.tierDefinitions.map((tier, idx) => (
                        ...
                        >
                          ...
                          <div className="flex-1">
                            ...
                            <p className="text-xs text-slate-500 mt-1">Examples: {tier.examples}</p>
                          </div>
                        </motion.div>
                      ))}
                    </div>
                      ...
                      {extended.sourceCredibilityMatrix.map((source, idx) => (
                        ...
                        >
                          <div className="flex-1">
                            ...
                            <p className="text-xs text-slate-500">{source.type} | Score: {source.score}/10</p>
                          </div>
                          <div className="flex items-center gap-2">
                      ...
                      {extended.urlContentSummaries.map((url, idx) => (
                        ...
                        >
                          ...
                          <div className="flex-1 min-w-0">
                            <p className="text-sm font-medium text-slate-200 truncate">{url.url}</p>
                            <p className="text-xs text-slate-400 mt-1">{url.keyDataExtracted}</p>
                            <div className="flex items-center gap-2 mt-2">
                              {getStatusBadge(url.status)}
                              <span className="text-xs text-slate-500">{url.dataPoints} data points</span>
                            </div>
                          </div>
                        </motion.div>
                      ))}
      ...
      >
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-slate-300">Enrichment Status: {meta.enrichmentStatus}</span>
          </div>
