...
export default function LegalRegulatoryPage() {
  const data = legalRegulatoryData
  ...
  const difcCompanies = 3000
  const adgmRanking = 2
  const patentApplications = 1005
  const caseCompletionRate = 98
  ...
  const trendChartData = [
    { period: '2022', value: 55 },
    { period: '2023', value: 58 },
    { period: '2024', value: 60 },
  ...
  const getSectorBadge = () => <Badge variant="gold" className="mb-2">H-SECTOR</Badge>
  ...
  return (
    <div className="space-y-8 p-8">
      ...
      <div className="flex items-start justify-between">
        <div>
          {getSectorBadge()}
          <h1 className="text-3xl font-extrabold gradient-text-platinum">Legal & Regulatory</h1>
          <p className="mt-2 text-slate-400">
            Civil law reforms, DIFC/ADGM courts, AML framework, IP protection, and regulatory compliance
          </p>
        </div>
      ...
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
        <MetricCard
          ...
          value={`${difcCompanies.toLocaleString()}+`}
          previousValue={2700}
        ...
        <MetricCard
          ...
          value={patentApplications.toLocaleString()}
          previousValue={900}
      ...
      <Tabs defaultValue="overview" className="space-y-6">
        ...
        <TabsContent value="overview" className="space-y-6">
          <GlassPanel title="Legal & Regulatory Metrics" description="Critical findings across courts, regulatory frameworks, and compliance">
            <div className="space-y-6">
              <Card className="glass-card">
                <CardHeader>
                  <CardTitle className="text-lg">Key Metrics</CardTitle>
                  <CardDescription>Core legal and regulatory indicators</CardDescription>
                </CardHeader>
                <CardContent>
                  <BarChart
              ...
              <div className="grid gap-6 lg:grid-cols-2">
                <Card className="glass-card">
                  <CardHeader>
                    <CardTitle className="text-lg">Courts & Adjudication</CardTitle>
                    <CardDescription>DIFC and ADGM court performance</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-4">
                      {[
                        { label: 'DIFC Companies Registered', value: '3,000+', sublabel: 'Active entities (2022)' },
                        { label: 'ADGM FinTech Sandbox', value: '2nd globally', sublabel: 'Most active globally' },
                        { label: 'Abu Dhabi Case Completion', value: '98%', sublabel: 'Completion rate (2025)' },
                      ].map((item, index) => (
                ...
                <Card className="glass-card">
                  <CardHeader>
                    ...
                    <CardDescription>Compliance and enforcement metrics</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-4">
                      {[
                        { label: 'AML Administrative Fines', value: 'AED 1B', sublabel: 'Maximum penalty' },
                        { label: 'PDPL Maximum Fine', value: 'AED 5M', sublabel: 'Data protection violations' },
                        { label: 'Patent Applications Growth', value: '622 to 1,005', sublabel: '2016 to 2023 growth' },
                      ].map((item, index) => (
                        <div key={index} className="space-y-2">
                          <div className="flex items-center justify-between">
                            <span className="text-sm font-medium text-slate-200">{item.label}</span>
              ...
              <Card className="glass-card">
                <CardHeader>
                  ...
                  <CardDescription>Complete list of legal and regulatory metrics</CardDescription>
                </CardHeader>
                <CardContent>
        ...
        <TabsContent value="sentiment" className="space-y-6">
          <GlassPanel title="Sentiment & Emotions Analysis" description="Public perception and emotional response to legal topics">
            <div className="space-y-6">
              <div className="grid gap-6 lg:grid-cols-2">
                <Card className="glass-card">
                  <CardHeader>
        ...
        <TabsContent value="trends" className="space-y-6">
          <GlassPanel title="Trend Analysis" description="Historical trends and future projections">
            <div className="space-y-6">
              <Card className="glass-card">
                <CardHeader>
                  <CardTitle className="text-lg">Legal Framework Index</CardTitle>
        ...
        <TabsContent value="stakeholders" className="space-y-6">
          <GlassPanel title="Key Stakeholders" description="Entities and actors in legal & regulatory space">
            <div className="space-y-4">
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-400">Legal & Regulatory</p>
                    </div>
                  </div>
