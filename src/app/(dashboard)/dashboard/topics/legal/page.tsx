          ...
          >
            <div className="space-y-6">
              ...
              <Card className="glass-card">
                ...
                <CardContent>
                  <div className="grid gap-6 lg:grid-cols-2">
                    ...
                    <div>
                      <h4 className="text-sm font-semibold text-gold-700 mb-3">Court Structure</h4>
              ...
              <Card className="glass-card">
                <CardHeader>
                  <CardTitle className="text-lg flex items-center gap-2">
                    <ScrollText className="h-5 w-5 text-platinum-500" />
                ...
                <CardContent>
                  <div className="grid gap-4 md:grid-cols-2">
                    <div>
                      <h4 className="text-sm font-semibold text-gold-700 mb-3">Will Service Options</h4>
              ...
              <Card className="glass-card border-navy-500/50">
                ...
                <CardContent>
                  <div className="grid gap-4 lg:grid-cols-2">
                    ...
                    <div>
                      <h4 className="text-sm font-semibold text-navy-500 mb-3">Key Provisions</h4>
                      <div className="space-y-2">
            ...
            <div className="space-y-6">
                ...
                <CardContent>
                  <ScrollArea className="h-[400px]">
                    <div className="space-y-4">
                      {reformsTimeline.map((reform, idx) => (
                        <div key={idx} className="flex gap-4 p-4 bg-platinum-800/50 rounded-lg border border-platinum-700">
                          <div className="p-2 bg-gold-700/20 rounded-lg text-center min-w-[60px]">
                            <p className="text-lg font-bold text-gold-700">{reform.year}</p>
                          </div>
              ...
              <Card className="glass-card">
                ...
                <CardContent>
                  <div className="grid gap-4 md:grid-cols-2">
                    <div>
                      <h4 className="text-sm font-semibold text-gold-700 mb-3">Extradition Process (5 Stages)</h4>
                      <div className="space-y-2">
                    ...
                    <div>
                      <h4 className="text-sm font-semibold text-gold-700 mb-3">Bilateral Agreements</h4>
                      <div className="space-y-2">
              ...
              <Card className="glass-card">
                <CardHeader>
                  <CardTitle className="text-lg flex items-center gap-2">
                    <Eye className="h-5 w-5 text-platinum-500" />
                    Sentiment by Topic
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                    <div>
                      <h4 className="text-sm font-semibold text-emerald-500 mb-2">Positive Topics</h4>
                      <div className="flex flex-wrap gap-2">
                        {sentimentAnalysis.positiveTopics.map((topic, idx) => (
                          <Badge key={idx} variant="outline" className="border-emerald-500/50 text-emerald-500 bg-emerald-500/10">
                            {topic.topic}
                          </Badge>
                        ))}
                      </div>
                    ...
                    <div>
                      <h4 className="text-sm font-semibold text-rose-500 mb-2">Concerns</h4>
                      <div className="flex flex-wrap gap-2">
                        {sentimentAnalysis.negativeTopics.map((topic, idx) => (
                          <Badge key={idx} variant="outline" className="border-rose-500/50 text-rose-500 bg-rose-500/10">
                            {topic.topic}
                          </Badge>
                        ))}
                      </div>
              ...
              <Card className="glass-card">
                ...
                <CardContent>
                  <div className="space-y-4">
                    <div>
                      <h4 className="text-sm font-semibold text-rose-500 mb-2">Critical Priority</h4>
                      <div className="grid gap-2 md:grid-cols-2">
