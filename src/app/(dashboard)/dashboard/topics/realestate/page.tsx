              ...
              <Card className="glass-card border-amber-500/50">
                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <div className="p-4 bg-platinum-800/50 rounded-lg">
                      <p className="text-sm text-platinum-400">Max affordable sale price: <span className="text-gold-700 font-bold">AED 790,000</span> based on income ratios, yet market prices far exceed this for most workers.</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
