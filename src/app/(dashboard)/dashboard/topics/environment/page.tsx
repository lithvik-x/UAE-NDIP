                  ...
                  <CardContent>
                    <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
                      {netZero2050Data.sixSectorFramework.map((sector, idx) => (
                        <div key={idx} className="rounded-lg bg-platinum-800/50 p-4 border border-platinum-700">
                          ...
                          <p className="text-xs text-emerald">{sector.keyOutcome}</p>
                        </div>
                      ))}
                    </div>
                    <div className="mt-4 grid gap-4 sm:grid-cols-3">
                      <div className="p-3 rounded-lg bg-emerald-500/10 border border-emerald-500/30">
                        ...
                        <p className="text-lg font-bold text-emerald">{netZero2050Data.aggregateTargets.jobOpportunities}</p>
                      </div>
                      <div className="p-3 rounded-lg bg-gold-500/10 border border-gold-500/30">
                        ...
                        <p className="text-lg font-bold text-gold">{netZero2050Data.aggregateTargets.gdpContribution}</p>
                      </div>
                  ...
                  <CardContent>
                    ...
                    <div className="mt-4 grid gap-3 sm:grid-cols-3">
                      <div className="p-3 rounded-lg bg-rose-500/10 border border-rose-500/30">
                        ...
                        <p className="text-lg font-bold text-rose">~32 t/person/year</p>
                      </div>
                      <div className="p-3 rounded-lg bg-orange-500/10 border border-orange-500/30">
                        <p className="text-xs text-platinum-400">Per Capita CO2 (World Economics)</p>
                        <p className="text-lg font-bold text-orange">21.55 t/head</p>
                      </div>
                      <div className="p-3 rounded-lg bg-gold-500/10 border border-gold-500/30">
                        <p className="text-xs text-platinum-400">50-Year Reduction</p>
                        <p className="text-lg font-bold text-gold">-69.3% since 1973</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                    ...
                    <CardContent>
                      <div className="space-y-3">
                        <div className="flex justify-between">
                          ...
                          <span className="text-sm font-bold text-emerald">3,460 MW</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-sm text-platinum-400">Under Construction</span>
                          <span className="text-sm font-medium text-gold">1,200 MW</span>
                        </div>
                        <div className="flex justify-between">
                        ...
                        <div className="flex justify-between">
                          ...
                          <span className="text-sm font-medium text-cyan">6,000 MWh battery</span>
                        </div>
                  ...
                  <CardContent>
                    <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                      <div className="p-4 rounded-lg bg-navy-500/10 border border-navy-500/30 text-center">
                        ...
                        <p className="text-2xl font-bold text-navy">5,380</p>
                      ...
                      <div className="p-4 rounded-lg bg-emerald-500/10 border border-emerald-500/30 text-center">
                        ...
                        <p className="text-2xl font-bold text-emerald">40</p>
                      ...
                      <div className="p-4 rounded-lg bg-cyan-500/10 border border-cyan-500/30 text-center">
                        ...
                        <p className="text-2xl font-bold text-cyan">22+</p>
                      ...
                      <div className="p-4 rounded-lg bg-gold-500/10 border border-gold-500/30 text-center">
                        ...
                        <p className="text-2xl font-bold text-gold">$880M</p>
            ...
            >
              <div className="space-y-6">
                ...
                <div className="grid gap-6 lg:grid-cols-2">
                  <Card className="glass-card">
                    <CardHeader>
                      <CardTitle className="text-lg text-emerald">Positive: PM2.5 Reduction</CardTitle>
                      <CardDescription>-22% drop in harmful levels (2024)</CardDescription>
                    </CardHeader>
                    <CardContent>
                      <div className="flex items-center justify-center p-6">
                        <div className="text-center">
                          <p className="text-5xl font-bold text-emerald">-22%</p>
            ...
            >
              <div className="space-y-6">
                ...
                <div className="grid gap-6 lg:grid-cols-2">
                  ...
                  <Card className="glass-card">
                    <CardHeader>
                      <CardTitle className="text-lg text-cyan">Infrastructure Investment</CardTitle>
                    </CardHeader>
                    <CardContent>
                      <div className="space-y-3">
                        <div className="p-4 rounded-lg bg-cyan-500/10 border border-cyan-500/30 text-center">
                  ...
                  <CardContent>
                    <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                      ...
                      <div className="p-3 rounded-lg bg-gold-500/10 border border-gold-500/30 text-center">
                        ...
                        <p className="text-xl font-bold text-gold">$544.6M</p>
                      ...
                      <div className="p-3 rounded-lg bg-cyan-500/10 border border-cyan-500/30 text-center">
                        ...
                        <p className="text-xl font-bold text-cyan">1,244</p>
                      ...
                      <div className="p-3 rounded-lg bg-rose-500/10 border border-rose-500/30 text-center">
                        ...
                        <p className="text-xl font-bold text-rose">30-50K</p>
                  ...
                  <CardContent>
                    <div className="grid gap-4 sm:grid-cols-3 lg:grid-cols-6">
                      ...
                      <div className="p-3 rounded-lg bg-gold-500/10 border border-gold-500/30 text-center">
                        ...
                        <p className="text-lg font-bold text-gold">34</p>
                        <p className="text-xs">~13,100 km2</p>
                      </div>
                      <div className="p-3 rounded-lg bg-cyan-500/10 border border-cyan-500/30 text-center">
                        <p className="text-xs text-platinum-400">Marine Reserves</p>
                        <p className="text-lg font-bold text-cyan">16</p>
                      ...
                      <div className="p-3 rounded-lg bg-navy-500/10 border border-navy-500/30 text-center">
                        ...
                        <p className="text-lg font-bold text-navy">&gt;20,000</p>
                        <p className="text-xs">km2</p>
                      </div>
                      <div className="p-3 rounded-lg bg-rose-500/10 border border-rose-500/30 text-center">
                        <p className="text-xs text-platinum-400">Wetland Coverage</p>
                        <p className="text-lg font-bold text-rose">391.7</p>
                  ...
                  <CardContent>
                    <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                      ...
                      <div className="p-3 rounded-lg bg-gold-500/10 border border-gold-500/30">
                        ...
                        <p className="text-xl font-bold text-gold">75 years</p>
                        <p className="text-xs">(since 1949)</p>
                      </div>
                      <div className="p-3 rounded-lg bg-cyan-500/10 border border-cyan-500/30">
                        <p className="text-xs text-platinum-400">Vehicles Affected</p>
                        <p className="text-xl font-bold text-cyan">30-50K</p>
                      </div>
                      <div className="p-3 rounded-lg bg-rose-500/10 border border-rose-500/30">
                        <p className="text-xs text-platinum-400">Deaths</p>
                        <p className="text-xl font-bold text-rose">5</p>
                    ...
                    <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-5">
                      {sustainabilityData.greenAgenda2030.fiveStrategicObjectives.map((obj, idx) => (
                        <div key={idx} className="p-3 rounded-lg bg-emerald-500/10 border border-emerald-500/30">
                          ...
                          <p className="text-xs text-emerald mt-1">{obj.targetImpact}</p>
                        </div>
                      ))}
                    </div>
                    <div className="mt-4 grid gap-3 sm:grid-cols-3">
                      <div className="p-3 rounded-lg bg-gold-500/10 border border-gold-500/30">
                        ...
                        <p className="text-lg font-bold text-gold">+4-5%</p>
                      </div>
                      <div className="p-3 rounded-lg bg-cyan-500/10 border border-cyan-500/30">
                        <p className="text-xs text-platinum-400">Export Increase</p>
                        <p className="text-lg font-bold text-cyan">AED 24-25B</p>
                      </div>
                      <div className="p-3 rounded-lg bg-navy-500/10 border border-navy-500/30">
                        <p className="text-xs text-platinum-400">Emissions Target</p>
                        <p className="text-sm font-bold text-navy">&lt;100 kWh/unit</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
          ...
          <motion.div variants={containerVariants}>
            ...
            >
              <div className="space-y-6">
                <Card className="glass-card">
                  <CardHeader>
                    <CardTitle className="text-lg text-gold">Al Maktoum Airport Expansion (Dubai)</CardTitle>
                  ...
                  <CardContent>
                    <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                      <div className="p-4 rounded-lg bg-orange-500/10 border border-orange-500/30 text-center">
                        ...
                        <p className="text-3xl font-bold text-orange">86%</p>
                      </div>
                      <div className="p-4 rounded-lg bg-rose-500/10 border border-rose-500/30 text-center">
                        ...
                        <p className="text-3xl font-bold text-rose">91%</p>
                      </div>
                      <div className="p-4 rounded-lg bg-gold-500/10 border border-gold-500/30 text-center">
                        <p className="text-xs text-platinum-400">Sharjah Experience</p>
                        <p className="text-3xl font-bold text-gold">90%</p>
                      </div>
                      <div className="p-4 rounded-lg bg-cyan-500/10 border border-cyan-500/30 text-center">
                        <p className="text-xs text-platinum-400">More vs Last Year</p>
                        <p className="text-3xl font-bold text-cyan">80%</p>
                      </div>
                    </div>
                    <div className="mt-4">
