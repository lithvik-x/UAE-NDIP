        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <Card className="glass-card border-emerald-500/30 bg-gradient-to-br from-emerald-500/10 to-transparent">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-slate-400 text-sm">New Companies (2025)</p>
          ...
          <Card className="glass-card border-emerald-500/30">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-slate-400 text-sm">Active Business Members</p>
          ...
          <Card className="glass-card border-emerald-500/30">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-slate-400 text-sm">Tax Efficiency</p>
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {economicIndicators.map((indicator, idx) => (
                <div key={idx} className="bg-slate-800/30 rounded-lg p-4">
                  <p className="text-xs text-slate-400">{indicator.indicator}</p>
          ...
          <CardContent>
            <div className="space-y-3">
              {investmentProjects.map((project, idx) => (
                ...
                >
                  <div>
                    <p className="font-medium text-slate-200 text-sm">{project.project}</p>
                    <p className="text-xs text-slate-400 mt-1">{project.details}</p>
                  </div>
