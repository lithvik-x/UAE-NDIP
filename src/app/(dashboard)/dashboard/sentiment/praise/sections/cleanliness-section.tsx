        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <Card className="glass-card border-cyan-500/30 bg-gradient-to-br from-cyan-500/10 to-transparent">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-platinum-500-400 text-sm">Consecutive Years</p>
          ...
          <Card className="glass-card border-cyan-500/30">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-platinum-500-400 text-sm">Satisfaction Rate</p>
              <p className="text-xs text-platinum-500-500 mt-1">Global Power City Index</p>
            </CardContent>
          </Card>
          ...
          <Card className="glass-card border-cyan-500/30">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-platinum-500-400 text-sm">Waste Storage Units</p>
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {cleanlinessKPIs.slice(2, 7).map((kpi, idx) => (
                <div key={idx} className="bg-platinum-800/30 rounded-lg p-3">
                  <p className="text-xs text-platinum-500-400 truncate">{kpi.metric}</p>
              ...
              {cleanlinessKPIs.slice(6).map((kpi, idx) => (
                <div key={idx} className="space-y-2">
                  <div className="flex justify-between text-sm">
                    <span className="text-platinum-500-300">{kpi.metric}</span>
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              {wasteManagementInitiatives.map((initiative, idx) => (
                ...
                >
                  ...
                  <div>
                    <p className="font-medium text-platinum-500-200 text-sm">{initiative.initiative}</p>
                    <p className="text-xs text-emerald-400 mt-1">{initiative.targetStatus}</p>
                    <p className="text-xs text-platinum-500-500">{initiative.timeline}</p>
                  </div>
                </div>
              ))}
            </div>
