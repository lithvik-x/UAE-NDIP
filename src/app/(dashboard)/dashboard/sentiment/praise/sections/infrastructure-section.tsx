        ...
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <Card className="glass-card border-violet-500/30">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-sm text-slate-400">Dubai Metro Length</p>
              ...
              {topDriverlessMetroSystems.map((metro, idx) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-semibold text-slate-200">{metro.metro}</p>
                      <p className="text-xs text-slate-400">{metro.country}</p>
                    </div>
                  </div>
