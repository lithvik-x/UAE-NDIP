...
const severityConfig = {
  ...
  MEDIUM: { color: 'bg-yellow-500/20 text-yellow-400 border-yellow-500/50', icon: TrendingDown, gradient: 'from-yellow-800/50 to-yellow-900/50' },
    ...
    <div className={className}>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4 mb-6">
        ...
        >
          ...
          <p className="text-2xl font-bold text-rose-400" style={{ fontFamily: 'Rajdhani, sans-serif' }}>
            {criticalCount}
          </p>
        ...
        <motion.div
          ...
          className="glass-card border border-yellow-500/50 p-4 text-center"
        >
          <TrendingDown className="h-6 w-6 mx-auto mb-2 text-yellow-400" />
          <p className="text-2xl font-bold text-yellow-400" style={{ fontFamily: 'Rajdhani, sans-serif' }}>
            {mediumCount}
          </p>
        ...
        >
          ...
          <p className="text-2xl font-bold text-emerald-400" style={{ fontFamily: 'Rajdhani, sans-serif' }}>
            {lowCount}
          </p>
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center justify-between">
                  <span className="text-xs text-slate-500">Severity Score</span>
