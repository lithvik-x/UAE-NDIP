                  ...
                  <motion.div key={idx} initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: idx * 0.1 }}
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-2">
                        <Badge variant="outline" className={`text-xs ${t.sentiment === 'positive' ? 'border-emerald-500/50 text-emerald' : t.sentiment === 'controlled' || t.sentiment === 'mixed' ? 'border-orange-500/50 text-orange' : 'border-platinum-500/50 text-platinum'}`}>{t.sentiment}</Badge>
