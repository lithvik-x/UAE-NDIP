                  ...
                  <div className="space-y-4">
                    <div className="space-y-2">
                      <div className="flex items-center justify-between text-sm">
                        <span className="text-slate-400">Automated Detection Rate</span>
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center justify-between text-sm">
                        ...
                        <span className="font-medium text-yellow-400">3.8%</span>
                      </div>
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center justify-between text-sm">
                        ...
                        <span className="font-medium text-navy">2.3 min</span>
                      </div>
                      <Progress value={23} className="h-3" />
                    </div>
                    <div className="space-y-2">
                      <div className="flex items-center justify-between text-sm">
                        <span className="text-slate-400">24/7 Coverage</span>
                        ...
                        <div key={index} className="space-y-2">
                          <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-4">
                              <span className="text-sm font-bold text-slate-200">{cat.count.toLocaleString()}</span>
              ...
              <div className="grid gap-6 lg:grid-cols-2">
                {moderationActions.map((action, index) => (
                  <Card key={index} className="glass-card">
                    ...
                    <CardContent>
                      <div className="text-3xl font-bold text-slate-200">{action.count.toLocaleString()}</div>
                      <p className="text-sm text-slate-400 mt-1">Total count this month</p>
                    </CardContent>
                  </Card>
                ))}
              </div>
                      ...
                      {recentIncidents.map((incident, index) => (
                        ...
                        >
                          <div className="flex items-center gap-4">
                            ...
                            <div>
                              <p className="font-semibold text-slate-200">{incident.content}</p>
                              <p className="text-sm text-slate-400">{incident.platform} · {incident.reason}</p>
                            </div>
                          </div>
                          <div className="flex items-center gap-4">
