...
export default function NarrativeThemesPage() {
  ...
  return (
    <div className="space-y-8 p-8">
          ...
          <div className="grid gap-6 lg:grid-cols-2">
            ...
            <GlassPanel title="Overall Sentiment Distribution" description="Global coverage sentiment breakdown">
              ...
              <div className="mt-4 flex justify-center gap-6">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-platinum-500-400 font-rajdhani">Positive 38%</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="h-3 w-3 rounded-full bg-platinum-400" />
                  <span className="text-sm text-platinum-500-400 font-rajdhani">Neutral 24%</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="h-3 w-3 rounded-full bg-rose-500" />
                  <span className="text-sm text-platinum-500-400 font-rajdhani">Negative 38%</span>
                </div>
              </div>
            </GlassPanel>
            ...
            <GlassPanel title="Narrative Framing Distribution" description="Pro-narrative vs contested vs counter-narrative">
              ...
              <div className="mt-4 flex justify-center gap-6">
                <div className="flex items-center gap-2">
                  <div className="h-3 w-3 rounded-full bg-emerald-500" />
                  <span className="text-sm text-platinum-500-400 font-rajdhani">Pro-Narrative: 3</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="h-3 w-3 rounded-full bg-gold-500" />
                  <span className="text-sm text-platinum-500-400 font-rajdhani">Contested: 6</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="h-3 w-3 rounded-full bg-rose-500" />
                  <span className="text-sm text-platinum-500-400 font-rajdhani">Counter: 3</span>
                </div>
              </div>
            </GlassPanel>
          </div>
          ...
          <GlassPanel title="UAE Profile - Core Data" description="Basic facts and statistics">
            <div className="grid gap-4 md:grid-cols-3 lg:grid-cols-4">
              <div className="space-y-1">
                <p className="text-xs text-platinum-500-500 font-rajdhani">Population</p>
                <p className="text-lg font-semibold font-rajdhani text-platinum-500-900">11M+</p>
              </div>
              <div className="space-y-1">
                <p className="text-xs text-platinum-500-500 font-rajdhani">GDP (2025)</p>
                <p className="text-lg font-semibold font-rajdhani text-platinum-500-900">$569.1B</p>
              </div>
              <div className="space-y-1">
                <p className="text-xs text-platinum-500-500 font-rajdhani">Nationalities</p>
                <p className="text-lg font-semibold font-rajdhani text-platinum-500-900">200+</p>
              </div>
              <div className="space-y-1">
                <p className="text-xs text-platinum-500-500 font-rajdhani">Literacy Rate</p>
                <p className="text-lg font-semibold font-rajdhani text-platinum-500-900">95%</p>
              </div>
            </div>
          </GlassPanel>
        </TabsContent>
            ...
            {findings.map((finding, idx) => (
              ...
              >
                <GlassCard hover className="h-full">
                  ...
                  <h3 className="font-rajdhani font-semibold text-lg text-platinum-500-900 mb-2">
                    {finding.narrative}
                  </h3>
                  <div className="flex items-center gap-4 text-sm">
                    <div className="flex items-center gap-1">
                      <TrendingUp className="h-4 w-4 text-emerald-500" />
                      <span className="text-platinum-500-600 font-rajdhani">{finding.proSources} Pro</span>
                    </div>
                    <div className="flex items-center gap-1">
                      <AlertTriangle className="h-4 w-4 text-rose-500" />
                      <span className="text-platinum-500-600 font-rajdhani">{finding.counterSources} Counter</span>
                    </div>
                  </div>
                </GlassCard>
              </motion.div>
              ...
              {discourseAnalysis.framingPatterns.map((pattern, idx) => (
                <div key={idx} className="flex items-center justify-between p-3 bg-platinum-50 rounded-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="font-rajdhani font-medium text-platinum-500-900">{pattern.pattern}</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <Badge variant="outline" className="font-rajdhani">{pattern.frequency}</Badge>
                    <span className="text-sm text-platinum-500-500 font-rajdhani">
            ...
            {topicClusters.map((cluster, idx) => (
              ...
              >
                <GlassCard hover className="h-full" gradient={
                  ...
                  <h3 className="font-rajdhani font-semibold text-lg text-platinum-500-900 mb-3">
                    {cluster.name}
                  </h3>
                  <div className="space-y-2">
                    {cluster.narratives.map((narrative, nIdx) => (
                      <div key={nIdx} className="flex items-center gap-2 text-sm">
                        <CheckCircle className="h-4 w-4 text-platinum-500-400" />
                        <span className="text-platinum-500-600 font-rajdhani">{narrative}</span>
                      </div>
                    ))}
                  </div>
                  <div className="mt-4 pt-4 border-t border-platinum-200">
                    <div className="flex justify-between text-sm">
                      <span className="text-platinum-500-500 font-rajdhani">Avg Pro Sources:</span>
                      <span className="font-semibold font-rajdhani text-emerald-600">{cluster.averageProSources}</span>
                    </div>
                    <div className="flex justify-between text-sm mt-1">
                      <span className="text-platinum-500-500 font-rajdhani">Avg Counter:</span>
                  ...
                  <div className="space-y-2">
                    {tension.details.map((detail, dIdx) => (
                      <div key={dIdx} className="flex items-start gap-2 text-sm">
                        ...
                        <span className="text-platinum-500-600 font-rajdhani">{detail}</span>
                      </div>
                    ))}
                  </div>
                </GlassCard>
              ...
              <div className="space-y-3">
                {sourceCredibility.tier1Government.map((source, idx) => (
                  <div key={idx} className="flex items-center justify-between p-2 bg-emerald-50 rounded">
                    <div>
                      <span className="font-rajdhani font-medium text-platinum-500-900">{source.source}</span>
                      <span className="text-xs text-platinum-500-500 ml-2 font-rajdhani">({source.type})</span>
                    </div>
          ...
          <GlassPanel title="Source Statistics" description="Summary of sources analyzed">
            <div className="grid gap-4 md:grid-cols-4">
              <div className="text-center p-4 bg-emerald-50 rounded-lg">
                ...
                <p className="text-xs text-platinum-500-500 font-rajdhani">Government/Official</p>
              </div>
              <div className="text-center p-4 bg-gold-50 rounded-lg">
                <p className="text-2xl font-bold font-rajdhani text-gold-600">15</p>
                <p className="text-xs text-platinum-500-500 font-rajdhani">NGO/Human Rights</p>
              </div>
              <div className="text-center p-4 bg-platinum-50 rounded-lg">
                <p className="text-2xl font-bold font-rajdhani text-platinum-500-600">10</p>
                <p className="text-xs text-platinum-500-500 font-rajdhani">Media</p>
              </div>
              <div className="text-center p-4 bg-platinum-50 rounded-lg">
                <p className="text-2xl font-bold font-rajdhani text-platinum-500-600">8</p>
                <p className="text-xs text-platinum-500-500 font-rajdhani">Academic/Think Tank</p>
              </div>
            </div>
          </GlassPanel>
        </TabsContent>
      ...
      {/* Footer */}
      <div className="flex items-center justify-between text-sm text-platinum-500-500">
