...
const tierColors: Record<number, string> = {
  0: 'bg-emerald-500/20 text-emerald-500 border-emerald-500/50',
...
const priorityColors: Record<string, string> = {
  Critical: 'border-rose-500/50 text-rose-500',
  High: 'border-gold-500/50 text-gold-700',
  Medium: 'border-emerald-500/50 text-emerald-500',
}

// Framework tier colors
const frameworkTierColors: Record<number, string> = {
  0: 'bg-emerald-500/20 text-emerald-500',
  1: 'bg-gold-500/20 text-gold-700',
  2: 'bg-navy-500/20 text-navy-500',
  3: 'bg-rose-500/20 text-rose-500',
}
                  ...
                  <div className="flex flex-wrap gap-2">
                    {amecStages.map((stage, idx) => (
                      <motion.div
                        ...
                        className="flex items-center gap-2 rounded-lg border px-3 py-2 cursor-pointer transition-colors hover:bg-platinum-800/50"
                ...
                <div className="space-y-2">
                  {data.sourceCredibilityMatrix.map((source, idx) => (
                    <motion.div
                      ...
                      className="flex items-center justify-between p-3 rounded-lg border border-platinum-700/50 bg-platinum-800/30 hover:bg-platinum-800/50 transition-colors cursor-pointer"
                    >
                  ...
                  >
                    ...
                    <div className="space-y-1">
                      ...
                      {stakeholder.mandates.length > 3 && (
                        <p className="text-xs text-gold-700">+{stakeholder.mandates.length - 3} more mandates</p>
                      )}
                    </div>
        ...
        <TabsContent value="methodology" className="space-y-6">
          ...
          >
              ...
              <div className="space-y-4">
                {data.weeklyDeepDivePhases.map((phase, idx) => (
                  <motion.div
                    ...
                    className="flex items-center gap-4 p-4 rounded-lg border border-platinum-700/50 bg-platinum-800/30 hover:bg-platinum-800/50 transition-colors cursor-pointer"
                  >
                    <div className="flex h-14 w-14 items-center justify-center rounded-full bg-gold-700/20">
                      <span className="text-xl font-bold text-gold-700">{phase.phase}</span>
                    </div>
                    <div className="flex-1">
                      ...
                      <div className="mt-2 flex flex-wrap gap-1">
                        ...
                        {phase.steps.length > 3 && (
                          <span className="text-xs px-2 py-0.5 rounded bg-gold-700/20 text-gold-700">
            ...
            <Card className="glass-card">
              <CardHeader className="pb-2">
                <CardTitle className="text-lg flex items-center gap-2">
                  <GitBranch className="h-5 w-5 text-navy-500" />
              ...
              <div className="space-y-6">
                {data.weeklyDeepDivePhases.map((phase) => (
                  <div key={phase.phase} className="space-y-3">
                    ...
                    <div className="ml-4 space-y-2 border-l-2 border-platinum-700 pl-4">
