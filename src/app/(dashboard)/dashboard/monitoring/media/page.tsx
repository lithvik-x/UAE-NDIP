...
export default function MediaMonitoringPage() {
  ...
  const getSeverityBadge = (severity: string) => {
    switch (severity) {
      ...
      default: return <Badge variant="outline" className="text-xs text-platinum-500-400 border-platinum-400/50">LOW</Badge>
    }
  }
    ...
    <div className="space-y-8 p-8">
      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <h1 className="text-3xl font-extrabold font-rajdhani gradient-text-navy-500">Media Monitoring</h1>
                      ...
                      {topOutlets.map((outlet, index) => (
                        ...
                        >
                          <div className="flex items-center gap-4">
                            ...
                            <div>
                              <p className="font-semibold text-platinum-500-200">{outlet.name}</p>
                              <p className="text-sm text-platinum-500-400">{outlet.coverage.toLocaleString()} articles</p>
                            </div>
                          </div>
                          <div className="flex items-center gap-6">
                            <div className="text-center">
                              <div className="text-lg font-bold text-platinum-500-200">{outlet.reach}M</div>
                      ...
                      {[
                        ...
                        <div key={idx} className="space-y-2">
                          <div className="flex items-center justify-between">
                            <span className="text-sm font-medium text-platinum-500-200">{item.channel}</span>
                            <span className="text-sm font-medium text-platinum-500-400">{item.mentions} mentions</span>
                          </div>
                      ...
                      <div className="space-y-2">
                        {[
                          ...
                          <div key={idx} className="flex items-center justify-between rounded-lg bg-platinum-800/50 p-3">
                            <span className="text-sm font-medium text-platinum-500-200">{item.outlet}</span>
                            <div className="flex items-center gap-3">
                              <span className="text-sm text-platinum-500-400">{item.articles} articles</span>
                  ...
                  <div className="grid gap-4 sm:grid-cols-3">
                    {contentTypeData.map((theme, idx) => (
                      <div key={idx} className="rounded-lg border border-platinum-700 bg-platinum-800/50 p-4 text-center">
                        <div className="text-2xl font-bold text-gold-700">{theme.value}%</div>
                        <p className="text-sm text-platinum-500-400 mt-1">{theme.name}</p>
                      </div>
                    ))}
                  </div>
                </CardContent>
                  ...
                  <div className="space-y-4">
                    <div className="space-y-2">
                      <div className="flex items-center justify-between text-sm">
                        <span className="text-platinum-500-400">Factually Accurate</span>
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center justify-between text-sm">
                        <span className="text-platinum-500-400">Balanced Reporting</span>
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center justify-between text-sm">
                        <span className="text-platinum-500-400">Source Diversity</span>
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center justify-between text-sm">
                        <span className="text-platinum-500-400">Pro-UAE Framing</span>
                        <span className="font-medium text-gold-700">54%</span>
                      </div>
                      ...
                      {flaggedContent.map((item) => (
                        <div key={item.id} className="flex items-start justify-between rounded-lg bg-rose-500/10 p-4 border border-rose-500/30">
                          <div className="flex-1">
                            <p className="font-medium text-platinum-500-200">{item.headline}</p>
                            <p className="text-sm text-platinum-500-400 mt-1">Source: {item.source} · {item.type}</p>
                          </div>
                          <div className="flex items-center gap-3">
                            {getSeverityBadge(item.severity)}
                            <span className="text-xs text-platinum-500-400">{item.time}</span>
                          </div>
                        </div>
                      ))}
                    </div>
                ...
                <CardContent>
                  <div className="grid gap-4 sm:grid-cols-4">
                    <div className="rounded-lg border border-platinum-700 bg-platinum-800/50 p-4 text-center">
                      ...
                      <p className="text-sm text-platinum-500-400">Verified True</p>
                    </div>
                    <div className="rounded-lg border border-platinum-700 bg-platinum-800/50 p-4 text-center">
                      <div className="text-2xl font-bold text-rose-400">89</div>
                      <p className="text-sm text-platinum-500-400">Verified False</p>
                    </div>
                    <div className="rounded-lg border border-platinum-700 bg-platinum-800/50 p-4 text-center">
                      <div className="text-2xl font-bold text-orange-400">234</div>
                      <p className="text-sm text-platinum-500-400">Under Review</p>
                    </div>
                    <div className="rounded-lg border border-platinum-700 bg-platinum-800/50 p-4 text-center">
                      <div className="text-2xl font-bold text-gold-700">45 min</div>
                      <p className="text-sm text-platinum-500-400">Avg Response</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
