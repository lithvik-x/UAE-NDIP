  ...
  if (!data) {
    return (
      <div className="flex items-center justify-center min-h-[400px]">
        <div className="text-platinum-500-400">Loading Crisis Response data...</div>
      </div>
    )
  }
    ...
    >
      ...
      <motion.div variants={item} className="flex items-start justify-between">
        <div>
          ...
          <h1 className="text-3xl font-extrabold font-rajdhani gradient-text-navy-500">Crisis Response Intelligence</h1>
                  ...
                  <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                    <div className="rounded-lg border border-platinum-700 bg-platinum-800/50 p-4">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-sm text-platinum-500-400">Speed Metrics</span>
                      </div>
                      {crisisPerformanceMetrics.speed.map((metric, i) => (
                        <div key={i} className="text-xs text-platinum-500-300 py-1">{metric}</div>
                      ))}
                    </div>
                    <div className="rounded-lg border border-platinum-700 bg-platinum-800/50 p-4">
                      <div className="flex items-center gap-2 mb-2">
                        <BarChart3 className="h-4 w-4 text-primary" />
                        <span className="text-sm text-platinum-500-400">Volume Metrics</span>
                      </div>
                    ...
                    <div className="rounded-lg border border-platinum-700 bg-platinum-800/50 p-4">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-sm text-platinum-500-400">Sentiment Metrics</span>
                      </div>
                    ...
                    <div className="rounded-lg border border-platinum-700 bg-platinum-800/50 p-4">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-sm text-platinum-500-400">Quality Metrics</span>
                      </div>
            ...
            <div className="space-y-6">
              <div className="grid gap-6 lg:grid-cols-3">
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      <div className="flex justify-between text-sm">
                        ...
                        <span className="text-platinum-500-200">Abu Dhabi (ADNEC)</span>
                      </div>
                      <div className="flex justify-between text-sm">
                        <span className="text-platinum-500-400">Organizer:</span>
                        <span className="text-platinum-500-200">NCEMA</span>
                      </div>
                      <div className="flex justify-between text-sm">
                        <span className="text-platinum-500-400">Inaugurated By:</span>
                        <span className="text-platinum-500-200">Nahyan bin Mubarak</span>
                      </div>
                      <div className="pt-2 border-t border-platinum-700">
                        <p className="text-xs text-platinum-500-400 mb-2">Key Focus Areas:</p>
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      <div className="flex justify-between text-sm">
                        ...
                        <span className="text-platinum-500-200">{uaeCrisisInfrastructure.adcmc.date}</span>
                      </div>
                      <div className="flex justify-between text-sm">
                        <span className="text-platinum-500-400">Head:</span>
                        <span className="text-platinum-500-200">Major Gen. Ahmed Saif bin Zaitoon</span>
                      </div>
                      <div className="pt-2 border-t border-platinum-700">
                        <p className="text-xs text-platinum-500-400 mb-2">Readiness Focus:</p>
                        <div className="flex flex-wrap gap-1">
                ...
                <Card className="glass-card border-info/50">
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      <p className="text-sm text-platinum-500-300">{uaeCrisisInfrastructure.barakah2025.purpose}</p>
                      <div className="flex justify-between text-sm">
                        <span className="text-platinum-500-400">Source:</span>
                        <span className="text-platinum-500-200">{uaeCrisisInfrastructure.barakah2025.source}</span>
                      </div>
                    </div>
                  </CardContent>
                </Card>
              ...
              <Card className="glass-card">
                ...
                <CardContent>
                  <blockquote className="border-l-4 border-primary pl-4 italic text-platinum-500-300">
              ...
              {crisisManagementLessons.map((lesson, idx) => (
                ...
                >
                  <Card className="glass-card">
                    ...
                    <CardContent>
                      <p className="text-sm text-platinum-500-400 mb-3">{lesson.description}</p>
                      <div className="space-y-1">
                        {lesson.keyPoints.map((point, i) => (
                          <div key={i} className="flex items-start gap-2 text-sm">
                            <div className="h-1.5 w-1.5 rounded-full bg-primary mt-1.5 shrink-0" />
                            <span className="text-platinum-500-300">{point}</span>
                          </div>
                        ))}
                      </div>
                    </CardContent>
                  ...
                  <div className="grid gap-3 md:grid-cols-2">
                    {realTimeMonitoringSystems.earlyWarningSigns.map((sign, i) => (
                      <div key={i} className="flex items-start gap-3 rounded-lg border border-platinum-700 bg-platinum-800/30 p-3">
                        ...
                        <span className="text-sm text-platinum-500-300">{sign}</span>
                      </div>
                    ))}
                  </div>
                </CardContent>
                ...
                <CardContent>
                  <div className="grid gap-4 md:grid-cols-3">
                    <div className="rounded-lg border border-danger/50 bg-danger/10 p-4 text-center">
                      ...
                      <p className="text-xs text-platinum-500-400">Credentials on Criminal Markets</p>
                    </div>
                    <div className="rounded-lg border border-warning/50 bg-warning/10 p-4 text-center">
                      ...
                      <p className="text-xs text-platinum-500-400">Web Attacks Use Stolen Credentials</p>
                    </div>
                    <div className="rounded-lg border border-danger/50 bg-danger/10 p-4 text-center">
                      <p className="text-2xl font-bold text-danger">{darkWebStats.phishingEmailsInfostealers2024}</p>
                      <p className="text-xs text-platinum-500-400">Phishing Emails with Infostealers (2024)</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                        <span className="text-sm text-platinum-500-400">Crises Going Global &lt;1hr</span>
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-sm text-platinum-500-400">Orgs with Crisis Plan</span>
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-sm text-platinum-500-400">Consumers Avoiding Brand</span>
                ...
                <CardContent>
                  <div className="grid gap-4 md:grid-cols-4">
                    <div className="rounded-lg border border-platinum-700 bg-platinum-800/50 p-4 text-center">
                      ...
                      <p className="text-xs text-platinum-500-400">Active Projects</p>
                    </div>
                    <div className="rounded-lg border border-platinum-700 bg-platinum-800/50 p-4 text-center">
                    ...
                    <div className="rounded-lg border border-platinum-700 bg-platinum-800/50 p-4 text-center">
                      ...
                      <p className="text-xs text-platinum-500-400">Languages</p>
                    </div>
                    <div className="rounded-lg border border-platinum-700 bg-platinum-800/50 p-4 text-center">
                      <p className="text-2xl font-bold text-warning">{factCheckingStatistics.metaPartnershipShare}</p>
                      <p className="text-xs text-platinum-500-400">Meta Partnership</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              {narrativeAttacks.map((attack, idx) => (
                ...
                >
                  <Card className="glass-card border-danger/30">
                    ...
                    <CardContent>
                      <p className="text-sm text-platinum-500-400 mb-3">{attack.description}</p>
                      ...
                      {attack.metrics.engagementVolume && (
                        <p className="text-xs text-platinum-500-500 mt-2">Volume: {attack.metrics.engagementVolume}</p>
                      )}
                    </CardContent>
                  </Card>
                </motion.div>
                        ...
                        {osintTools.map((tool, i) => (
                          <div key={i} className="rounded-lg border border-platinum-700 bg-platinum-800/30 p-3">
                            <div className="flex items-center justify-between mb-1">
                              <span className="font-medium text-platinum-500-200">{tool.name}</span>
                            </div>
                            <p className="text-xs text-platinum-500-400">{tool.capabilities}</p>
                          </div>
                        ))}
                      </div>
                    </ScrollArea>
                      ...
                      <div className="space-y-3">
                        {darkWebTools.map((tool, i) => (
                          <div key={i} className="rounded-lg border border-platinum-700 bg-platinum-800/30 p-3">
                            ...
                            <p className="text-xs text-platinum-500-400">{tool.bestFor}</p>
                          </div>
                        ))}
                      </div>
                    </ScrollArea>
                  ...
                  <div className="space-y-4">
                    {crossPlatformTracking.trackingMethods.map((method, i) => (
                      <div key={i} className="flex items-start gap-3">
                        ...
                        <p className="text-sm text-platinum-500-300">{method}</p>
                      </div>
                    ))}
                  </div>
                </CardContent>
                ...
                <CardContent>
                  <div className="grid gap-4 md:grid-cols-3">
                    <div className="rounded-lg border border-success/50 bg-success/10 p-4">
                      ...
                      <p className="text-sm text-platinum-500-300">Official UAE and primary international sources</p>
                    </div>
                    <div className="rounded-lg border border-warning/50 bg-warning/10 p-4">
                      <Badge variant="warning" className="mb-2">T2</Badge>
                      <p className="text-sm text-platinum-500-300">Peer-reviewed and industry authority sources</p>
                    </div>
                    <div className="rounded-lg border border-platinum-700 bg-platinum-800/30 p-4">
                      ...
                      <p className="text-sm text-platinum-500-300">Industry blogs and general web content</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
