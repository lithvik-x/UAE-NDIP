                ...
                <motion.div variants={cardHover} whileHover="hover" className="glass-card rounded-xl p-6 bg-glass-surface/50 border-glass-border">
                  ...
                  <CardContent className="px-0 pb-0">
                    <div className="space-y-3 text-sm text-platinum-300">
                      ...
                      <div className="flex items-center gap-2"><TrendingUp className="h-4 w-4 text-emerald" />Dubai: primary destination for Russians</div>
                      <div className="flex items-center gap-2"><Shield className="h-4 w-4 text-rose" />Sanctions evasion concerns elevated</div>
                      <div className="flex items-center gap-2"><TrendingUp className="h-4 w-4 text-emerald" />Real estate: significant buyer segment</div>
                    </div>
                  </CardContent>
                </motion.div>
              </div>
                  ...
                  <motion.div key={idx} initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: idx * 0.1 }}
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-2">
                        <Badge variant="outline" className={`${t.sentiment === 'Positive' ? 'border-emerald-500/50 text-emerald' : t.sentiment === 'Negative' ? 'border-rose-500/50 text-rose' : 'border-platinum-500/50 text-platinum'}`}>{t.sentiment}</Badge>
