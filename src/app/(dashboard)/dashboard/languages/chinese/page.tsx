                ...
                <motion.div variants={cardHover} whileHover="hover" className="glass-card rounded-xl p-6 bg-glass-surface/50 border-glass-border">
                  ...
                  <CardContent className="px-0 pb-0">
                    <div className="space-y-3 text-sm text-platinum-300">
                      <div className="flex items-center gap-2"><TrendingUp className="h-4 w-4 text-emerald" />$85B+ annual trade volume</div>
                      <div className="flex items-center gap-2"><TrendingUp className="h-4 w-4 text-emerald" />BRI: key infrastructure partner</div>
                      <div className="flex items-center gap-2"><TrendingUp className="h-4 w-4 text-emerald" />Huawei, Alibaba significant presence</div>
                      <div className="flex items-center gap-2"><TrendingUp className="h-4 w-4 text-emerald" />600K+ Chinese tourists annually</div>
                    </div>
                  </CardContent>
                </motion.div>
              </div>
