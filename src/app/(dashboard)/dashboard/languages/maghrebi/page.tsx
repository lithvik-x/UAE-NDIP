...
export default function MaghrebiArabicPage() {
      ...
      >
        <div className="relative">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <Globe className="h-5 w-5 text-platinum-500 animate-pulse" />
          </div>
        </div>
      </motion.div>
    )
  ...
  const getRelationColor = (status: string) => {
    switch (status.toLowerCase()) {
      ...
      case 'competing': return 'bg-platinum/20 text-platinum-500 border-platinum/50'
    ...
    >
      ...
      >
        <div>
          ...
          >
            <Badge variant="default" className="mb-2 bg-gradient-platinum text-navy-500-950 font-bold">
          ...
          <motion.h1
            ...
            className="text-4xl font-extrabold gradient-text-platinum-500 tracking-tight"
          >
          ...
          {extendedData?.executionMetadata && (
            <motion.div
              ...
              className="mt-3 flex items-center gap-4 text-sm text-platinum-500-500"
            >
        ...
        >
          <Button
            variant="outline"
            className="gap-2 border-platinum/50 text-platinum-500 hover:bg-platinum/10 backdrop-blur-sm transition-all hover:scale-105"
          >
            <Languages className="h-4 w-4" />
            View Dialect Map
          </Button>
          <Button className="bg-gradient-platinum hover:opacity-90 text-navy-500-950 gap-2 font-bold transition-all hover:scale-105 hover:shadow-lg hover:shadow-platinum/20">
          ...
          <TabsList className="glass-panel backdrop-blur-md p-1" scrollable>
            {[
              ...
              <TabsTrigger
                key={tab.value}
                value={tab.value}
                className="data-[state=active]:bg-gradient-platinum data-[state=active]:text-navy-500-950 gap-2 font-bold transition-all"
              >
                {tab.icon}
                {tab.label}
              </TabsTrigger>
                    ...
                    >
                      ...
                      <div className="relative">
                        <div className="flex items-center justify-between mb-2">
                          <h3 className="font-bold text-platinum-500-200">{country.country}</h3>
                        ...
                        <p className="text-xs text-platinum-500-500 mt-1">Tension Score</p>
                      </div>
                    </motion.div>
                  )) : [
                ...
                <motion.div variants={staggerContainer} className="grid gap-6 lg:grid-cols-2">
                  ...
                  <motion.div variants={scaleIn} whileHover={{ scale: 1.02 }}>
                    <Card className="glass-card backdrop-blur-md border-platinum/10">
                      <CardHeader>
                        <CardTitle className="text-lg flex items-center gap-2">
                          <UsersRound className="h-5 w-5 text-platinum-500" />
                          ...
                          {[
                            ...
                            >
                              <div className="flex items-center gap-3">
                                ...
                                <span className="text-platinum-500-200">{item.country}</span>
                              </div>
                              <div className="flex items-center gap-3">
                                <span className="text-sm text-platinum-500-500">{item.population}</span>
                    ...
                    <CardContent>
                      <div className="grid gap-4 lg:grid-cols-4">
                        <div className="space-y-2">
                          ...
                          <Badge variant="outline" className="border-platinum/50 text-platinum-500 font-bold">
                            Tier {credibility?.tier || 3}
                          </Badge>
                        </div>
                        <div className="space-y-2">
                          <p className="text-sm text-platinum-500-400">Credibility Score</p>
                          <div className="text-2xl font-bold text-platinum-500-400">{credibility?.score || 76}%</div>
                        </div>
                        <div className="space-y-2">
                        ...
                        {sourceCredibility && (
                          <div className="space-y-2">
                            <p className="text-sm text-platinum-500-400">Avg Credibility</p>
                        ...
                        >
                          <div className="flex items-center gap-4">
                            <motion.div
                              ...
                              className="flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-br from-platinum/20 to-platinum/5 text-platinum-500 text-sm font-bold border border-platinum/20"
                            >
                              {idx + 1}
                            </motion.div>
                            <div>
                              <p className="font-semibold text-platinum-500-200">{term.term}</p>
                              <p className="text-sm text-platinum-500-500">{term.volume?.toLocaleString()} queries</p>
                            </div>
                          </div>
                          <div className="flex items-center gap-3">
                            <Badge
                            ...
                            {migrantWorkerSentiment.map((item, idx) => (
                              ...
                              >
                                <div className="flex items-center gap-3">
                                  ...
                                  <div>
                                    <p className="font-semibold text-platinum-500-200">{item.source}</p>
                                    <p className="text-xs text-platinum-500-400">{item.framing}</p>
                                  </div>
                                </div>
                    ...
                    <Card className="glass-card backdrop-blur-md border-rose-500/30">
                      ...
                      <CardContent>
                        <div className="space-y-4">
                          ...
                          <div>
                            <p className="text-sm font-bold text-platinum-500-400 mb-2">LOW RISK</p>
                            <div className="flex flex-wrap gap-2">
                              {uaeRelevance.riskHeatMap.lowRisk.map((risk, idx) => (
                                <Badge key={idx} className="bg-platinum-500/20 text-platinum-500-400 border-platinum-500/50">
                                  {risk}
                                </Badge>
                              ))}
                            </div>
                      ...
                      <div className="space-y-3">
                        {searchTermsData.filter(t => t.sentiment === 'negative' || t.term.toLowerCase().includes('tension') || t.term.toLowerCase().includes('border')).map((term, idx) => (
                          ...
                          >
                            <div className="flex items-center gap-3">
                              <AlertCircle className="h-4 w-4 text-rose-400" />
                              <span className="text-platinum-500-200">{term.term}</span>
                            </div>
                            ...
                            >
                              <div className="flex items-center gap-4">
                                <div className={`flex h-10 w-10 items-center justify-center rounded-full ${
                                  ...
                                  source.tier === 2 ? 'bg-platinum-500/20 text-platinum-500' :
                                ...
                                <div>
                                  ...
                                  <p className="text-sm text-platinum-500-500">{source.date}</p>
                                </div>
                              </div>
                              <Badge variant="outline" className={`border-platinum-600 ${
                                source.tier === 1 ? 'text-emerald-400 border-emerald-500/50' :
                                source.tier === 2 ? 'text-platinum-500-400 border-platinum-500/50' :
                                'text-platinum-500-400'
                              }`}>
                                Tier {source.tier || 3}
                              </Badge>
              ...
              <div className="space-y-6">
                ...
                <motion.div variants={scaleIn}>
                  <Card className="glass-card backdrop-blur-md border-platinum/10">
                    <CardHeader>
                      <CardTitle className="text-lg flex items-center gap-2">
                        <Building2 className="h-5 w-5 text-platinum-500" />
                        Country Relations
                      </CardTitle>
                        ...
                        <table className="w-full">
                          <thead>
                            <tr className="border-b border-platinum-700">
                              <th className="text-left py-3 px-4 text-sm font-bold text-platinum-500-400">Country</th>
                              <th className="text-left py-3 px-4 text-sm font-bold text-platinum-500-400">Status</th>
                              <th className="text-left py-3 px-4 text-sm font-bold text-platinum-500-400">Tension</th>
                              <th className="text-left py-3 px-4 text-sm font-bold text-platinum-500-400">Key Disputes</th>
                              <th className="text-left py-3 px-4 text-sm font-bold text-platinum-500-400">Investment</th>
                            </tr>
                          </thead>
                          <tbody>
                            {diplomaticData.length > 0 ? diplomaticData.map((row, idx) => (
                              ...
                              >
                                <td className="py-3 px-4 font-bold text-platinum-500-200">{row.country}</td>
                                ...
                                <td className="py-3 px-4 text-sm text-platinum-500-400">{row.uaeInvestmentLevel}</td>
                              </motion.tr>
                            )) : (
                              <tr className="border-b border-platinum-700/50">
                                <td colSpan={5} className="py-4 text-center text-platinum-500-500">
                      ...
                      <CardContent>
                        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                          <div className="p-4 rounded-lg bg-platinum-800/50 border border-platinum-700/50">
                            <p className="text-sm text-platinum-500-400">UAE FDI to Morocco</p>
                            <p className="text-2xl font-bold text-emerald-400">{moroccoEconomics.uaeFdiToMorocco}</p>
                          </div>
                          <div className="p-4 rounded-lg bg-platinum-800/50 border border-platinum-700/50">
                            <p className="text-sm text-platinum-500-400">Share of Total FDI</p>
                            <p className="text-2xl font-bold text-platinum-500">{moroccoEconomics.uaeShareOfTotalFdi}%</p>
                          </div>
                          <div className="p-4 rounded-lg bg-platinum-800/50 border border-platinum-700/50">
                            <p className="text-sm text-platinum-500-400">Megadeal Value</p>
                            <p className="text-2xl font-bold text-gold-400">{moroccoEconomics.megadealValue}</p>
                          </div>
                          <div className="p-4 rounded-lg bg-platinum-800/50 border border-platinum-700/50">
                            <p className="text-sm text-platinum-500-400">Moroccan Community</p>
                            <p className="text-2xl font-bold text-platinum-500-200">{moroccoEconomics.moroccanCommunityInUae.toLocaleString()}</p>
                          </div>
                        </div>
                      </CardContent>
                    </Card>
                ...
                {extendedData?.diplomaticKeyDates && extendedData.diplomaticKeyDates.length > 0 && (
                  <motion.div variants={scaleIn}>
                    <Card className="glass-card backdrop-blur-md border-platinum/10">
                      <CardHeader>
                        <CardTitle className="text-lg flex items-center gap-2">
                          <Activity className="h-5 w-5 text-platinum-500" />
                          ...
                          <div className="space-y-4">
                            {extendedData.diplomaticKeyDates.map((event, idx) => (
                              ...
                              >
                                ...
                                <div className="flex items-center gap-4">
                                  <span className="text-sm font-bold text-platinum-500 min-w-[80px]">{event.date}</span>
                                  <div>
                                    <p className="text-platinum-500-200 font-medium">{event.event}</p>
                                    <p className="text-xs text-platinum-500-500">{event.countriesInvolved}</p>
                                  </div>
                                </div>
                              </motion.div>
                            ))}
                  ...
                  <motion.div variants={scaleIn}>
                    <Card className="glass-card backdrop-blur-md border-rose-500/20">
                      ...
                      <CardContent>
                        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                          <div className="p-4 rounded-lg bg-platinum-800/50 border border-platinum-700/50">
                            <p className="text-sm text-platinum-500-400">Total Migrant Workers</p>
                            <p className="text-2xl font-bold text-rose-400">{workerStats.totalMigrantWorkers.toLocaleString()}</p>
                          </div>
                          <div className="p-4 rounded-lg bg-platinum-800/50 border border-platinum-700/50">
                            <p className="text-sm text-platinum-500-400">Migrant % of Population</p>
                            <p className="text-2xl font-bold text-platinum-500">{workerStats.migrantPercentageOfPopulation}%</p>
                          </div>
                          <div className="p-4 rounded-lg bg-platinum-800/50 border border-platinum-700/50">
                            <p className="text-sm text-platinum-500-400">Modern Slavery Victims</p>
                            <p className="text-2xl font-bold text-rose-400">{workerStats.modernSlaveryVictims.toLocaleString()}</p>
                          </div>
                          <div className="p-4 rounded-lg bg-platinum-800/50 border border-platinum-700/50">
                            <p className="text-sm text-platinum-500-400">Labour Rights Index</p>
                          ...
                          {entityRegistries.maghrebiWorkersOrigin.map((worker, idx) => (
                            ...
                            >
                              <div className="flex items-center gap-3">
                                ...
                                <div>
                                  <p className="font-bold text-platinum-500-200">{worker.country}</p>
                                  <p className="text-sm text-platinum-500-500">{worker.primarySectors}</p>
                                </div>
                              </div>
                              <Badge className="bg-platinum/20 text-platinum-500 border-platinum/50">
                      ...
                      <CardContent>
                        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                          {gccDemographics.map((country, idx) => (
                            ...
                            >
                              <div className="flex items-center justify-between mb-2">
                                <span className="font-bold text-platinum-500-200">{country.country}</span>
                                {country.country === 'UAE' && (
                                  <Badge className="bg-platinum/20 text-platinum-500 text-xs">FOCUS</Badge>
                                )}
                              </div>
                              <div className="space-y-1 text-sm">
                                <div className="flex justify-between">
                                  <span className="text-platinum-500-500">Population</span>
                                  <span className="text-platinum-500-300">{country.totalPopulation.toLocaleString()}</span>
                                </div>
                                <div className="flex justify-between">
                                  <span className="text-platinum-500-500">% Foreign</span>
                                  <span className="text-platinum-500-300">{country.percentForeign}%</span>
                                </div>
                                <div className="flex justify-between">
                                  <span className="text-platinum-500-500">Migrant Stock</span>
                                  <span className="text-platinum-500-300">{country.migrantStock.toLocaleString()}</span>
                                </div>
                              </div>
                            </motion.div>
                          ))}
