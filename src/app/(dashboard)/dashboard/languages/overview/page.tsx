            ...
            <div className="space-y-6">
              ...
              <Card className="glass-card">
                ...
                <CardContent>
                  <div className="space-y-4">
                    <div>
                      <p className="text-xs text-gold-700 font-medium mb-2">Academic Researchers (Tier 2-3)</p>
                      <div className="flex flex-wrap gap-2">
                    ...
                    <div>
                      <p className="text-xs text-emerald-500 font-medium mb-2">Government & Policy (Tier 0-1)</p>
                      <div className="flex flex-wrap gap-2">
                    ...
                    <div>
                      <p className="text-xs text-orange-500 font-medium mb-2">Campaigns</p>
                      <div className="flex flex-wrap gap-2">
                    ...
                    <div className="rounded-lg border border-gold-700/30 bg-gold-700/10 p-4">
                      ...
                      <div className="grid gap-2 sm:grid-cols-3 lg:grid-cols-6">
                        {['Mohammed', 'Muhammad', 'Mohamed', 'Mohamad', 'Muhamed', 'Muhamad'].map((variant) => (
                          <div key={variant} className="rounded bg-platinum-800/50 px-2 py-1 text-center text-sm text-platinum-500">{variant}</div>
                        ))}
                      </div>
                    </div>
