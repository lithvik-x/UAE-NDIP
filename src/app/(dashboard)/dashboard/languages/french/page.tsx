        ...
        <CardContent>
          <div className="space-y-3">
            {defenseTerms.map((item: any, index: number) => (
              <motion.div
                key={index}
                className="flex items-center justify-between rounded-lg border border-navy-700/50 bg-slate-800/50 p-4 hover:bg-slate-800/70 transition-colors"
                initial={{ opacity: 0, x: -20 }}
                animate={{ opacity: 1, x: 0 }}
        ...
        <CardContent>
          <div className="space-y-3">
            {businessTerms.map((item: any, index: number) => (
              <motion.div
                key={index}
                className="flex items-center justify-between rounded-lg border border-slate-700 bg-slate-800/50 p-4 hover:bg-slate-800/70 transition-colors"
                initial={{ opacity: 0, x: -20 }}
                animate={{ opacity: 1, x: 0 }}
                transition={{ delay: index * 0.1 }}
                whileHover={{ scale: 1.01 }}
        ...
        <CardContent>
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            ...
            >
              ...
              <p className="text-sm text-slate-400 mt-1">UAE Investment</p>
            ...
            >
              ...
              <p className="text-sm text-slate-400 mt-1">AI Campus Capacity</p>
            ...
            >
              ...
              <p className="text-sm text-slate-400 mt-1">Operations Launch</p>
            ...
            >
              ...
              <p className="text-sm text-slate-400 mt-1">Partnership</p>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {culturalInstitutions.map((inst: any, index: number) => (
              ...
              >
                ...
                <p className="text-sm text-slate-300">{inst.description}</p>
                <p className="text-xs text-slate-400 mt-2">{inst.since}</p>
              </motion.div>
            ))}
          </div>
        </CardContent>
