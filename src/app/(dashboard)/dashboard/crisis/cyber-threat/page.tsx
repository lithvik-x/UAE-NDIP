    ...
    >
      ...
      >
        {keyStats.slice(0, 8).map((stat, idx) => (
          <motion.div
            ...
            className="rounded-lg glass-card border border-slate-700/50 p-3 text-center hover:border-violet-500/30 transition-all"
          >
      ...
      <Tabs defaultValue="overview" className="space-y-6" value={activeTab} onValueChange={setActiveTab}>
            ...
            <Tabs defaultValue="stats" className="space-y-6">
              ...
              <TabsContent value="stats" className="space-y-4">
                <div className="rounded-lg glass-card border border-rose-500/30 p-6">
                  <h3 className="text-lg font-semibold text-slate-200 mb-4">Ransomware Statistics (24 months)</h3>
                  <div className="grid gap-4 md:grid-cols-4">
                    <div className="text-center p-4 bg-slate-800/50 rounded-lg border border-rose-500/30">
                      <p className="text-3xl font-bold text-rose">267%</p>
                      <p className="text-xs text-slate-400">Increase (24mo)</p>
                    </div>
                    <div className="text-center p-4 bg-slate-800/50 rounded-lg border border-rose-500/30">
                      <p className="text-3xl font-bold text-rose">145</p>
                      <p className="text-xs text-slate-400">Victims Tracked</p>
                    </div>
                    <div className="text-center p-4 bg-slate-800/50 rounded-lg border border-rose-500/30">
                      <p className="text-3xl font-bold text-rose">44</p>
                      <p className="text-xs text-slate-400">2024 Incidents</p>
                    </div>
                    <div className="text-center p-4 bg-slate-800/50 rounded-lg border border-rose-500/30">
                      <p className="text-3xl font-bold text-rose">78%</p>
                      <p className="text-xs text-slate-400">Orgs Affected (2020)</p>
                    </div>
                  </div>
                </div>
              </TabsContent>
              ...
              <TabsContent value="groups" className="space-y-4">
                <div className="rounded-lg glass-card border border-purple-500/30 p-6">
                  <h3 className="text-lg font-semibold text-slate-200 mb-4">Active Ransomware Groups</h3>
        ...
        <TabsContent value="phishing" className="space-y-6">
          <motion.div variants={fadeInUp}>
            <div className="rounded-lg glass-card border border-rose-500/30 p-6">
              <h3 className="text-lg font-semibold text-slate-200 mb-4">Phishing Statistics</h3>
              <div className="grid gap-4 md:grid-cols-3">
                <div className="text-center p-4 bg-slate-800/50 rounded-lg border border-rose-500/30">
                  <p className="text-3xl font-bold text-rose">75%</p>
                  <p className="text-xs text-slate-400">UAE Breaches from Phishing</p>
                </div>
                <div className="text-center p-4 bg-slate-800/50 rounded-lg border border-rose-500/30">
                  <p className="text-3xl font-bold text-rose">3.4B</p>
                  <p className="text-xs text-slate-400">Global Daily Messages</p>
                </div>
                <div className="text-center p-4 bg-slate-800/50 rounded-lg border border-rose-500/30">
                  <p className="text-3xl font-bold text-rose">90%</p>
                  <p className="text-xs text-slate-400">AI-Powered Breaches</p>
                </div>
              </div>

              <h3 className="text-lg font-semibold text-slate-200 mt-8 mb-4">Major Scam Types in UAE (2026)</h3>
              <div className="grid gap-3 md:grid-cols-3 lg:grid-cols-5">
                {['Fake concert tickets', 'Bogus residency services', 'Domestic worker recruitment', 'Unauthorized insurance', 'Seized vehicle sales', 'Parcel tracking scams', 'Illegal investment schemes', 'Fake real estate', 'Job seeker phishing'].map((scam, idx) => (
                  <div key={idx} className="p-3 bg-slate-800/50 rounded-lg border border-slate-700/50 text-center">
                    <p className="text-sm font-medium text-slate-200">{scam}</p>
                  </div>
                ))}
              </div>
            </div>
        ...
        <TabsContent value="workforce" className="space-y-6">
          <motion.div variants={fadeInUp}>
            <div className="rounded-lg glass-card border border-purple-500/30 p-6">
              <h3 className="text-lg font-semibold text-slate-200 mb-4">Workforce & Talent Gap</h3>
              <div className="grid gap-4 md:grid-cols-4">
                <div className="text-center p-4 bg-slate-800/50 rounded-lg border border-purple-500/30">
                  <p className="text-3xl font-bold text-purple">40%</p>
                  <p className="text-xs text-slate-400">Orgs Lacking Skilled Staff</p>
                </div>
                <div className="text-center p-4 bg-slate-800/50 rounded-lg border border-purple-500/30">
                  <p className="text-3xl font-bold text-purple">90%</p>
                  <p className="text-xs text-slate-400">Tech Cos Reporting Shortage</p>
                </div>
                <div className="text-center p-4 bg-slate-800/50 rounded-lg border border-purple-500/30">
                  <p className="text-3xl font-bold text-purple">47%</p>
                  <p className="text-xs text-slate-400">Struggling to Prioritize</p>
                </div>
                <div className="text-center p-4 bg-slate-800/50 rounded-lg border border-cyan-500/30">
                  ...
                  <p className="text-xs text-slate-400">Home Network Attacks</p>
                </div>
              </div>
            </div>
          </motion.div>
        ...
        <TabsContent value="darkweb" className="space-y-6">
          <motion.div variants={fadeInUp}>
            <div className="rounded-lg glass-card border border-purple-500/30 p-6">
              <h3 className="text-lg font-semibold text-slate-200 mb-4">Dark Web Economy</h3>
              <div className="grid gap-4 md:grid-cols-4">
                <div className="text-center p-4 bg-slate-800/50 rounded-lg border border-purple-500/30">
                  <p className="text-lg font-bold text-purple">$257-$50K</p>
                  <p className="text-xs text-slate-400">Per Database</p>
                </div>
                <div className="text-center p-4 bg-slate-800/50 rounded-lg border border-rose-500/30">
                  <p className="text-lg font-bold text-rose">$22.80</p>
                  <p className="text-xs text-slate-400">UAE InvestBank Data</p>
                </div>
                <div className="text-center p-4 bg-slate-800/50 rounded-lg border border-amber-500/30">
                  <p className="text-lg font-bold text-amber">$17.3M</p>
                  <p className="text-xs text-slate-400">UAE Personal Data (NordVPN)</p>
                </div>
                <div className="text-center p-4 bg-slate-800/50 rounded-lg border border-cyan-500/30">
                  <p className="text-lg font-bold text-cyan">~200K</p>
                  <p className="text-xs text-slate-400">Dubai Property Owners</p>
                </div>
              </div>
            </div>
          </motion.div>
        ...
        <TabsContent value="emerging" className="space-y-6">
          <motion.div variants={fadeInUp}>
            <div className="rounded-lg glass-card border border-purple-500/30 p-6">
              <h3 className="text-lg font-semibold text-slate-200 mb-4">Emerging Threats</h3>
              <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                <div className="p-4 bg-slate-800/50 rounded-lg border border-rose-500/30">
                  <p className="font-medium text-rose">Automated Malware Mutation</p>
                  <p className="text-xs text-slate-400 mt-1">Real-time behavior adaptation</p>
                </div>
                <div className="p-4 bg-slate-800/50 rounded-lg border border-amber-500/30">
                  ...
                  <p className="text-xs text-slate-400 mt-1">$35M loss recorded</p>
                </div>
                <div className="p-4 bg-slate-800/50 rounded-lg border border-orange-500/30">
                  ...
                  <p className="text-xs text-slate-400 mt-1">90% of breaches</p>
                </div>
                <div className="p-4 bg-slate-800/50 rounded-lg border border-purple-500/30">
                  ...
                  <p className="text-xs text-slate-400 mt-1">Iranian groups using</p>
                </div>
              </div>
            </div>
          </motion.div>
        ...
        <TabsContent value="insurance" className="space-y-6">
          <motion.div variants={fadeInUp}>
            <div className="rounded-lg glass-card border border-purple-500/30 p-6">
              <h3 className="text-lg font-semibold text-slate-200 mb-4">Cyber Insurance Market</h3>
              <div className="grid gap-4 md:grid-cols-4">
                <div className="text-center p-4 bg-slate-800/50 rounded-lg border border-purple-500/30">
        ...
        <TabsContent value="laws" className="space-y-6">
          <motion.div variants={fadeInUp}>
            <div className="rounded-lg glass-card border border-purple-500/30 p-6">
              <h3 className="text-lg font-semibold text-slate-200 mb-4">Federal Law No. 34 of 2021 - Cybercrime Penalties</h3>
              <div className="grid gap-4 md:grid-cols-4">
                <div className="p-4 bg-slate-800/50 rounded-lg border border-purple-500/30">
              ...
              <h3 className="text-lg font-semibold text-slate-200 mt-8 mb-4">Defense Capabilities</h3>
