...
export default function CommunicationCrisisPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-platinum-950 via-platinum-900 to-platinum-950 p-6 font-rajdhani">
      <motion.div initial="hidden" animate="visible" variants={staggerContainer} className="max-w-[1800px] mx-auto space-y-6">
        ...
        <motion.div variants={fadeInUp}>
          <Tabs tabs={tabs} activeTab={activeTab} onTabChange={setActiveTab} className="bg-platinum-900/50 backdrop-blur-xl rounded-xl border border-platinum-700/50 p-2" />
        </motion.div>
      ...
      <GlassPanel variant="dark" className="p-6 rounded-xl border border-platinum-700/50">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {governmentCounterMeasures?.map((measure, idx) => (
            <motion.div key={idx} variants={fadeInUp} whileHover="hover" initial="rest" animate="rest" className="bg-platinum-800/50 rounded-lg p-4 border border-platinum-700/30">
  ...
  return (
    <div className="space-y-6">
      <GlassPanel variant="dark" className="p-6 rounded-xl border border-platinum-700/50">
        ...
        <div className="bg-platinum-800/50 rounded-lg p-4 border border-platinum-700/30 mb-6">
    ...
    <div className="space-y-6">
      ...
      <GlassPanel variant="dark" className="p-6 rounded-xl border border-platinum-700/50">
        ...
        <div className="relative mb-4">
          <div className="absolute left-4 top-0 bottom-0 w-0.5 bg-platinum-700" />
          <div className="space-y-4">
            {andreGauthierTimeline?.map((event, idx) => (
              <div key={idx} className="relative flex items-start gap-4 pl-20">
                <div className="absolute left-2.5 w-3 h-3 bg-cyan-400 rounded-full border-2 border-platinum-950" />
                <div className="bg-platinum-800/50 rounded-lg p-3 border border-platinum-700/30 flex-1">
