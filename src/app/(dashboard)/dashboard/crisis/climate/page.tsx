            ...
            >
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        {expandedCards['fujairah-timeline'] && (
                          <div className="space-y-2 p-4 rounded-lg bg-platinum-800/30">
              ...
              <motion.div variants={itemVariants}>
                <Card className="glass-card border-orange-500/30">
                  ...
                  <CardContent>
                    <div className="grid gap-4 md:grid-cols-2">
                      <div className="rounded-lg border border-orange-500/30 bg-platinum-800/30 p-4">
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      {extended.recentSeismicEvents.map((event, idx) => (
                        <div key={idx} className="flex items-center justify-between p-3 rounded-lg bg-platinum-800/50 hover:bg-platinum-800/70 transition-colors">
                    ...
                    <div className="space-y-3">
                      {[
                        ...
                        <motion.div
                          ...
                          animate={{ opacity: 1, x: 0 }}
                          transition={{ delay: idx * 0.1 }}
                          className="flex items-center justify-between p-3 rounded-lg bg-platinum-800/50 hover:bg-platinum-800/70 transition-colors"
                        >
                          <div className="flex items-center gap-3">
