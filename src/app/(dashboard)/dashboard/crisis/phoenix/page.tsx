    ...
    <div className="space-y-8 p-8">
      ...
      >
        <div>
          ...
          <h1 className="text-3xl font-extrabold font-rajdhani gradient-text-rose-500">Phoenix Project</h1>
            ...
            <div className="space-y-6">
              ...
              <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
                {reputationCrisisExtendedData.crisisCategories.map((crisis, index) => (
                  ...
                  >
                    ...
                    <h4 className="font-semibold text-platinum-500-200 text-sm">{crisis.name}</h4>
                    <p className="text-xs text-platinum-500-400 mt-1">{crisis.timeline}</p>
                    <p className="text-xs text-platinum-500-500 mt-2 line-clamp-2">{crisis.keyIssue}</p>
                  </motion.div>
                ))}
              </div>
              ...
              <div className="grid gap-6 lg:grid-cols-4">
                ...
                >
                  ...
                  <p className="text-sm text-platinum-500-400 mt-1">RSF Press Freedom Rank</p>
                  <p className="text-xs text-platinum-500-500">164/180 - 3rd worst in Middle East</p>
                </motion.div>
                <motion.div
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                ...
                >
                  ...
                  <p className="text-sm text-platinum-500-400 mt-1">Freedom House Score</p>
                  <p className="text-xs text-platinum-500-500">18/100 - Not Free</p>
                </motion.div>
                <motion.div
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                ...
                >
                  ...
                  <p className="text-sm text-platinum-500-400 mt-1">UAE94 Defendants</p>
                  <p className="text-xs text-platinum-500-500">67+ life sentences</p>
                </motion.div>
                <motion.div
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                ...
                >
                  ...
                  <p className="text-sm text-platinum-500-400 mt-1">Iran War Detentions</p>
                  <p className="text-xs text-platinum-500-500">Social media content arrests</p>
                </motion.div>
              </div>
            </div>
          </GlassPanel>
                  ...
                  <div className="space-y-4">
                    <div className="grid gap-4 sm:grid-cols-3">
                      <div className="glass-card p-4 rounded-lg">
                        ...
                        <p className="text-sm text-platinum-500-400">Influencers in Dubai</p>
                      </div>
                      <div className="glass-card p-4 rounded-lg">
                        <div className="text-2xl font-bold text-orange-400">{reputationCrisisExtendedData.iranWarStats.arrestedForContent}</div>
                        <p className="text-sm text-platinum-500-400">Arrested for Content</p>
                      </div>
                      <div className="glass-card p-4 rounded-lg">
                        <div className="text-2xl font-bold text-amber-400">375+</div>
                        <p className="text-sm text-platinum-500-400">Total Detainees</p>
                      </div>
                    </div>
                    <div className="p-4 bg-platinum-800/50 rounded-lg border border-platinum-700">
                      ...
                      <p className="text-xs text-platinum-500-500 mt-2">— Radha Stirling, Detained in Dubai</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent>
                  <div className="grid gap-3">
                    {reputationCrisisExtendedData.keyQuotes.slice(0, 4).map((q, i) => (
                      ...
                      >
                        <p className="text-sm text-platinum-500-200">{q.quote}</p>
                        <p className="text-xs text-platinum-500-500 mt-1">— {q.source}</p>
                      </motion.div>
                    ))}
                  </div>
                </CardContent>
              ...
              <Card className="glass-card">
                ...
                <CardContent>
                  <div className="grid gap-4 sm:grid-cols-2">
                    <div className="glass-card p-4 rounded-lg">
                      <div className="text-3xl font-bold text-gold-700">${(reputationCrisisExtendedData.sudanCrisis.uaegiftsToUSUniversities / 1000000).toFixed(0)}M</div>
                      <p className="text-sm text-platinum-500-400">UAE Gifts to US Universities</p>
                      <p className="text-xs text-platinum-500-500">Feb 2001 - Apr 2024</p>
                    </div>
                    <div className="glass-card p-4 rounded-lg">
                      ...
                      <p className="text-sm text-platinum-500-400">Cultural Investment</p>
                      <p className="text-xs text-platinum-500-500">Since 2017</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent>
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                    {reputationCrisisExtendedData.tortureMethods.map((method, i) => (
                      ...
                      >
                        <p className="text-xs text-platinum-500-300">{method}</p>
                      </motion.div>
                    ))}
                  </div>
                </CardContent>
                    ...
                    {reputationCrisisExtendedData.sportsBans.map((ban, i) => (
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p className="font-medium text-platinum-500-200">{ban.body} - {ban.year}</p>
                            <p className="text-sm text-platinum-500-400">{ban.type}</p>
                          </div>
                        </div>
                    ...
                    {Object.entries(reputationCrisisExtendedData.pressFreedomIndex).map(([key, data]) => (
                      <div key={key} className="space-y-2">
                        <div className="flex items-center justify-between text-sm">
                          <span className="text-platinum-500-400 capitalize">{key.replace(/([A-Z])/g, ' $1').trim()}</span>
                    ...
                    {reputationCrisisExtendedData.sentimentByCategory.map((item, i) => (
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <span className="font-medium text-platinum-500-200">{item.category}</span>
                        </div>
                        <div className="text-right">
                          ...
                          <p className="text-xs text-platinum-500-500 mt-1">{item.tone}</p>
                        </div>
                      </motion.div>
                    ))}
                  </div>
                ...
                <CardContent>
                  <div className="grid gap-4">
                    {reputationCrisisExtendedData.keyQuotes.map((q, i) => (
                      ...
                      >
                        <p className="text-platinum-500-200 italic">"{q.quote.replace(/"/g, '')}"</p>
