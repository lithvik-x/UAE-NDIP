    ...
    <div className="space-y-6 p-6">
      ...
      <div className="flex flex-col gap-4">
        <div className="flex items-center gap-3">
          <Badge variant="gold" className="text-sm font-bold tracking-wider">
            CORPORATE ENTITIES
          </Badge>
        </div>
        <div>
          ...
          <p className="mt-1 text-platinum-600 dark:text-platinum-400">
            Monitoring corporate entities operating within the UAE ecosystem
          </p>
        </div>
      </div>
        ...
        <Card className="glass-premium">
          ...
          <CardContent>
            <BarChart
              ...
              bars={[{ dataKey: 'count', name: 'Entities', color: '#F59E0B' }]}
              xAxisKey="tier"
              height={200}
              showLegend={false}
              showTooltip
      ...
      {/* Entity Table */}
      <GlassPanel title="Entity Directory" description={`${totalCount} corporate entities tracked`}>
