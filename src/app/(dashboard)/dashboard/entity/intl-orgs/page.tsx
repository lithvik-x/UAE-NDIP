    ...
    <div className="space-y-6 p-6">
      ...
      <div className="flex flex-col gap-4">
        <div className="flex items-center gap-3">
          <Badge variant="denim" className="text-sm font-bold tracking-wider">
        ...
        <div>
          ...
          <p className="mt-1 text-platinum-600 dark:text-platinum-400">
            Tracking international organizations with UAE operations and influence
          </p>
        </div>
      </div>
        ...
        <Card className="glass-premium">
          ...
          <CardContent>
            <BarChart
              ...
              bars={[{ dataKey: 'count', name: 'Organizations', color: '#3b82f6' }]}
              xAxisKey="tier"
              height={200}
              showLegend={false}
              showTooltip
      ...
      {/* Entity Table */}
      <GlassPanel title="Organization Directory" description={`${totalCount} international organizations tracked`}>
                  ...
                  <TableCell>
                    <div className="flex items-center gap-2">
                      <div className="h-2 w-16 rounded-full bg-platinum-200 dark:bg-platinum-700">
                        <div
                          className="h-2 rounded-full bg-gradient-to-r from-denim-400 to-denim-600"
      ...
      {keyFindings.length > 0 && (
        <GlassPanel title="Key Findings" description="Critical intelligence findings">
