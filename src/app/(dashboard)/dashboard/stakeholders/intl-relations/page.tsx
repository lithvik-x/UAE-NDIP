              ...
              <CardContent className="space-y-4">
                {threatIndicatorsData.arabOpinionIndex.greatestThreats.map((threat) => (
                  <div key={threat.threat}>
                    ...
                    <Progress value={threat.toArabNation} className="h-2 bg-platinum-700" />
                  </div>
                ))}
              ...
              <CardContent className="space-y-4">
                <div className="space-y-3">
                  <div>
                    ...
                    <Progress value={threatIndicatorsData.gulfThreatData.israelPoliciesThreat} className="h-2 bg-platinum-700" />
                  </div>
                  <div>
                    <div className="flex justify-between mb-1">
                    ...
                    <Progress value={threatIndicatorsData.gulfThreatData.usPoliciesThreat} className="h-2 bg-platinum-700" />
                  </div>
                  <div>
                    <div className="flex justify-between mb-1">
                      <span className="text-sm">Iranian Policies</span>
                      <span className="text-amber-400 font-bold">{threatIndicatorsData.gulfThreatData.iranPoliciesThreat}%</span>
                    </div>
                    <Progress value={threatIndicatorsData.gulfThreatData.iranPoliciesThreat} className="h-2 bg-platinum-700" />
                  </div>
                </div>
                <div className="pt-4 border-t border-platinum-700">
