                  ...
                  <CardContent>
                    <div className="space-y-4">
                      <div className="flex items-center gap-2 text-sm">
                        <Badge variant="outline" className="border-gold-700/50 text-gold-700">Est. 2001</Badge>
                        <Badge variant="outline" className="border-emerald-500/50 text-emerald-500">Arab Media Capital 2020</Badge>
                      </div>
              ...
              <motion.div whileHover={{ scale: 1.02 }} transition={{ duration: 0.2 }}>
                <Card className="glass-card h-full">
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      <div className="flex items-center gap-2 text-sm">
                        <Badge variant="outline" className="border-emerald-500/50 text-emerald-500">Film/TV Hub</Badge>
              ...
              <Card className="glass-card">
                ...
                <CardContent>
                  <div className="grid gap-2">
                    {[
                      { icon: <Star className="h-4 w-4 text-gold-700" />, text: 'Golden Visa nomination and relocation services' },
                      { icon: <Mic className="h-4 w-4 text-emerald-500" />, text: 'Platform consultations with social media representatives' },
                      { icon: <Users className="h-4 w-4 text-navy-500" />, text: '1 Billion Followers Summit all-access pass' },
                      { icon: <Camera className="h-4 w-4 text-violet-500" />, text: 'Studio discounts on facilities and equipment' },
                      { icon: <BookOpen className="h-4 w-4 text-amber-500" />, text: 'Priority booking for limited-seats workshops' },
                      { icon: <UsersRound className="h-4 w-4 text-rose-500" />, text: 'Complimentary studios after 5PM access' },
                    ].map((benefit, idx) => (
                ...
                <CardContent>
                  <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    {[
                      ...
                      <motion.div
                        key={idx}
                        className="p-4 rounded-lg border border-platinum-700 hover:border-gold-700/50 transition-colors"
                ...
                <CardContent>
                  <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                    {[
                      ...
                      <motion.div
                        key={idx}
                        className="flex items-center gap-3 p-3 rounded-lg border border-platinum-700 hover:border-gold-700/30 transition-colors"
