  ...
  return (
    <div className="space-y-6">
      ...
      >
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-slate-300">{climateRiskData.heat.trend}</p>
          </div>
        </div>
        <div className="mt-3 space-y-2">
          <p className="text-xs text-slate-400">Primary Threats:</p>
        ...
        <p className="text-xs text-slate-500 mt-3 italic">{climateRiskData.heat.whoNote}</p>
      </motion.div>
          ...
          {climateRiskData.seaLevelRise.abuDhabiProjections.map((proj, idx) => (
            ...
            >
              <p className={`text-xs font-semibold ${
                proj.scenario.includes('Extreme') ? 'text-rose-400' : 'text-slate-300'
              }`}>{proj.scenario}</p>
              <div className="mt-2 grid grid-cols-3 gap-2 text-xs">
                <div>
                  <p className="text-slate-500">Rise</p>
                  <p className="font-bold text-cyan-400">{proj.rise}</p>
                </div>
                <div>
                  <p className="text-slate-500">Retreat</p>
                  <p className="font-bold text-cyan-400">{proj.coastalRetreat}</p>
                </div>
                <div>
                  <p className="text-slate-500">Flooded</p>
      ...
      <motion.div
        ...
        animate={{ opacity: 1 }}
        transition={{ delay: 0.3 }}
        className="rounded-xl border border-blue-500/20 bg-blue-900/10 p-5"
      >
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div>
            ...
            <p className="text-lg font-bold text-blue-400">{climateRiskData.waterStress.status}</p>
          </div>
          <div>
            <p className="text-xs text-slate-400">Investment Commitment</p>
            <p className="text-lg font-bold text-blue-400">{climateRiskData.waterStress.investmentCommitment}</p>
          </div>
        </div>
        <div className="mt-3 space-y-2">
          <p className="text-xs text-slate-400">Primary Drivers:</p>
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            {climateRiskData.sectorImpacts.map((sector, idx) => (
              <motion.div
                ...
                transition={{ delay: idx * 0.1 }}
                whileHover={{ scale: 1.02 }}
                className="flex items-center gap-3 rounded-lg border border-slate-700/50 bg-slate-800/30 p-3"
              >
  ...
  return (
    <div className="space-y-6">
      ...
      <motion.div
        ...
        className="rounded-xl border border-slate-700/50 bg-[var(--glass-surface)] p-5"
      >
        <h4 className="text-sm font-semibold text-slate-300 mb-3">Target Sectors</h4>
      ...
      >
        ...
        <div className="mt-4 rounded-lg border border-teal-500/20 bg-teal-900/20 p-3">
          ...
          <p className="text-sm text-slate-300 mt-1">{climateCircularEconomyData.keyStatistic}</p>
        </div>
      </motion.div>
    </div>
  )
  ...
  return (
    <div className="space-y-6">
      ...
      <motion.div
        ...
        className="rounded-xl border border-slate-700/50 bg-[var(--glass-surface)] p-5"
      >
        <h4 className="text-sm font-semibold text-slate-300 mb-4">Net Zero Target Years</h4>
        <div className="space-y-3">
          {menaClimateContextData.netZeroCommitments.map((commitment, idx) => (
            <motion.div
              ...
              animate={{ opacity: 1, x: 0 }}
              transition={{ delay: idx * 0.1 }}
              className="flex items-center gap-4 rounded-lg border border-slate-700/30 bg-slate-800/20 p-3"
            >
              <div className="text-center">
      ...
      <motion.div
        ...
        className="rounded-xl border border-slate-700/50 bg-[var(--glass-surface)] p-5"
      >
        <h4 className="text-sm font-semibold text-slate-300 mb-4">Key NDC Targets</h4>
        <ScrollArea className="h-[200px]">
          <div className="space-y-2">
            {menaClimateContextData.keyNDCTargets.map((ndc, idx) => (
              <div key={ndc.country} className="flex items-center justify-between rounded-lg border border-slate-700/30 bg-slate-800/20 p-2">
                <span className="text-sm font-medium text-slate-200">{ndc.country}</span>
                <Badge variant="outline" className="text-xs">
                  {ndc.target}
                </Badge>
              </div>
      ...
      <motion.div
        ...
        className="rounded-xl border border-slate-700/50 bg-[var(--glass-surface)] p-5"
      >
        <h4 className="text-sm font-semibold text-slate-300 mb-4">Regional Carbon Market Initiatives</h4>
        <div className="space-y-3">
  ...
  return (
    <div className="space-y-6">
      ...
      <motion.div
        ...
        className="rounded-xl border border-slate-700/50 bg-[var(--glass-surface)] p-5"
      >
        <h4 className="text-sm font-semibold text-slate-300 mb-4">International Assessment</h4>
        <div className="space-y-3">
      ...
      >
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          <div>
            <p className="text-xs text-slate-400">Affected Exports</p>
          ...
          <div>
            ...
            <p className="text-sm text-slate-300">{climateCriticalPerspectives.euCBAMImplications.impact}</p>
          </div>
        </div>
      </motion.div>
      ...
      <motion.div
        ...
        className="rounded-xl border border-slate-700/50 bg-[var(--glass-surface)] p-5"
      >
        <h4 className="text-sm font-semibold text-slate-300 mb-3">Industry Challenges</h4>
        <div className="space-y-2">
      ...
      >
        ...
        <div className="space-y-3">
          <div className="rounded-lg border border-amber-500/20 bg-amber-900/20 p-3">
            ...
            <p className="text-sm text-slate-300">{climateCriticalPerspectives.enforcementTrends2026.requirement}</p>
          </div>
          <div className="rounded-lg border border-amber-500/20 bg-amber-900/20 p-3">
            <p className="text-xs text-amber-400 font-semibold">Verification</p>
            <p className="text-sm text-slate-300">{climateCriticalPerspectives.enforcementTrends2026.verification}</p>
          </div>
          <div>
            <p className="text-xs text-slate-400 mb-2">Penalties:</p>
            <div className="flex flex-wrap gap-2">
  ...
  return (
    <div className="space-y-6">
      ...
      <motion.div
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        className="relative overflow-hidden rounded-2xl border border-slate-500/20 bg-gradient-to-br from-slate-900/20 via-slate-950/40 to-transparent p-6"
      >
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,rgba(100,116,139,0.15),transparent_50%)]" />
        <div className="relative z-10">
          <Badge variant="outline" className="border-slate-500/50 text-slate-400 mb-2">
            <Info className="h-3 w-3 mr-1" />
            COMPREHENSIVE DATA
          </Badge>
          <h3 className="text-2xl font-bold text-slate-300 mb-1">Statistics Compendium</h3>
          <p className="text-sm text-slate-400">
        ...
        <CardContent>
          <div className="grid gap-4 sm:grid-cols-3">
            <div className="rounded-lg border border-slate-700/50 bg-slate-800/30 p-3 text-center">
              <p className="text-2xl font-bold text-slate-200">{climateResearchMetadata.atomicQueries}</p>
              <p className="text-xs text-slate-400">Atomic Queries</p>
            </div>
            <div className="rounded-lg border border-slate-700/50 bg-slate-800/30 p-3 text-center">
              <p className="text-2xl font-bold text-slate-200">{climateResearchMetadata.sourcesAccessed}</p>
              <p className="text-xs text-slate-400">Sources Accessed</p>
            </div>
            <div className="rounded-lg border border-slate-700/50 bg-slate-800/30 p-3 text-center">
              <p className="text-2xl font-bold text-slate-200">{climateResearchMetadata.webFetchPages}</p>
              <p className="text-xs text-slate-400">WebFetch Pages</p>
            </div>
          </div>
          <div className="mt-4">
          ...
          <ScrollArea className="h-[200px]">
            <div className="space-y-2">
              {climateStatisticsCompendium.investmentFinance.map((stat, idx) => (
                <div key={idx} className="flex items-center justify-between rounded-lg border border-slate-700/30 bg-slate-800/20 p-2">
                  <span className="text-sm text-slate-300">{stat.statistic}</span>
                  <div className="text-right">
      ...
      <Card className="glass-card">
        ...
        <CardContent>
          ...
          <div className="mt-4">
            <p className="text-xs text-slate-400 mb-2">Identified Gaps:</p>
