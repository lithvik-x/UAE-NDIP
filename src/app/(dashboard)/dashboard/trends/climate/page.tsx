        ...
        <CardContent>
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="rounded-lg border border-platinum-700/50 bg-platinum-800/30 p-3">
              ...
              <p className="text-xl font-bold text-amber">{menaClimateContextData.regionalEmissions.shareGlobalCrudeOilReserves}</p>
            </div>
            <div className="rounded-lg border border-platinum-700/50 bg-platinum-800/30 p-3">
              <p className="text-xs text-platinum-500">Global Gas Share</p>
              <p className="text-xl font-bold text-cyan">{menaClimateContextData.regionalEmissions.shareGlobalNaturalGas}</p>
            </div>
            <div className="rounded-lg border border-platinum-700/50 bg-platinum-800/30 p-3">
              <p className="text-xs text-platinum-500">Per Capita Annual Emissions</p>
              <p className="text-xl font-bold text-rose">{menaClimateContextData.regionalEmissions.perCapitaAnnualEmissions}</p>
            </div>
            <div className="rounded-lg border border-platinum-700/50 bg-platinum-800/30 p-3">
              <p className="text-xs text-platinum-500">Total Regional Through 2050</p>
              <p className="text-xl font-bold text-emerald">{menaClimateContextData.regionalEmissions.totalRegionalEmissionsThrough2050}</p>
            </div>
          </div>
        </CardContent>
      </Card>
