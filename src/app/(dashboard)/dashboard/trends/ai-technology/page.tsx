  ...
  return (
    <motion.div variants={fadeInUp} className="glass-panel p-4 rounded-xl">
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          <p className="text-sm font-semibold text-gold truncate">{topic}</p>
          ...
          <CardContent>
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
              {data.subsidiaries.map((sub, i) => (
                ...
                >
                  <div className="flex h-12 w-12 mx-auto items-center justify-center rounded-xl mb-3 bg-gold/20">
            ...
            <div className="grid gap-4 sm:grid-cols-3">
              {[
                ...
                >
                  ...
                  <p className="text-sm text-gold mt-1">{product.detail}</p>
                </motion.div>
              ))}
            </div>
          </CardContent>
          ...
          <CardContent>
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="rounded-xl border border-gold-500/30 bg-gold-500/10 p-6 text-center">
                ...
                <p className="text-4xl font-bold text-gold">60%</p>
                <p className="text-sm text-platinum-400 mt-2">Last-mile deliveries by autonomous systems</p>
              </div>
              <div className="rounded-xl border border-gold-500/30 bg-gold-500/10 p-6 text-center">
                <Car className="h-8 w-8 mx-auto text-gold mb-2" />
...
function QuantumSection() {
  ...
  return (
    <GlassPanel
      ...
      icon={<Atom className="h-5 w-5 text-gold" />}
    >
      <div className="space-y-6">
        {/* Key Stats */}
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="space-y-3">
                {data.plans.map((plan, i) => (
                  ...
                  >
                    ...
                    <span className="text-lg font-bold text-navy">{plan.monthly}</span>
                  </motion.div>
                ))}
              </div>
            </ScrollArea>
...
function TalentSection() {
  ...
  return (
    <GlassPanel
      ...
      icon={<PersonStanding className="h-5 w-5 text-gold" />}
    >
      <div className="space-y-6">
        {/* Key Metrics */}
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                ...
                {data.majorDeals.map((deal, i) => (
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        <p className="text-lg font-bold text-gold">{deal.value}</p>
    ...
    <div className="space-y-8 p-8 min-h-screen font-rajdhani">
      ...
      >
        <div>
          ...
          <h1 className="text-4xl font-extrabold font-rajdhani gradient-text-gold tracking-tight">AI Technology</h1>
      ...
      <motion.div variants={staggerContainer} initial="initial" animate="animate">
        <GlassPanel title="Summary KPIs" icon={<Activity className="h-5 w-5 text-gold" />}>
