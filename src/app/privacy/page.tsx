...
export default function PrivacyPage() {
  return (
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      <div className="mb-8">
        <h1 className="text-4xl font-bold font-rajdhani text-platinum-500-900 mb-4">Privacy Policy</h1>
        <p className="text-platinum-500-600">Last updated: January 14, 2026</p>
      </div>

      <div className="space-y-6">
        <GlassPanel className="p-8">
          <h2 className="text-2xl font-semibold font-rajdhani text-navy-500-900 mb-4">1. Information We Collect</h2>
          <p className="text-platinum-500-700 mb-4">
          ...
          <h3 className="text-xl font-semibold font-rajdhani text-platinum-500-900 mb-2">Data Types</h3>
          <ul className="list-disc list-inside text-platinum-500-700 space-y-2">
        ...
        <GlassPanel className="p-8">
          <h2 className="text-2xl font-semibold font-rajdhani text-navy-500-900 mb-4">2. Data Storage & Security</h2>
          <p className="text-platinum-500-700 mb-4">
        ...
        <GlassPanel className="p-8">
          <h2 className="text-2xl font-semibold font-rajdhani text-navy-500-900 mb-4">3. Data Usage</h2>
          <p className="text-platinum-500-700 mb-4">
        ...
        <GlassPanel className="p-8">
          <h2 className="text-2xl font-semibold font-rajdhani text-navy-500-900 mb-4">4. Data Sharing</h2>
          <p className="text-platinum-500-700 mb-4">
        ...
        <GlassPanel className="p-8">
          <h2 className="text-2xl font-semibold font-rajdhani text-navy-500-900 mb-4">5. Your Rights</h2>
          <p className="text-platinum-500-700 mb-4">
        ...
        <GlassPanel className="p-8">
          <h2 className="text-2xl font-semibold font-rajdhani text-navy-500-900 mb-4">6. Contact Us</h2>
          <p className="text-platinum-500-700 mb-4">
            For any privacy-related questions or concerns, please contact us at:
          </p>
          <div className="bg-platinum-50 p-4 rounded-lg">
            <p className="text-platinum-500-900 font-medium">Email: privacy@ndip.dossier.li</p>
            <p className="text-platinum-500-900 font-medium">Company: CryptoMize | cryptomize.com</p>
            <p className="text-platinum-500-900 font-medium">HQ: New Delhi, India</p>
          </div>
        </GlassPanel>
      </div>
    </div>
