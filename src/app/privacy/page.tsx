...
export default function PrivacyPage() {
  return (
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      <div className="mb-8">
        <h1 className="text-4xl font-bold font-rajdhani text-platinum-900 mb-4">Privacy Policy</h1>
        <p className="text-platinum-600">Last updated: January 14, 2026</p>
      </div>

      <div className="space-y-6">
        <GlassPanel className="p-8">
          <h2 className="text-2xl font-semibold font-rajdhani text-navy-900 mb-4">1. Information We Collect</h2>
          ...
          <h3 className="text-xl font-semibold font-rajdhani text-platinum-900 mb-2">Data Types</h3>
        ...
        <GlassPanel className="p-8">
          <h2 className="text-2xl font-semibold font-rajdhani text-navy-900 mb-4">2. Data Storage & Security</h2>
          <p className="text-platinum-700 mb-4">
        ...
        <GlassPanel className="p-8">
          <h2 className="text-2xl font-semibold font-rajdhani text-navy-900 mb-4">3. Data Usage</h2>
          <p className="text-platinum-700 mb-4">
        ...
        <GlassPanel className="p-8">
          <h2 className="text-2xl font-semibold font-rajdhani text-navy-900 mb-4">4. Data Sharing</h2>
          <p className="text-platinum-700 mb-4">
        ...
        <GlassPanel className="p-8">
          <h2 className="text-2xl font-semibold font-rajdhani text-navy-900 mb-4">5. Your Rights</h2>
          <p className="text-platinum-700 mb-4">
        ...
        <GlassPanel className="p-8">
          <h2 className="text-2xl font-semibold font-rajdhani text-navy-900 mb-4">6. Contact Us</h2>
          <p className="text-platinum-700 mb-4">
