      ...
      <GlassPanel title="Disease Outbreaks & Surveillance" description="MERS-CoV, Mpox, Dengue, and Food Safety monitoring">
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          ...
          <Card className="glass-card bg-glass-surface/50 border-glass-border">
            <CardHeader className="pb-2">
              <CardTitle className="text-sm flex items-center gap-2">
                <Microscope className="h-4 w-4 text-rose" />
                MERS-CoV
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid grid-cols-3 gap-3">
                <div className="text-center p-2 rounded-lg bg-rose-500/10 border border-rose-500/30">
                  <div className="text-xl font-bold text-rose">{MersCov.uaeTotalCases}</div>
                  <div className="text-xs text-platinum-400">UAE Cases</div>
                </div>
                <div className="text-center p-2 rounded-lg bg-rose-500/10 border border-rose-500/30">
                  <div className="text-xl font-bold text-rose">{MersCov.uaeDeaths}</div>
                  <div className="text-xs text-platinum-400">Deaths</div>
                </div>
                <div className="text-center p-2 rounded-lg bg-rose-500/10 border border-rose-500/30">
                  <div className="text-xl font-bold text-rose">{MersCov.caseFatalityRate}</div>
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-2 gap-3">
                <div className="text-center p-2 rounded-lg bg-gold-500/10 border border-gold-500/30">
                  <div className="text-xl font-bold text-gold">{mpoxData['2022Outbreak'].cases}</div>
                  <div className="text-xs text-platinum-400">2022 Cases</div>
                </div>
                <div className="text-center p-2 rounded-lg bg-gold-500/10 border border-gold-500/30">
                  <div className="text-xl font-bold text-gold">Feb 2025</div>
          ...
          <Card className="glass-card bg-glass-surface/50 border-glass-border">
            <CardHeader className="pb-2">
              <CardTitle className="text-sm flex items-center gap-2">
                <FlaskConical className="h-4 w-4 text-rose" />
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-2 gap-3">
                <div className="text-center p-2 rounded-lg bg-rose-500/10 border border-rose-500/30">
                  <div className="text-xl font-bold text-rose">{foodPoisoningStats.totalCasesH12025}+</div>
                  <div className="text-xs text-platinum-400">Total Cases</div>
                </div>
                <div className="text-center p-2 rounded-lg bg-rose-500/10 border border-rose-500/30">
                  <div className="text-xl font-bold text-rose">{foodPoisoningStats.confirmedSalmonella}+</div>
          ...
          <div className="grid gap-3 md:grid-cols-2 lg:grid-cols-5">
            <div className="rounded-lg bg-emerald-500/10 border border-emerald-500/30 p-3">
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-sm font-medium text-emerald">Predatory Fish</span>
              </div>
            ...
            <div className="rounded-lg bg-purple-500/10 border border-purple-500/30 p-3">
              <div className="flex items-center gap-2 mb-1">
                <Leaf className="h-4 w-4 text-purple" />
                <span className="text-sm font-medium text-purple">Growth Regulators</span>
              </div>
            ...
            <div className="rounded-lg bg-gold-500/10 border border-gold-500/30 p-3">
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-sm font-medium text-gold">Smart Traps</span>
              </div>
            ...
            <div className="rounded-lg bg-emerald-500/10 border border-emerald-500/30 p-3">
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-sm font-medium text-emerald">Risk Level</span>
              </div>
              <div className="text-lg font-bold text-emerald">{vectorControl.currentRiskAssessment}</div>
            </div>
          </div>
        </div>
      </GlassPanel>
