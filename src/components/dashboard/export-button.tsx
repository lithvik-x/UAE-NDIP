    ...
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute right-0 top-full mt-2 z-50 w-56 glass-premium rounded-xl shadow-premium-xl border border-white/30 overflow-hidden">
          <div className="p-2">
            <div className="px-3 py-2 text-xs font-semibold text-platinum-500 uppercase tracking-wider">
              Export As
            </div>
            {availableFormats.map((format) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-xs text-platinum-500 truncate">{format.description}</div>
                </div>
              </button>
            ))}
          </div>
  ...
  return (
    <div className={cn('glass-premium rounded-xl p-4 space-y-4', className)}>
      <div>
        ...
        <p className="text-xs text-platinum-500 mt-1">{description}</p>
      </div>
