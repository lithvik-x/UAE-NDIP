            ...
            <CardContent>
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead>
                    <tr className="border-b border-platinum/10">
                      <th className="text-left py-3 px-4 text-sm font-medium text-platinum/60">Requirement</th>
                      <th className="text-left py-3 px-4 text-sm font-medium text-platinum/60">Threshold</th>
                      <th className="text-left py-3 px-4 text-sm font-medium text-gold">Rate</th>
                      <th className="text-left py-3 px-4 text-sm font-medium text-platinum/60">Deadline</th>
                    </tr>
                  </thead>
                  <tbody>
                    {taxRequirements.map((tax: { requirement: string; threshold: string; rate: string; deadline: string }, idx: number) => (
                      <tr key={idx} className="border-b border-platinum/5 hover:bg-white/5">
                        ...
                        <td className="py-3 px-4 text-sm text-platinum/70">{tax.threshold}</td>
                        <td className="py-3 px-4 text-sm text-gold">{tax.rate}</td>
                        <td className="py-3 px-4 text-sm text-platinum/50">{tax.deadline}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
