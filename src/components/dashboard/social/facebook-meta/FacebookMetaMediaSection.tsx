    ...
    <motion.div variants={fadeInUp}>
      ...
      >
        <div className="space-y-6">
              ...
              <div className="space-y-3">
                {mediaFacebookPages.map((page, idx) => (
                  <motion.a
                    ...
                    className="flex items-center justify-between p-4 rounded-lg bg-platinum-800/50 border border-platinum-700/50 hover:border-info/50 transition-colors"
                  >
          ...
          <Card className="glass-card border-glass">
            <CardHeader>
              <CardTitle className="text-lg text-gold-700">Khaleej Times Deep Dive</CardTitle>
          ...
          <Card className="glass-card border-glass">
            <CardHeader>
              <CardTitle className="text-lg text-emerald-500">Gulf News Deep Dive</CardTitle>
              <CardDescription>Major English-language UAE newspaper</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
