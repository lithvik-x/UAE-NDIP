...
>(({ className, scrollable = false, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'h-10 items-center justify-center rounded-xl bg-muted/50 p-1 text-muted-foreground',
      !scrollable && 'inline-flex',
      scrollable && 'flex overflow-x-auto overflow-y-hidden scrollbar-hide scroll-smooth',
      className
    )}
    {...props}
  />
